 ...
 *   flag:81 = 人间界侵攻度（facade-names）
 *   flag:87 = 精灵领域征服完了（facade-names）
 ...
 *   3. :407 NO属性 NO:ASSI → 角色 assi 的 ID（ere 角色 ID = 原作 NO，直接对应 JS 角色变量）
 *   4. :415 未知语句 SETCOLOR 255,204,255
 *   5. :417 未知语句 RESETCOLOR
 *   6. :423 未知语句 SETCOLOR 255,204,255
 *   7. :425 未知语句 RESETCOLOR
 *   8. :434 未知语句 SETCOLOR 255,204,255
 *   9. :436 未知语句 RESETCOLOR
 *   10. :439 未知语句 SETCOLOR 255,204,255
 *   11. :441 未知语句 RESETCOLOR
 *   12. :445 未知语句 SETCOLOR 255,204,255
 *   13. :447 未知语句 RESETCOLOR
 *   14. :450 未知语句 SETCOLOR 255,204,255
 *   15. :452 未知语句 RESETCOLOR
 *   16. :458 未知语句 SETCOLOR 255,204,255
 *   17. :460 未知语句 RESETCOLOR
 *   18. :462 未知语句 SETCOLOR 255,204,255
 *   19. :464 未知语句 RESETCOLOR
 *   20. :473 未知语句 SETCOLOR 255,204,255
 *   21. :475 未知语句 RESETCOLOR
 *   22. :482 未知语句 SETCOLOR 255,204,255
 *   23. :484 未知语句 RESETCOLOR
 *   24. :487 未知语句 SETCOLOR 255,204,255
 *   25. :489 未知语句 RESETCOLOR
 *   26. :494 未知语句 SETCOLOR 255,204,255
 *   27. :496 未知语句 RESETCOLOR
 *   28. :497 未知语句 SETCOLOR 255,204,255
 *   29. :499 未知语句 RESETCOLOR
 *   30. :510 未知语句 SETCOLOR 255,204,255
 *   31. :512 未知语句 RESETCOLOR
 *   32. :517 未知语句 SETCOLOR 255,204,255
 *   33. :519 未知语句 RESETCOLOR
 *   34. :525 未知语句 SETCOLOR 255,204,255
 *   35. :527 未知语句 RESETCOLOR
 *   36. :595 CALL K3_KOJO2 —— 口上文件里多为存根调用，人工定存根名
 *   37. :710 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   38. :713 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   39. :726 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   40. :729 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   41. :744 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   42. :747 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   43. :757 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   44. :760 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   45. :771 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   46. :774 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   47. :790 同名函数 @EVENTEND 重复定义（ERB 事件函数可多重定义）——JS 侧需改 on('EVENTEND', …) 注册，参照 ere/kojo/kojo-k5.js
 *   48. :890 CALL COLOSSEUM_KOJO_3 —— 口上文件里多为存根调用，人工定存根名
 *   49. :904 CALL DOG_KOJO_3 —— 口上文件里多为存根调用，人工定存根名
 *   50. :937 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   51. :942 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   52. :957 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   53. :962 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   54. :1012 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   55. :1013 插值 未知插值 %SELF_CALL(TARGET, 1)% —— 保真锁会红，须人工定归一
 *   56. :1014 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   57. :1043 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   58. :1045 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   59. :1094 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   60. :1096 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   61. :1160 局部变量 P = PALAM:3 + UP:3 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   62. :1162 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   63. :1168 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   64. :1174 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   65. :1180 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   66. :1185 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   67. :1227 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   68. :1231 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   69. :1252 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   70. :1277 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   71. :1281 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   72. :1293 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   73. :1304 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   74. :1314 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   75. :1332 表达式寻址 PALAMLV:3 → era.get('palamlv:3')——族名直译，语义与归属人工定
 *   76. :1362 表达式寻址 PALAMLV:3 → era.get('palamlv:3')——族名直译，语义与归属人工定
 *   77. :2475 插值 未知插值 %SELF_CALL(TARGET, 1)% —— 保真锁会红，须人工定归一
 *   78. :2539 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   79. :2543 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   80. :2556 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   81. :2560 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   82. :2635 插值 未知插值 %SELF_CALL(TARGET, 1)% —— 保真锁会红，须人工定归一
 *   83. :2693 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   84. :2698 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   85. :2700 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   86. :2706 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   87. :2710 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   88. :2722 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   89. :2726 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   90. :2796 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   91. :2800 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   92. :2812 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   93. :2817 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   94. :2886 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   95. :2890 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   96. :2901 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   97. :2905 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   98. :2980 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   99. :2995 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   100. :3052 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   101. :3056 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   102. :3073 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   103. :3150 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   104. :3154 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   105. :3172 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   106. :3184 插值 未知插值 %SELF_CALL(TARGET, 1)% —— 保真锁会红，须人工定归一
 *   107. :3227 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   108. :3231 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   109. :3247 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   110. :3301 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   111. :3318 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   112. :3387 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   113. :3416 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   114. :3477 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   115. :3481 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   116. :3493 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   117. :3497 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   118. :3549 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   119. :3571 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   120. :3765 RAND RAND:4 → rand_n(4)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   121. :3768 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   122. :3771 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   123. :3782 RAND RAND:4 → rand_n(4)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   124. :3786 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   125. :3790 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   126. :3800 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   127. :3803 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   128. :3895 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   129. :3912 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   130. :3996 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   131. :4001 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   132. :4006 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   133. :4026 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   134. :4031 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   135. :4033 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   136. :4042 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   137. :4047 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   138. :4538 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   139. :4539 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   140. :4539 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   141. :4539 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   142. :4540 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   143. :4540 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   144. :4541 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   145. :4544 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   146. :4544 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   147. :4544 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   148. :4544 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   149. :4545 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   150. :4545 插值 未知插值 %SELF_CALL(TARGET,5)% —— 保真锁会红，须人工定归一
 *   151. :4545 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   152. :4546 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   153. :4546 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   154. :4549 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   155. :4549 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   156. :4550 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   157. :4550 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   158. :4550 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   159. :4550 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   160. :4551 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   161. :4551 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   162. :4551 插值 未知插值 %SELF_CALL(TARGET,3)% —— 保真锁会红，须人工定归一
 *   163. :4551 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   164. :4555 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   165. :4555 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   166. :4555 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   167. :4556 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   168. :4556 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   169. :4560 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   170. :4561 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   171. :4561 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   172. :4561 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   173. :4561 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   174. :4584 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   175. :4600 假名残留 归一后仍含日文假名：っ —— 查 lang-table 是否应收
 *   176. :4634 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   177. :4639 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   178. :4644 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   179. :4650 未知语句 REPEAT CHARANUM
 *   180. :4652 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   181. :4653 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   182. :4654 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   183. :4656 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   184. :4661 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   185. :4662 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   186. :4663 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   187. :4664 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   188. :4665 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   189. :4665 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   190. :4667 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   191. :4667 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   192. :4668 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   193. :4673 未知语句 REND
 *   194. :4676 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   195. :4677 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   196. :4677 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   197. :4678 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   198. :4679 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   199. :4679 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   200. :4679 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   201. :4681 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   202. :4681 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   203. :4681 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   204. :4685 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   205. :4686 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   206. :4687 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   207. :4688 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   208. :4690 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   209. :4690 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   210. :4690 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   211. :4695 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   212. :4696 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   213. :4696 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   214. :4698 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   215. :4698 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   216. :4698 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   217. :4707 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   218. :4712 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   219. :4717 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   220. :4722 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   221. :4743 未知语句 REPEAT CHARANUM
 *   222. :4745 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   223. :4748 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   224. :4763 未知语句 REND
 *   225. :4766 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   226. :4768 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   227. :4776 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   228. :4778 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   229. :4790 未知语句 REPEAT CHARANUM
 *   230. :4797 未知语句 REND
 *   231. :4811 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   232. :4813 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   233. :4822 未知语句 REPEAT CHARANUM
 *   234. :4829 未知语句 REND
 *   235. :4917 表达式寻址 PALAMLV:3 → era.get('palamlv:3')——族名直译，语义与归属人工定
 *   236. :4927 表达式寻址 PALAMLV:3 → era.get('palamlv:3')——族名直译，语义与归属人工定
 *   237. :4994 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   238. :5016 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   239. :5027 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   240. :5029 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   241. :5031 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   242. :5031 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   243. :5043 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   244. :5046 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   245. :5060 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   246. :5063 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   247. :5066 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   248. :5088 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   249. :5099 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   250. :5101 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   251. :5103 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   252. :5103 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   253. :5115 表达式寻址 PALAMLV:4 → era.get('palamlv:4')——族名直译，语义与归属人工定
 *   254. :5118 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   255. :5168 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   256. :5173 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   257. :5225 插值 未知插值 %SELF_CALL(TARGET, 1)% —— 保真锁会红，须人工定归一
 *   258. :6026 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   259. :6032 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   260. :6047 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   261. :6056 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   262. :6194 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   263. :6198 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   264. :6214 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   265. :6275 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   266. :6671 变量语义 LOCAL = TALENT:320 —— 局部/自定义变量，人工映射
 *   267. :6673 变量语义 LOCAL:1 = LOCAL % 10 —— 局部/自定义变量，人工映射
 *   268. :6675 变量语义 LOCAL:3 = LOCAL % 1000 —— 局部/自定义变量，人工映射
 *   269. :6676 变量语义 LOCAL:3 / = 100 —— 局部/自定义变量，人工映射
 *   270. :6678 变量语义 LOCAL:4 = LOCAL % 10000 —— 局部/自定义变量，人工映射
 *   271. :6679 变量语义 LOCAL:4 / = 1000 —— 局部/自定义变量，人工映射
 *   272. :6681 变量语义 LOCAL:5 = LOCAL % 1000000 —— 局部/自定义变量，人工映射
 *   273. :6682 变量语义 LOCAL:5 / = 100000 —— 局部/自定义变量，人工映射
 *   274. :6684 变量语义 LOCAL:6 = LOCAL % 10000000 —— 局部/自定义变量，人工映射
 *   275. :6685 变量语义 LOCAL:6 / = 1000000 —— 局部/自定义变量，人工映射
 *   276. :6687 变量语义 LOCAL:7 = LOCAL % 100000000 —— 局部/自定义变量，人工映射
 *   277. :6688 变量语义 LOCAL:7 / = 10000000 —— 局部/自定义变量，人工映射
 *   278. :6690 变量语义 LOCAL:8 = LOCAL % 1000000000 —— 局部/自定义变量，人工映射
 *   279. :6691 变量语义 LOCAL:8 / = 100000000 —— 局部/自定义变量，人工映射
 *   280. :6693 变量语义 LOCAL:9 = LOCAL:5 + LOCAL:6 + LOCAL:7 + LOCAL:8 —— 局部/自定义变量，人工映射
 *   281. :6705 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   282. :6705 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   283. :6708 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   284. :6711 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   285. :6716 局部参数 LOCAL:9 → local_9（JS 局部变量，形参名人工定）
 *   286. :6718 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   287. :6718 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   288. :6718 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   289. :6718 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   290. :6720 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   291. :6720 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   292. :6720 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   293. :6722 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   294. :6722 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   295. :6722 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   296. :6724 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   297. :6724 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   298. :6724 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   299. :6726 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   300. :6726 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   301. :6726 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   302. :6728 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   303. :6728 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   304. :6730 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   305. :6730 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   306. :6732 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   307. :6732 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   308. :6734 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   309. :6734 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   310. :6736 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   311. :6736 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   312. :6738 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   313. :6738 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   314. :6740 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   315. :6742 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   316. :6744 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   317. :6746 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   318. :6753 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   319. :6753 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   320. :6756 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   321. :6759 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   322. :6764 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   323. :6764 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   324. :6767 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   325. :6770 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   326. :6784 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   327. :6784 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   328. :6787 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   329. :6790 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   330. :6795 局部参数 LOCAL:9 → local_9（JS 局部变量，形参名人工定）
 *   331. :6797 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   332. :6797 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   333. :6797 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   334. :6797 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   335. :6799 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   336. :6799 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   337. :6799 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   338. :6801 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   339. :6801 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   340. :6801 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   341. :6803 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   342. :6803 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   343. :6803 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   344. :6805 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   345. :6805 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   346. :6805 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   347. :6807 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   348. :6807 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   349. :6809 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   350. :6809 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   351. :6811 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   352. :6811 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   353. :6813 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   354. :6813 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   355. :6815 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   356. :6815 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   357. :6817 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   358. :6817 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   359. :6819 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   360. :6821 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   361. :6823 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   362. :6825 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   363. :6832 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   364. :6832 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   365. :6835 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   366. :6838 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   367. :6843 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   368. :6843 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   369. :6846 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   370. :6849 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   371. :6888 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   372. :6888 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   373. :6891 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   374. :6894 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   375. :6899 局部参数 LOCAL:9 → local_9（JS 局部变量，形参名人工定）
 *   376. :6901 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   377. :6901 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   378. :6901 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   379. :6901 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   380. :6903 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   381. :6903 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   382. :6903 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   383. :6905 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   384. :6905 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   385. :6905 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   386. :6907 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   387. :6907 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   388. :6907 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   389. :6909 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   390. :6909 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   391. :6909 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   392. :6911 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   393. :6911 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   394. :6913 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   395. :6913 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   396. :6915 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   397. :6915 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   398. :6917 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   399. :6917 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   400. :6919 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   401. :6919 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   402. :6921 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   403. :6921 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   404. :6923 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   405. :6925 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   406. :6927 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   407. :6929 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   408. :6936 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   409. :6936 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   410. :6939 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   411. :6942 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   412. :6947 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   413. :6947 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   414. :6950 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   415. :6953 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   416. :6970 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   417. :6970 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   418. :6973 局部参数 LOCAL:3 → local_3（JS 局部变量，形参名人工定）
 *   419. :6976 局部参数 LOCAL:4 → local_4（JS 局部变量，形参名人工定）
 *   420. :6981 局部参数 LOCAL:9 → local_9（JS 局部变量，形参名人工定）
 *   421. :6983 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   422. :6983 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   423. :6983 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   424. :6983 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   425. :6985 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   426. :6985 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   427. :6985 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   428. :6987 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   429. :6987 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   430. :6987 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   431. :6989 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   432. :6989 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   433. :6989 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   434. :6991 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   435. :6991 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   436. :6991 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   437. :6993 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   438. :6993 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   439. :6995 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   440. :6995 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   441. :6997 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   442. :6997 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   443. :6999 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   444. :6999 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   445. :7001 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   446. :7001 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   447. :7003 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   448. :7003 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   449. :7005 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   450. :7007 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   451. :7009 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   452. :7011 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   453. :7018 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   454. :7018 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   455. :7021 局部参数 LOCAL:5 → local_5（JS 局部变量，形参名人工定）
 *   456. :7024 局部参数 LOCAL:6 → local_6（JS 局部变量，形参名人工定）
 *   457. :7029 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   458. :7029 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   459. :7032 局部参数 LOCAL:7 → local_7（JS 局部变量，形参名人工定）
 *   460. :7035 局部参数 LOCAL:8 → local_8（JS 局部变量，形参名人工定）
 *   461. :7104 局部变量 P = PALAM:3 + UP:3 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   462. :7105 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   463. :7135 局部变量 P = PALAM:5 + UP:5 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   464. :7136 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   465. :7166 局部变量 P = PALAM:8 + UP:8 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   466. :7167 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   467. :7183 局部变量 P = PALAM:10 + UP:10 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   468. :7184 表达式寻址 PALAMLV:2 → era.get('palamlv:2')——族名直译，语义与归属人工定
 *   469. :7200 表达式寻址 NOWEX:0 → era.get('nowex:0')——族名直译，语义与归属人工定
 *   470. :7216 表达式寻址 NOWEX:1 → era.get('nowex:1')——族名直译，语义与归属人工定
 *   471. :7241 表达式寻址 NOWEX:2 → era.get('nowex:2')——族名直译，语义与归属人工定
 *   472. :7246 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   473. :7246 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   474. :7247 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   475. :7247 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   476. :7248 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   477. :7248 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   478. :7248 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   479. :7290 插值 未知插值 %SELF_CALL(TARGET,4)% —— 保真锁会红，须人工定归一
 *   480. :7296 插值 未知插值 %UNICODE(0x2764) *1% —— 保真锁会红，须人工定归一
 *   481. :7309 表达式寻址 NOWEX:3 → era.get('nowex:3')——族名直译，语义与归属人工定
 *   482. :7326 局部变量 A = UP:11 + UP:12 —— 单字母局部变量，JS 侧声明与赋值人工定
 *   483. :7367 表达式寻址 NOWEX:0 → era.get('nowex:0')——族名直译，语义与归属人工定
 *   484. :7367 表达式寻址 NOWEX:1 → era.get('nowex:1')——族名直译，语义与归属人工定
 *   485. :7367 表达式寻址 NOWEX:2 → era.get('nowex:2')——族名直译，语义与归属人工定
 *   486. :7367 表达式寻址 NOWEX:3 → era.get('nowex:3')——族名直译，语义与归属人工定
 *   487. :7369 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   488. :7372 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   489. :7384 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   490. :7392 RAND RAND:1 → rand_n(1)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   491. :7399 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   492. :7672 CALL SELL_MATURO_K0 —— 口上文件里多为存根调用，人工定存根名
 *   493. :7692 插值 未知插值 %CSTR:2% —— 保真锁会红，须人工定归一
 *   494. :7697 插值 未知插值 %CSTR:2% —— 保真锁会红，须人工定归一
 *   495. :7728 插值 未知插值 %CSTR:2% —— 保真锁会红，须人工定归一
 *   496. :7733 插值 未知插值 %CSTR:2% —— 保真锁会红，须人工定归一
 *   497. :8086 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   498. :8087 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   499. :8105 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   500. :8106 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   501. :8125 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   502. :8126 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   503. :8127 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   504. :8145 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   505. :8146 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   506. :8147 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   507. :8165 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   508. :8166 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   509. :8167 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   510. :8185 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   511. :8186 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   512. :8187 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   513. :8206 CALL BENKI_PLAYER_NAME —— 口上文件里多为存根调用，人工定存根名
 *   514. :8207 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   515. :8208 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   516. :8209 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   517. :8209 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   518. :8228 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   519. :8230 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   520. :8249 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   521. :8251 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   522. :8270 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   523. :8272 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   524. :8307 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   525. :8309 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   526. :8324 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   527. :8326 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   528. :8364 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   529. :8366 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   530. :8389 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   531. :8391 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   532. :8409 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   533. :8411 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   534. :8426 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   535. :8428 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   536. :8495 表达式寻址 ITEM:PBAND → era.get('item:4')——PBAND 是内建非角色变量，SYSTEM ver1.0.3.ERB:42 赋 4（4 号 = 假阳具，#552）
 *   537. :8528 表达式寻址 ITEM:PBAND → era.get('item:4')——PBAND 是内建非角色变量，SYSTEM ver1.0.3.ERB:42 赋 4（4 号 = 假阳具，#552）
 *   538. :8552 表达式寻址 ITEM:PBAND → era.get('item:4')——PBAND 是内建非角色变量，SYSTEM ver1.0.3.ERB:42 赋 4（4 号 = 假阳具，#552）
 *   539. :8782 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   540. :8785 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   541. :8788 插值 未知插值 %SELF_CALL_FIRST(A)% —— 保真锁会红，须人工定归一
 *   542. :8788 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   543. :8791 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   544. :8800 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   545. :8803 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   546. :8814 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   547. :8817 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   548. :8820 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   549. :8823 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   550. :8823 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   551. :8826 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   552. :8840 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   553. :8843 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   554. :8847 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   555. :8852 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   556. :8854 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   557. :8860 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   558. :8862 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   559. :8868 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   560. :8870 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   561. :8879 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   562. :8886 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   563. :8931 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   564. :8947 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   565. :8955 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   566. :8961 插值 未知插值 %SELF_CALL(A)% —— 保真锁会红，须人工定归一
 *   567. :8974 函数参数 @GOBI_KOUJO_K3, ARG:0 —— 参数声明已剥（JS 函数签名人工定）
 *   568. :8977 局部参数 ARG:0 → arg_0（JS 局部变量，形参名人工定）
 *   569. :8980 局部参数 ARG:0 → arg_0（JS 局部变量，形参名人工定）
 *   570. :8983 局部参数 ARG:0 → arg_0（JS 局部变量，形参名人工定）
 *   571. :8986 局部参数 ARG:0 → arg_0（JS 局部变量，形参名人工定）
 *   572. :8989 局部参数 ARG:0 → arg_0（JS 局部变量，形参名人工定）
 *   573. :8995 RAND RAND:3 → rand_n(3)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 *   574. :8997 RAND RAND:2 → rand_n(2)——随机源需注入（参照 kojo-k5.js 的 rand 参数）
 */
...
// @EVENTTRAIN // :95
async function EVENTTRAIN() {
  if (era.get('flag:7') <= 0) { // :97
    return 0; // :97
  } // :97
  if (era.get(`talent:${target}:163`) != 1) { // :99
    return 0; // :99
  } // :99
  ...
  if (era.get(`cflag:${target}:201`) == 0) { // :104
    era.drawLine(); // :105

    if (era.get(`talent:${target}:314`) == 1) { // :107

      if (era.get('flag:87') >= 1) { // :109
    ...
    } else if (era.get(`talent:${target}:314`) == 2) { // :125
    ...
    } else if (era.get(`talent:${target}:314`) == 3) { // :131
    ...
    } else if (era.get(`talent:${target}:314`) == 4) { // :137
    ...
    } else if (era.get(`talent:${target}:314`) == 5) { // :143
    ...
    } else if (era.get(`talent:${target}:314`) == 6) { // :149
    ...
    } else if (era.get(`talent:${target}:314`) == 9) { // :155
    ...
    } else if (era.get(`talent:${target}:314`) == 10) { // :165
    ...
    } else if (era.get(`talent:${target}:314`) == 11) { // :170
  ...
  } else if (era.get(`cflag:${target}:201`) < 5 && era.get(`cflag:${target}:370`) == 0 && era.get(`talent:${target}:314`) == 9 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :185
    ...
    if (era.get(`mark:${target}:2`) == 3) { // :191
  ...
  } else if (era.get(`cflag:${target}:201`) >= 1 && era.get(`cflag:${target}:650`) == 1) { // :199
    if (era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) { // :200
      era.drawLine(); // :201
  ...
  } else if (era.get(`cflag:${target}:201`) < 2 && era.get(`mark:${target}:2`) == 1 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :219
    era.drawLine(); // :220

    if (era.get(`talent:${target}:314`) == 1) { // :222
  ...
  } else if (era.get(`cflag:${target}:201`) < 3 && era.get(`mark:${target}:2`) == 2 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :234
    era.drawLine(); // :235

    if (era.get(`talent:${target}:314`) == 1) { // :237
  ...
  } else if (era.get(`cflag:${target}:201`) < 4 && era.get(`mark:${target}:2`) == 3 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :249
    era.drawLine(); // :250

    if (era.get(`talent:${target}:314`) == 1) { // :252
  ...
  } else if (era.get(`cflag:${target}:201`) < 5 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 1 && era.get(`talent:${target}:314`) != 9) { // :265
    era.drawLine(); // :266

    if (era.get(`talent:${target}:314`) == 7) { // :268
  ...
  } else if (era.get(`talent:${target}:314`) == 9 && era.get(`cflag:${target}:201`) < 6 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 1) { // :289
    era.drawLine(); // :290

    if (era.get(`cflag:${target}:370`) == 1) { // :292
    ...
    } else if (era.get(`cflag:${target}:370`) == 2) { // :303
  ...
  } else if (era.get(`cflag:${target}:201`) < 7 && era.get(`talent:${target}:85`) == 1 && era.get(`talent:${target}:76`) == 0 && era.get(`talent:${target}:314`) != 9) { // :330
    era.drawLine(); // :331

    if (era.get(`talent:${target}:314`) == 1) { // :333
  ...
  } else if (era.get(`talent:${target}:314`) == 9 && era.get(`cflag:${target}:201`) < 8 && era.get(`talent:${target}:85`) == 1 && era.get(`talent:${target}:76`) == 0) { // :354
    era.drawLine(); // :355

    if (era.get(`cflag:${target}:370`) == 1) { // :357
    ...
    } else if (era.get(`cflag:${target}:370`) == 2) { // :368
  ...
  } else if (era.get(`talent:${target}:9`) == 1 && era.get(`cflag:${target}:201`) < 9) { // :387
    era.drawLine(); // :388
    ...
    if (era.get(`cflag:${target}:202`) == 0) { // :412

      if (era.get(`talent:${target}:9`) == 1) { // :414
        // RAW: SETCOLOR 255,204,255 // :415
        await era.printAndWait(`『…主人、这个人已经坏掉了哦』`); // :416
        // RAW: RESETCOLOR // :417

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`cflag:${target}:201`) >= 5) { // :419
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`cflag:${target}:201`) >= 7) { // :428
        ...
        if (era.get(`talent:${assi}:85`) == 1) { // :432
    ...
    } else if (era.get(`cflag:${target}:202`) == 1 && era.get('flag:7') == 2) { // :470

      if (era.get(`talent:${target}:9`) == 1) { // :472
        // RAW: SETCOLOR 255,204,255 // :473
        await era.printAndWait(`『已经坏掉了的话…那就弄得更加坏掉也没关系吧★』`); // :474
        // RAW: RESETCOLOR // :475

      } else if (era.get(`talent:${target}:85`) == 1) { // :477
        ...
        if (era.get(`talent:${assi}:85`) == 1) { // :481
        ...
        if (era.get(`mark:${target}:2`) == 3) { // :529
...
// @K3_KOJO2 // :602
async function K3_KOJO2() {

  if (era.get(`talent:${target}:9`) == 1 && era.get('flag:7') == 2) { // :604
    era.drawLine(); // :605
  ...
  } else if (era.get(`mark:${target}:3`) == 3 && era.get('flag:7') == 2) { // :611
    era.drawLine(); // :612

    if (era.get(`talent:${target}:314`) == 1) { // :614
  ...
  } else if (era.get(`mark:${target}:2`) == 0 && era.get('flag:7') == 2 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :625
    era.drawLine(); // :626

    if (era.get(`talent:${target}:314`) == 1) { // :628
      await era.printAndWait(`「真是肮脏…不要看过来！」`); // :629
      await era.printAndWait(`${target_name}紧咬着牙，怒视着${player_name}………`); // :630

    } else { // :632

      if (era.get(`talent:${target}:317`) == 4) { // :634
  ...
  } else if (era.get(`mark:${target}:2`) == 1 && era.get('flag:7') == 2 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :645
    era.drawLine(); // :646

    if (era.get(`talent:${target}:314`) == 1) { // :648
      await era.printAndWait(`「哼、哼嗯…这点小事…！」`); // :649
      await era.printAndWait(`${target_name}还是一副强硬的样子………`); // :650

    } else { // :652

      if (era.get(`talent:${target}:317`) == 4) { // :654
  ...
  } else if (era.get(`mark:${target}:2`) == 2 && era.get('flag:7') == 2 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :665
    era.drawLine(); // :666

    if (era.get(`talent:${target}:314`) == 1) { // :668
      await era.printAndWait(`「呜……${sc()}才…不会在这种地方……」`); // :669
      await era.printAndWait(`${target_name}还没有抛弃希望的样子、不过看来差不到要到极限了………`); // :670

    } else { // :672

      if (era.get(`talent:${target}:317`) == 4) { // :674
  ...
  } else if (era.get(`mark:${target}:2`) == 3 && era.get(`talent:${target}:85`) == 0 && era.get('flag:7') == 2 && era.get(`talent:${target}:76`) == 0) { // :685
    era.drawLine(); // :686

    if (era.get(`talent:${target}:314`) == 1) { // :688
      await era.printAndWait(`「如果不做太过分的事情的话…就没关系………」`); // :689
      await era.printAndWait(`${target_name}一副已经完全放弃了的样子………`); // :690

    } else { // :692

      if (era.get(`talent:${target}:317`) == 4 && era.get('flag:81') >= 5000) { // :694
  ...
  } else if (era.get(`talent:${target}:76`) == 1 && era.get('flag:7') == 2) { // :705
    era.drawLine(); // :706

    if (era.get(`talent:${target}:314`) == 7) { // :708
  ...
  } else if (era.get(`talent:${target}:85`) == 1 && era.get('flag:7') == 2) { // :740
    era.drawLine(); // :741

    if (era.get(`cflag:${target}:230`) >= 1 && (era.get(`talent:${target}:190`) == 1 || era.get(`talent:${target}:191`) == 1)) { // :743
      if (rand_n(3) == 0) { // :744
...
async function EVENTEND() {
  ...
  if (era.get(`cflag:${target}:301`) >= 1) { // :793
    // CFLAG:301  = 1（变量语义：CFLAG 族，301） // :793
    era.set(`cflag:${target}:301`, 1); // :793
  } // :793

  if (era.get('flag:7') <= 0) { // :796
    return 0; // :796
  } // :796
  if (era.get(`talent:${target}:163`) != 1) { // :798
    return 0; // :798
  } // :798


  if (era.get(`base:${target}:0`) <= 0) { // :802
    return 0; // :802
  } // :802
  ...
  if (era.get(`talent:${target}:9`) == 1 && era.get('flag:7') == 2) { // :808
    era.drawLine(); // :809
  ...
  } else if (era.get(`mark:${target}:3`) == 3 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :815
    era.drawLine(); // :816
    await era.printAndWait(`「……真是无法置信」`); // :817
    return 1; // :818


  } else if (era.get(`mark:${target}:2`) <= 1 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :821
    era.drawLine(); // :822
    await era.printAndWait(`「终于结束了啊………」`); // :823
    return 1; // :824


  } else if (era.get(`mark:${target}:2`) == 2 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :827
    era.drawLine(); // :828
    await era.printAndWait(`「到底打算继续到什么时候呐…？」`); // :829
    return 1; // :830


  } else if (era.get(`mark:${target}:2`) == 3 && era.get(`talent:${target}:85`) == 0 && era.get(`talent:${target}:76`) == 0) { // :833
    era.drawLine(); // :834
    await era.printAndWait(`「这种程度才不会屈服…来的………」`); // :835
    return 1; // :836


  } else if (era.get(`talent:${target}:76`) == 1 && era.get(`base:${target}:0`) >= 500) { // :839
    era.drawLine(); // :840

    if (era.get(`talent:${target}:314`) == 7) { // :842
  ...
  } else if (era.get(`talent:${target}:76`) == 1 && era.get(`base:${target}:0`) <= 500) { // :850
    era.drawLine(); // :851

    if (era.get(`talent:${target}:314`) == 7) { // :853
  ...
  } else if (era.get(`talent:${target}:85`) == 1 && era.get(`base:${target}:0`) >= 500) { // :860
    era.drawLine(); // :861

    if (era.get(`talent:${target}:314`) == 1) { // :863
  ...
  } else if (era.get(`talent:${target}:85`) == 1 && era.get(`base:${target}:0`) <= 500) { // :871
    era.drawLine(); // :872

    if (era.get(`talent:${target}:314`) == 1) { // :874
...
async function KOJO_MESSAGE_COM_3() {

  if (era.get(`tequip:${target}:55`)) { // :889
    // CALL COLOSSEUM_KOJO_3 // :890
    return 0; // :891
  } // :892

  if (era_flag.assi > 0 && era_flag.assiplay) { // :895
    return 0; // :895
  } // :895

  if (era.get(`tequip:${target}:45`) && era_flag.selectcom != 45) { // :898
    return 0; // :898
  } // :898

  if (era.get('tflag:899')) { // :901
    return 0; // :901
  } // :901

  if (era.get(`tequip:${target}:89`)) { // :903
    // CALL DOG_KOJO_3 // :904
    return 0; // :905
  } // :906

  if (era.get(`talent:${target}:9`) == 1) { // :909
    return 0; // :909
  } // :909

  if (era.get(`tequip:${target}:90`)) { // :912
    return 0; // :912
  } // :912
  ...
  if (era_flag.selectcom == 0) { // :920

    if (era.get(`cflag:${target}:301`) == 0) { // :922

      if (era.get(`mark:${target}:2`) >= 2) { // :924
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:301`) <= 599 || era.get('flag:7') == 2)) { // :935
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:301`) <= 499 || era.get('flag:7') == 2)) { // :955
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:301`) <= 399 || era.get('flag:7') == 2)) { // :977

        if (era.get(`cflag:${target}:301`) <= 400) { // :979

          if (era.get(`mark:${target}:1`) == 3) { // :981
        ...
        } else if (era.get(`cflag:${target}:301`) == 401) { // :990

          if (era.get(`mark:${target}:1`) == 3) { // :992
        ...
        } else if (era.get(`cflag:${target}:301`) == 402) { // :1004
      ...
      } else if (era.get(`mark:${target}:2`) == 2 && era.get(`mark:${target}:1`) == 3 && (era.get(`cflag:${target}:301`) <= 299 || era.get('flag:7') == 2)) { // :1021

        if (era.get(`cflag:${target}:301`) <= 300) { // :1023
        ...
        } else if (era.get(`cflag:${target}:301`) == 301) { // :1029
        ...
        } else if (era.get(`cflag:${target}:301`) == 302) { // :1035
      ...
      } else if (era.get(`mark:${target}:2`) <= 1 && (era.get(`cflag:${target}:301`) <= 1 || era.get('flag:7') == 2)) { // :1052

        if (era.get(`cflag:${target}:301`) <= 200) { // :1054

          if (era.get(`mark:${target}:1`) == 3) { // :1056
          ...
          } else if (era.get(`mark:${target}:2`) == 2) { // :1062
        ...
        } else if (era.get(`cflag:${target}:301`) == 201) { // :1068

          if (era.get(`mark:${target}:1`) == 3) { // :1070
        ...
        } else if (era.get(`cflag:${target}:301`) == 202) { // :1079

          if (era.get(`mark:${target}:1`) == 3) { // :1081
  ...
  if (era_flag.selectcom == 1) { // :1110

    if (era.get(`cflag:${target}:302`) == 0) { // :1112

      if (era.get(`talent:${target}:0`) == 1) { // :1114
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:302`) <= 4 || era.get('flag:7') == 2)) { // :1125
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:302`) <= 3 || era.get('flag:7') == 2)) { // :1131
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:302`) <= 2 || era.get('flag:7') == 2)) { // :1137
        await era.printAndWait(`「呜啊~…啊~…呜呼啊~…更加地…温柔地爱抚吧…哼唔啊~…啊~啊啊~♪」`); // :1138
        // CFLAG:302  = 3（变量语义：CFLAG 族，302） // :1139
        era.set(`cflag:${target}:302`, 3); // :1139

      } else if (era.get(`cflag:${target}:302`) <= 1 || era.get('flag:7') == 2) { // :1141
  ...
  if (era_flag.selectcom == 2) { // :1152

    if (era.get(`cflag:${target}:303`) == 0) { // :1154
      await era.printAndWait(`「呜，呜哇啊！？那、那里是不行的！」`); // :1155
      // CFLAG:TARGET:303  = 1（变量语义：CFLAG 族，TARGET:303） // :1156
      era.set(`cflag:${target}:303`, 1); // :1156
      return 0; // :1157

    } else { // :1159
      // 赋值 P = PALAM:3 + UP:3 // :1160

      if (era.get(`talent:${target}:76`) == 1 && P >= era.get('palamlv:2') && (era.get(`cflag:${target}:303`) <= 6 || era.get('flag:7') == 2)) { // :1162
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && P < era.get('palamlv:2') && (era.get(`cflag:${target}:303`) <= 5 || era.get('flag:7') == 2)) { // :1168
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && P >= era.get('palamlv:2') && (era.get(`cflag:${target}:303`) <= 4 || era.get('flag:7') == 2)) { // :1174
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && P < era.get('palamlv:2') && (era.get(`cflag:${target}:303`) <= 3 || era.get('flag:7') == 2)) { // :1180
      ...
      } else if (P >= era.get('palamlv:2') && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:303`) <= 2 || era.get('flag:7') == 2)) { // :1185
      ...
      } else if (era.get(`cflag:${target}:223`) <= 1 || era.get('flag:7') == 2) { // :1191
  ...
  if (era_flag.selectcom == 3) { // :1202

    if (era.get(`cflag:${target}:304`) == 0) { // :1204
      await era.printAndWait(`「居然…不能不做这样的事情…这是……何等的…屈辱啊…」`); // :1205
      // CFLAG:TARGET:304  = 1（变量语义：CFLAG 族，TARGET:304） // :1206
      era.set(`cflag:${target}:304`, 1); // :1206
      return 0; // :1207

    } else { // :1209

      if (era.get(`talent:${target}:76`) == 1 && era.get(`talent:${target}:0`) == 1 && (era.get(`cflag:${target}:304`) <= 8 || era.get('flag:7') == 2)) { // :1211
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:31`) >= 3 && (era.get(`cflag:${target}:304`) <= 7 || era.get('flag:7') == 2)) { // :1220

        if (era.get(`tequip:${target}:11`) || era.get(`tequip:${target}:13`)) { // :1222
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:31`) < 3 && (era.get(`cflag:${target}:304`) <= 6 || era.get('flag:7') == 2)) { // :1245

        if (era.get(`tequip:${target}:11`) || era.get(`tequip:${target}:13`)) { // :1247
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`talent:${target}:0`) == 1 && (era.get(`cflag:${target}:304`) <= 5 || era.get('flag:7') == 2)) { // :1262
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:31`) >= 3 && (era.get(`cflag:${target}:304`) <= 4 || era.get('flag:7') == 2)) { // :1270

        if (era.get(`tequip:${target}:11`) || era.get(`tequip:${target}:13`)) { // :1272
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:31`) < 3 && (era.get(`cflag:${target}:304`) <= 3 || era.get('flag:7') == 2)) { // :1291
      ...
      } else if (era.get(`mark:${target}:2`) == 3 &&era.get(`abl:${target}:31`) >= 1 && (era.get(`cflag:${target}:304`) <= 2 || era.get('flag:7') == 2)) { // :1302
      ...
      } else if (era.get(`cflag:${target}:304`) <= 1 || era.get('flag:7') == 2) { // :1312
  ...
  if (era_flag.selectcom == 5) { // :1328

    if (era.get(`cflag:${target}:306`) == 0) { // :1330

      if (era.get(`talent:${target}:130`) == 1 && era.get(`palam:${target}:5`) > era.get('palamlv:3') && era.get(`tequip:${target}:16`) == 0 && era.get(`tequip:${target}:15`) == 0) { // :1332

        if (era.get(`talent:${target}:85`) == 1 && era.get(`talent:${target}:76`) == 1) { // :1334
      ...
      era.set(`cflag:${target}:306`, 1); // :1357
      return 0; // :1358

    } else { // :1360

      if (era.get(`talent:${target}:130`) == 1 && era.get(`palam:${target}:5`) > era.get('palamlv:3') && era.get(`tequip:${target}:16`) == 0 && era.get(`tequip:${target}:15`) == 0) { // :1362

        if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:306`) <= 4 || era.get('flag:7') == 2)) { // :1364
        ...
        } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:306`) <= 3 || era.get('flag:7') == 2)) { // :1369
        ...
        } else if (era.get(`abl:${target}:1`) >= 3 && (era.get(`cflag:${target}:306`) <= 2 || era.get('flag:7') == 2)) { // :1374
        ...
        } else if (era.get(`cflag:${target}:306`) <= 1 || era.get('flag:7') == 2) { // :1379
        ...
        if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:306`) <= 4 || era.get('flag:7') == 2)) { // :1385
        ...
        } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:306`) <= 3 || era.get('flag:7') == 2)) { // :1390
        ...
        } else if (era.get(`abl:${target}:1`) >= 3 && (era.get(`cflag:${target}:306`) <= 2 || era.get('flag:7') == 2)) { // :1395
  ...
  if (era_flag.selectcom == 6) { // :1412

    if (era.get(`cflag:${target}:307`) == 0 && era.get('tflag:13')) { // :1414

      if (era.get(`talent:${target}:76`) == 1 && era_flag.assiplay == 0 && era.get(`tequip:${target}:89`) == 0 && era.get(`tequip:${target}:90`) == 0) { // :1416

        if (era.get(`talent:${target}:314`) == 7) { // :1418
          ...
          if (era.get(`talent:${target}:317`) == 4) { // :1426
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era_flag.assiplay == 0 && era.get(`tequip:${target}:89`) == 0 && era.get(`tequip:${target}:90`) == 0) { // :1438

        if (era.get(`talent:${target}:314`) == 1) { // :1440
          ...
          if (era.get(`talent:${target}:317`) == 4) { // :1449
        ...
        if (era.get(`talent:${target}:317`) == 4 && era.get('flag:81') >= 5000) { // :1462
    ...
    } else if (era.get(`cflag:${target}:307`) == 0) { // :1475

      if (era.get(`talent:${target}:76`) == 1) { // :1477
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:307`) <= 4 || era.get('flag:7') == 2)) { // :1494
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:307`) <= 3 || era.get('flag:7') == 2)) { // :1500
      ...
      } else if (era.get(`abl:${target}:10`) >=2 && (era.get(`cflag:${target}:307`) <= 2 || era.get('flag:7') == 2)) { // :1506
      ...
      } else if (era.get(`cflag:${target}:307`) <= 1 || era.get('flag:7') == 2) { // :1511
  ...
  if (era_flag.selectcom == 7) { // :1522

    if (era.get(`cflag:${target}:308`) == 0) { // :1524

      if (era.get(`talent:${target}:76`) == 1) { // :1526
        await era.printAndWait(`「啊啊嗯~…${sc()}的小穴深处…被主人看到了啊~~${heart(1)}」`); // :1527

      } else if (era.get(`talent:${target}:85`) == 1) { // :1529
      ...
      era.set(`cflag:${target}:308`, 1); // :1535
      return 0; // :1536

    } else if (era.get(`tequip:${target}:53`) == 1) { // :1538

      if (era.get(`talent:${target}:76`) == 0 && era.get(`talent:${target}:85`) == 0) { // :1540

        if (era.get(`abl:${target}:17`) >= 5) { // :1542
        ...
        if (era.get(`talent:${target}:76`) == 1) { // :1552
          await era.printAndWait(`「嗯哼~${heart(1)} ${target_name}明白了~。就按照主人说的那样、给大~家、大饱眼福一下吧~」`); // :1553

        } else if (era.get(`talent:${target}:85`) == 1) { // :1555
          await era.printAndWait(`「啊啊……虽然感到十分地羞耻、但是会按照${master_name}所说的那样……」`); // :1556
        } // :1557

        if (era.get(`talent:${target}:0`) == 1 && era.get(`talent:${target}:136`) == 1 && era.get(`talent:${target}:271`) == 1) { // :1559
        ...
        } else if (era.get(`talent:${target}:0`) == 1 && era.get(`talent:${target}:271`) == 1) { // :1564
        ...
        } else if (era.get(`talent:${target}:77`) == 1) { // :1630
          await era.print(`不只是前面，后面也很厉害的噢、${sc()}。因为魔王大人只专注调教这边的原因、${sc()}的肛穴…`); // :1631

          if (era.get(`talent:${target}:0`) == 1) { // :1633
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:308`) <= 104 || era.get('flag:7') == 2)) { // :1745
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:308`) <= 103 || era.get('flag:7') == 2)) { // :1751
      ...
      } else if (era.get(`abl:${target}:17`) >= 3 && (era.get(`cflag:${target}:308`) <= 102 || era.get('flag:7') == 2)) { // :1757
      ...
      } else if (era.get(`cflag:${target}:306`) <= 101 || era.get('flag:7') == 2) { // :1762
  ...
  if (era_flag.selectcom == 8) { // :1774

    if (era.get(`cflag:${target}:309`) == 0) { // :1776

      if (era.get(`talent:${target}:76`) == 1) { // :1778
        await era.printAndWait(`「啊啊~${heart(1)} 主人的手指…在${sc()}的小穴里…${heart(1)}」`); // :1779

      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`talent:${target}:85`) == 1) { // :1781
      ...
      era.set(`cflag:${target}:309`, 1); // :1787
      return 0; // :1788

    } else { // :1790

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:309`) <= 4 || era.get('flag:7') == 2)) { // :1792
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:309`) <= 3 || era.get('flag:7') == 2)) { // :1797
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:309`) <= 2 || era.get('flag:7') == 2)) { // :1802
      ...
      } else if (era.get(`cflag:${target}:309`) <= 1 || era.get('flag:7') == 2) { // :1807
  ...
  if (era_flag.selectcom == 9) { // :1820

    if (era.get(`cflag:${target}:310`) == 0) { // :1822

      if (era.get(`talent:${target}:76`) == 1) { // :1824
        await era.printAndWait(`「哈嗯呜~…主人~${heart(1)}」`); // :1825
        await era.printAndWait(`「啊啊~明明不干净的肛穴被舔着…却还会有感觉……真是……${heart(1)}」`); // :1826

      } else if (era.get(`talent:${target}:85`) == 1) { // :1828
      ...
      era.set(`cflag:${target}:310`, 1); // :1835
      return 0; // :1836

    } else { // :1838

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:310`) <= 4 || era.get('flag:7') == 2)) { // :1840
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:310`) <= 3 || era.get('flag:7') == 2)) { // :1845
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:310`) <= 2 || era.get('flag:7') == 2)) { // :1850
      ...
      } else if (era.get(`cflag:${target}:310`) <= 1 || era.get('flag:7') == 2) { // :1855
  ...
  if (era_flag.selectcom == 10) { // :1867

    if (era.get(`cflag:${target}:311`) == 0) { // :1869

      if (era.get(`talent:${target}:76`) == 1) { // :1871
        await era.printAndWait(`「嗯哼呜呜~！？啊啊~啊~…哈啊恩~…！那个小玩具…好棒呀~${heart(1)}」`); // :1872

      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`talent:${target}:85`) == 1) { // :1874
      ...
      era.set(`cflag:${target}:311`, 1); // :1880
      return 0; // :1881

    } else { // :1883

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:311`) <= 4 || era.get('flag:7') == 2)) { // :1885
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:311`) <= 3 || era.get('flag:7') == 2)) { // :1890
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:311`) <= 2 || era.get('flag:7') == 2)) { // :1896
      ...
      } else if (era.get(`cflag:${target}:311`) <= 1 || era.get('flag:7') == 2) { // :1901
  ...
  if (era_flag.selectcom == 11 && era.get(`tequip:${target}:11`)) { // :1913

    if (era.get(`cflag:${target}:312`) == 0) { // :1915

      if (era.get(`talent:${target}:0`) == 1) { // :1917

        if (era.get(`talent:${target}:76`) == 1) { // :1919
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :1925
        ...
        if (era.get(`talent:${target}:76`) == 1) { // :1937
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :1941
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:312`) <= 4 || era.get('flag:7') == 2)) { // :1954
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:312`) <= 3 || era.get('flag:7') == 2)) { // :1960
      ...
      } else if (era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:312`) <= 2 || era.get('flag:7') == 2)) { // :1965
      ...
      } else if (era.get(`cflag:${target}:312`) <= 1 || era.get('flag:7') == 2) { // :1971
  ...
  } else if (era_flag.selectcom == 11 && era.get(`tequip:${target}:11`) == 0) { // :1978

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:372`) < 3 || era.get('flag:7') == 2)) { // :1980
    ...
    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:372`) < 2 || era.get('flag:7') == 2)) { // :1985
    ...
    } else if (era.get(`cflag:${target}:372`) < 1 || era.get('flag:7') == 2) { // :1990
  ...
  if (era_flag.selectcom == 12) { // :2002

    if (era.get(`cflag:${target}:313`) == 0) { // :2004

      if (era.get(`talent:${target}:76`) == 1) { // :2006
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :2011
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:313`) <= 4 || era.get('flag:7') == 2)) { // :2026
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:313`) <= 3 || era.get('flag:7') == 2)) { // :2032
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:313`) <= 2 || era.get('flag:7') == 2)) { // :2038
      ...
      } else if (era.get(`cflag:${target}:313`) <= 1 || era.get('flag:7') == 2) { // :2043
  ...
  if (era_flag.selectcom == 13 && era.get(`tequip:${target}:13`)) { // :2055

    if (era.get(`cflag:${target}:314`) == 0) { // :2057

      if (era.get(`talent:${target}:76`) == 1) { // :2059
        await era.printAndWait(`「啊啊啊~…肛穴在…被侵犯着呢~~…${heart(1)}」`); // :2060
        await era.printAndWait(`「请让可爱的蠕虫酱…将${sc()}的肛穴弄得更加舒服起来吧~~${heart(3)}」`); // :2061

      } else if (era.get(`talent:${target}:85`) == 1) { // :2063
      ...
      era.set(`cflag:${target}:314`, 1); // :2070
      return 0; // :2071

    } else { // :2073

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:314`) <= 6 || era.get('flag:7') == 2)) { // :2075
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:314`) <= 5 || era.get('flag:7') == 2)) { // :2081
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:314`) <= 4 || era.get('flag:7') == 2)) { // :2087
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:314`) <= 3 || era.get('flag:7') == 2)) { // :2094
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:314`) <= 2 || era.get('flag:7') == 2)) { // :2100
      ...
      } else if (era.get(`cflag:${target}:314`) <= 1 || era.get('flag:7') == 2) { // :2106
  ...
  } else if (era_flag.selectcom == 13 && era.get(`tequip:${target}:13`) == 0) { // :2114

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:374`) < 4 || era.get('flag:7') == 2)) { // :2116
    ...
    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:374`) < 3 || era.get('flag:7') == 2)) { // :2122
      await era.printAndWait(`「哈啊…哈啊…啊啊~…屁股的洞居然…那么…舒服………」`); // :2123
      // CFLAG:374  = 3（变量语义：CFLAG 族，374） // :2124
      era.set(`cflag:${target}:374`, 3); // :2124

    } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:374`) < 2 || era.get('flag:7') == 2)) { // :2126
      await era.printAndWait(`「啊哈嗯~…更、更多~………♪」`); // :2127
      // CFLAG:374  = 2（变量语义：CFLAG 族，374） // :2128
      era.set(`cflag:${target}:374`, 2); // :2128

    } else if (era.get(`cflag:${target}:374`) < 1 || era.get('flag:7') == 2) { // :2130
  ...
  if (era_flag.selectcom == 14 && era.get(`tequip:${target}:14`)) { // :2141

    if (era.get(`cflag:${target}:315`) == 0) { // :2143

      if (era.get(`talent:${target}:76`) == 1) { // :2145
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:315`) <= 3 || era.get('flag:7') == 2)) { // :2159
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:315`) <= 2 || era.get('flag:7') == 2)) { // :2164
      ...
      } else if (era.get(`cflag:${target}:315`) <= 1 || era.get('flag:7') == 2) { // :2169
  ...
  } else if (era_flag.selectcom == 14 && era.get(`tequip:${target}:14`) == 0) { // :2176

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:375`) < 3 || era.get('flag:7') == 2)) { // :2178
      await era.printAndWait(`「啊啊~…还没有满足呢~…这次就用主人的手来~………${heart(1)}」`); // :2179
      // CFLAG:375  = 3（变量语义：CFLAG 族，375） // :2180
      era.set(`cflag:${target}:375`, 3); // :2180

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:375`) < 2 || era.get('flag:7') == 2)) { // :2182
      await era.printAndWait(`「啊啊…${sc()}...可能已经不行了…♪」`); // :2183
      // CFLAG:375  = 2（变量语义：CFLAG 族，375） // :2184
      era.set(`cflag:${target}:375`, 2); // :2184

    } else if (era.get(`cflag:${target}:375`) < 1 || era.get('flag:7') == 2) { // :2186
  ...
  if (era_flag.selectcom == 15 && era.get(`tequip:${target}:15`)) { // :2198

    if (era.get(`cflag:${target}:316`) == 0) { // :2200

      if (era.get(`talent:${target}:76`) == 1) { // :2202
        await era.printAndWait(`「啊啊~…请将乳头…更加尽情地~…${heart(1)}」`); // :2203

      } else if (era.get(`talent:${target}:85`) == 1) { // :2205
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:316`) <= 3 || era.get('flag:7') == 2)) { // :2217
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:316`) <= 2 || era.get('flag:7') == 2)) { // :2222
      ...
      } else if (era.get(`cflag:${target}:316`) <= 1 || era.get('flag:7') == 2) { // :2227
  ...
  } else if (era_flag.selectcom == 15 && era.get(`tequip:${target}:15`) == 0) { // :2234

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:376`) < 3 || era.get('flag:7') == 2)) { // :2236
      await era.printAndWait(`「哈啊啊啊~…乳头居然变成那么不像样子了…${heart(1)}」`); // :2237
      // CFLAG:376  = 3（变量语义：CFLAG 族，376） // :2238
      era.set(`cflag:${target}:376`, 3); // :2238

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:376`) < 2 || era.get('flag:7') == 2)) { // :2240
      await era.printAndWait(`「哈啊…哈啊…哈嗯…胸部好难受的啊…♪」`); // :2241
      // CFLAG:376  = 2（变量语义：CFLAG 族，376） // :2242
      era.set(`cflag:${target}:376`, 2); // :2242

    } else if (era.get(`cflag:${target}:376`) < 1 || era.get('flag:7') == 2) { // :2244
  ...
  if (era_flag.selectcom == 16 && era.get(`tequip:${target}:16`)) { // :2256

    if (era.get(`cflag:${target}:317`) == 0) { // :2258

      if (era.get(`talent:${target}:76`) == 1) { // :2260
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:317`) <= 3 || era.get('flag:7') == 2)) { // :2277
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:317`) <= 2 || era.get('flag:7') == 2)) { // :2282
      ...
      } else if (era.get(`cflag:${target}:317`) <= 1 || era.get('flag:7') == 2) { // :2287
  ...
  } else if (era_flag.selectcom == 16 && era.get(`tequip:${target}:16`) == 0) { // :2295

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:377`) < 3 || era.get('flag:7') == 2)) { // :2297
    ...
    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:377`) < 2 || era.get('flag:7') == 2)) { // :2301
      await era.printAndWait(`「哈啊哈啊…只喝一口也没有关系，请大人您尝一尝吧~…♪」`); // :2302
      // CFLAG:377  = 2（变量语义：CFLAG 族，377） // :2303
      era.set(`cflag:${target}:377`, 2); // :2303

    } else if (era.get(`cflag:${target}:377`) < 1 || era.get('flag:7') == 2) { // :2305
  ...
  if (era_flag.selectcom == 19 && era.get(`tequip:${target}:19`)) { // :2372

    if (era.get(`cflag:${target}:320`) == 0) { // :2374

      if (era.get(`talent:${target}:76`) == 1) { // :2376
        await era.printAndWait(`「嗯哈噢噢噢~…${heart(1)}」`); // :2377
        await era.printAndWait(`「小球…进去了…啊啊~…嗯哈啊啊~…${heart(1)}」`); // :2378

      } else if (era.get(`talent:${target}:85`) == 1) { // :2380
      ...
      era.set(`cflag:${target}:320`, 1); // :2386
      return 0; // :2387

    } else { // :2389

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:320`) <= 6 || era.get('flag:7') == 2)) { // :2391
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:320`) <= 5 || era.get('flag:7') == 2)) { // :2397
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:320`) <= 4 || era.get('flag:7') == 2)) { // :2402
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:320`) <= 3 || era.get('flag:7') == 2)) { // :2408
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:320`) <= 2 || era.get('flag:7') == 2)) { // :2413
      ...
      } else if (era.get(`cflag:${target}:320`) <= 1 || era.get('flag:7') == 2) { // :2417
  ...
  } else if (era_flag.selectcom == 19 && era.get(`tequip:${target}:19`) == 0) { // :2424

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:379`) < 4 || era.get('flag:7') == 2)) { // :2426
      await era.printAndWait(`「哈啊恩~…肛穴…好像往外翻了………${heart(3)}」`); // :2427
      // CFLAG:379  = 4（变量语义：CFLAG 族，379） // :2428
      era.set(`cflag:${target}:379`, 4); // :2428

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:379`) < 3 || era.get('flag:7') == 2)) { // :2430
      await era.printAndWait(`「哈呜呀啊啊~……♪　请更加地…欺负屁股吧~${heart(1)}」`); // :2431
      // CFLAG:379  = 3（变量语义：CFLAG 族，379） // :2432
      era.set(`cflag:${target}:379`, 3); // :2432

    } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:379`) < 2 || era.get('flag:7') == 2)) { // :2434
      await era.printAndWait(`「嗯哼唔~…不行~…屁股被欺负的话…就要变得不行了啊~…」`); // :2435
      // CFLAG:379  = 2（变量语义：CFLAG 族，379） // :2436
      era.set(`cflag:${target}:379`, 2); // :2436

    } else if (era.get(`cflag:${target}:379`) < 1 || era.get('flag:7') == 2) { // :2438
  ...
  if (era_flag.selectcom == 20) { // :2448

    if (era.get(`cflag:${target}:321`) == 0) { // :2450

      if (era.get(`talent:${target}:0`) == 1) { // :2452

        if (era.get(`talent:${target}:76`) == 1) { // :2454

          if (era.get(`talent:${target}:314`) == 7) { // :2456
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :2466
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :2480

          if (era.get(`talent:${target}:314`) == 1) { // :2482
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :2491
          ...
          if (era.get(`talent:${target}:317`) == 4) { // :2507
        ...
        if (era.get(`talent:${target}:76`) == 1) { // :2520
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :2525
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:321`) <= 5 || era.get('flag:7') == 2)) { // :2538
        if (rand_n(3) == 0) { // :2539
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:321`) <= 4 || era.get('flag:7') == 2)) { // :2555
        if (rand_n(3) == 0) { // :2556
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:321`) <= 3 || era.get('flag:7') == 2)) { // :2571
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:321`) <= 2 || era.get('flag:7') == 2)) { // :2577
      ...
      } else if (era.get(`cflag:${target}:321`) <= 1 || era.get('flag:7') == 2) { // :2582
  ...
  if (era_flag.selectcom == 21) { // :2594

    if (era.get(`cflag:${target}:322`) == 0) { // :2596

      if (era.get(`talent:${target}:0`) == 1) { // :2598

        if (era.get(`talent:${target}:76`) == 1) { // :2600

          if (era.get(`talent:${target}:314`) == 7) { // :2602
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :2613
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :2629

          if (era.get(`talent:${target}:314`) == 1) { // :2631
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :2640
          ...
          if (era.get(`talent:${target}:317`) == 4) { // :2659
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:322`) <= 5 || era.get('flag:7') == 2)) { // :2691
        if (era.get(`tequip:${target}:44`) == 1) { // :2692
          if (rand_n(2) == 0) { // :2693
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:322`) <= 4 || era.get('flag:7') == 2)) { // :2721
        if (rand_n(3) == 0) { // :2722
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:322`) <= 3 || era.get('flag:7') == 2)) { // :2736
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:322`) <= 2 || era.get('flag:7') == 2)) { // :2741
      ...
      } else if (era.get(`cflag:${target}:322`) <= 1 || era.get('flag:7') == 2) { // :2746
  ...
  if (era_flag.selectcom == 22) { // :2759
    if (era.get(`cflag:${target}:323`) == 0) { // :2760

      if (era.get(`talent:${target}:0`) == 1) { // :2762

        if (era.get(`talent:${target}:76`) == 1) { // :2764
          await era.printAndWait(''); // :2765

        } else if (era.get(`talent:${target}:85`) == 1) { // :2767
        ...
        if (era.get(`talent:${target}:76`) == 1) { // :2776
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :2781
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:323`) <= 5 || era.get('flag:7') == 2)) { // :2795
        if (rand_n(3) == 0) { // :2796
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:323`) <= 4 || era.get('flag:7') == 2)) { // :2811
        if (rand_n(3) == 0) { // :2812
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:323`) <= 3 || era.get('flag:7') == 2)) { // :2828
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:323`) <= 2 || era.get('flag:7') == 2)) { // :2834
      ...
      } else if (era.get(`cflag:${target}:323`) <= 1 || era.get('flag:7') == 2) { // :2839
  ...
  if (era_flag.selectcom == 23) { // :2851
    if (era.get(`cflag:${target}:324`) == 0) { // :2852

      if (era.get(`talent:${target}:0`) == 1) { // :2854

        if (era.get(`talent:${target}:76`) == 1) { // :2856
          await era.printAndWait(''); // :2857

        } else if (era.get(`talent:${target}:85`) == 1) { // :2859
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:324`) <= 5 || era.get('flag:7') == 2)) { // :2885
        if (rand_n(3) == 0) { // :2886
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:324`) <= 4 || era.get('flag:7') == 2)) { // :2900
        if (rand_n(3) == 0) { // :2901
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:324`) <= 3 || era.get('flag:7') == 2)) { // :2916
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:324`) <= 2 || era.get('flag:7') == 2)) { // :2922
      ...
      } else if (era.get(`cflag:${target}:324`) <= 1 || era.get('flag:7') == 2) { // :2926
  ...
  if (era_flag.selectcom == 24) { // :2937
    if (era.get(`cflag:${target}:325`) == 0) { // :2938

      if (era.get(`talent:${player}:0`) == 1) { // :2940

        if (era.get(`talent:${target}:76`) == 1) { // :2942
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :2946
        ...
        if (era.get(`talent:${target}:76`) == 1) { // :2956
      ...
      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:325`) <= 5 || era.get('flag:7') == 2)) { // :2971
        await era.printAndWait(''); // :2972
        // CFLAG:325  = 6（变量语义：CFLAG 族，325） // :2973
        era.set(`cflag:${target}:325`, 6); // :2973

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:325`) <= 4 || era.get('flag:7') == 2)) { // :2975
        await era.printAndWait(''); // :2976
        // CFLAG:325  = 5（变量语义：CFLAG 族，325） // :2977
        era.set(`cflag:${target}:325`, 5); // :2977

      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:20`) >= 3 && (era.get(`cflag:${target}:325`) <= 3 || era.get('flag:7') == 2)) { // :2979
        if (rand_n(2) == 0) { // :2980
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:325`) <= 2 || era.get('flag:7') == 2)) { // :2989
      ...
      } else if (era.get(`cflag:${target}:325`) <= 1 || era.get('flag:7') == 2) { // :2994
        if (rand_n(2) == 0) { // :2995
  ...
  if (era_flag.selectcom == 26) { // :3010

    if (era.get(`cflag:${target}:327`) == 0) { // :3012

      if (era.get(`talent:${target}:76`) == 1) { // :3014

        if (era.get(`talent:${target}:314`) == 7) { // :3016
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :3028

        if (era.get(`talent:${target}:314`) == 1) { // :3030
      ...
      era.set(`cflag:${target}:327`, 1); // :3046
      return 0; // :3047

    } else { // :3049

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:327`) <= 6 || era.get('flag:7') == 2)) { // :3051
        if (rand_n(3) == 0) { // :3052
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:327`) <= 5 || era.get('flag:7') == 2)) { // :3067
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:327`) <= 4 || era.get('flag:7') == 2)) { // :3072
        if (rand_n(2) == 0) { // :3073
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:327`) <= 3 || era.get('flag:7') == 2)) { // :3084
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:327`) <= 2 || era.get('flag:7') == 2)) { // :3089
      ...
      } else if (era.get(`cflag:${target}:327`) <= 1 || era.get('flag:7') == 2) { // :3094
  ...
  if (era_flag.selectcom == 27) { // :3106

    if (era.get(`cflag:${target}:328`) == 0) { // :3108

      if (era.get(`talent:${target}:76`) == 1) { // :3110

        if (era.get(`talent:${target}:314`) == 7) { // :3112
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :3125

        if (era.get(`talent:${target}:314`) == 1) { // :3127
      ...
      era.set(`cflag:${target}:328`, 1); // :3144
      return 0; // :3145

    } else { // :3147

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:328`) <= 6 || era.get('flag:7') == 2)) { // :3149
        if (rand_n(3) == 0) { // :3150
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:328`) <= 5 || era.get('flag:7') == 2)) { // :3166
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:328`) <= 4 || era.get('flag:7') == 2)) { // :3171
        if (rand_n(2) == 0) { // :3172
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:328`) <= 3 || era.get('flag:7') == 2)) { // :3182
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:328`) <= 2 || era.get('flag:7') == 2)) { // :3187
      ...
      } else if (era.get(`cflag:${target}:328`) <= 1 || era.get('flag:7') == 2) { // :3192
  ...
  if (era_flag.selectcom == 28) { // :3204

    if (era.get(`cflag:${target}:329`) == 0) { // :3206
      ...
      era.set(`cflag:${target}:329`, 1); // :3221
      return 0; // :3222

    } else { // :3224

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:329`) <= 6 || era.get('flag:7') == 2)) { // :3226
        if (rand_n(3) == 0) { // :3227
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:329`) <= 5 || era.get('flag:7') == 2)) { // :3241
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:329`) <= 4 || era.get('flag:7') == 2)) { // :3246
        if (rand_n(2) == 0) { // :3247
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:329`) <= 3 || era.get('flag:7') == 2)) { // :3258
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:329`) <= 2 || era.get('flag:7') == 2)) { // :3263
      ...
      } else if (era.get(`cflag:${target}:329`) <= 1 || era.get('flag:7') == 2) { // :3268
  ...
  if (era_flag.selectcom == 29) { // :3279

    if (era.get(`cflag:${target}:330`) == 0) { // :3281

      if (era.get(`talent:${target}:76`) == 1) { // :3283
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :3288
      ...
      era.set(`cflag:${target}:330`, 1); // :3295
      return 0; // :3296

    } else { // :3298

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:330`) <= 6 || era.get('flag:7') == 2)) { // :3300
        if (rand_n(2) == 0) { // :3301
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:330`) <= 5 || era.get('flag:7') == 2)) { // :3312
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:330`) <= 4 || era.get('flag:7') == 2)) { // :3317
        if (rand_n(2) == 0) { // :3318
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:330`) <= 3 || era.get('flag:7') == 2)) { // :3328
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:330`) <= 2 || era.get('flag:7') == 2)) { // :3333
      ...
      } else if (era.get(`cflag:${target}:330`) <= 1 || era.get('flag:7') == 2) { // :3338
  ...
  if (era_flag.selectcom == 30) { // :3349

    if (era.get(`cflag:${target}:331`) == 0) { // :3351

      if (era.get(`talent:${target}:76`) == 1) { // :3353
      ...
      era.set(`cflag:${target}:331`, 1); // :3368
      return 0; // :3369

    } else { // :3371

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:331`) <= 6 || era.get('flag:7') == 2)) { // :3373
        if (era.get(`talent:${player}:318`) == 1) { // :3374

          await era.printAndWait(`「雄伟的大肉棒……把这放到女人的阴道里……咽口水${heart(1)}」`); // :3376
        } else if (era.get(`talent:${player}:318`) == 2) { // :3377

          await era.printAndWait(`「小孩子似的鲜肉棒棒，拼尽全力地勃起着呢${heart(1)}　这样子还不够挑逗女人哦？${heart(1)}」`); // :3379
        } else if (era.get(`talent:${player}:318`) == 3) { // :3380

          await era.printAndWait(`「最喜欢剥开……包茎的外皮了${heart(1)}　味道简直让人受不了${heart(1)}」`); // :3382
        } else if (era.get(`talent:${player}:318`) == 4) { // :3383
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:331`) <= 5 || era.get('flag:7') == 2)) { // :3396
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:331`) <= 4 || era.get('flag:7') == 2)) { // :3402
        if (era.get(`talent:${player}:318`) == 1) { // :3403

          await era.printAndWait(`「雄伟的大肉棒啊……把这个插进${sc()}的里面来……咽口水${heart(1)}」`); // :3405
        } else if (era.get(`talent:${player}:318`) == 2) { // :3406

          await era.printAndWait(`「小孩子似的鲜肉棒棒，拼尽全力地勃起着呢${heart(1)}　真是可爱${heart(1)}」`); // :3408
        } else if (era.get(`talent:${player}:318`) == 3) { // :3409

          await era.printAndWait(`「就喜欢剥开……包茎的外皮了${heart(1)}　你的味道真是让人受不了${heart(1)}」`); // :3411
        } else if (era.get(`talent:${player}:318`) == 4) { // :3412
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:331`) <= 3 || era.get('flag:7') == 2)) { // :3427
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:331`) <= 2 || era.get('flag:7') == 2)) { // :3433
      ...
      } else if (era.get(`cflag:${target}:331`) <= 1 || era.get('flag:7') == 2) { // :3438
  ...
  if (era_flag.selectcom == 31) { // :3450

    if (era.get(`cflag:${target}:332`) == 0) { // :3452
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :3459
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :3464
      ...
      era.set(`cflag:${target}:332`, 1); // :3471
      return 0; // :3472

    } else { // :3474

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:332`) <= 4 || era.get('flag:7') == 2)) { // :3476
        if (rand_n(3) == 0) { // :3477
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:332`) <= 3 || era.get('flag:7') == 2)) { // :3492
        if (rand_n(3) == 0) { // :3493
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:332`) <= 2 || era.get('flag:7') == 2)) { // :3508
      ...
      } else if (era.get(`cflag:${target}:332`) <= 1 || era.get('flag:7') == 2) { // :3513
  ...
  if (era_flag.selectcom == 32) { // :3524

    if (era.get(`cflag:${target}:333`) == 0) { // :3526
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :3537
      ...
      era.set(`cflag:${target}:333`, 1); // :3543
      return 0; // :3544

    } else { // :3546

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:332`) <= 6 || era.get('flag:7') == 2)) { // :3548
        if (rand_n(2) == 0) { // :3549
          await era.printAndWait(`「啊啊~…大鸡巴好热啊~…胸部好舒服的啊~${heart(1)}」`); // :3550
          await era.printAndWait(`「嗯~…啊嗯~…大鸡巴好像也很舒服的样子啊~~~♪」`); // :3551
          if (era.get(`talent:${target}:110`) == 1 || era.get(`talent:${target}:114`) == 1 || era.get(`talent:${target}:119`) == 1) { // :3553
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:332`) <= 5 || era.get('flag:7') == 2)) { // :3562
        await era.printAndWait(`「啊啊~…大鸡巴好热啊~…胸部好舒服啊~${heart(1)}」`); // :3563
        await era.printAndWait(`「嗯~…啊嗯~…大鸡巴好像也很舒服的样子啊~~~♪」`); // :3564
        if (era.get(`talent:${target}:110`) == 1 || era.get(`talent:${target}:114`) == 1 || era.get(`talent:${target}:119`) == 1) { // :3566
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:333`) <= 4 || era.get('flag:7') == 2)) { // :3570
        if (rand_n(2) == 0) { // :3571
          await era.printAndWait(`「嗯~…啊啊~…要用${sc()}的胸部来侍奉的对吧~♪」`); // :3572
          if (era.get(`talent:${target}:110`) == 1 || era.get(`talent:${target}:114`) == 1 || era.get(`talent:${target}:119`) == 1) { // :3574
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:333`) <= 3 || era.get('flag:7') == 2)) { // :3582
        await era.printAndWait(`「嗯~…啊啊~…要用${sc()}的胸部来侍奉的对吧~♪」`); // :3583
        if (era.get(`talent:${target}:110`) == 1 || era.get(`talent:${target}:114`) == 1 || era.get(`talent:${target}:119`) == 1) { // :3585
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:333`) <= 2 || era.get('flag:7') == 2)) { // :3589
      ...
      } else if (era.get(`cflag:${target}:333`) <= 1 || era.get('flag:7') == 2) { // :3594
  ...
  if (era_flag.selectcom == 33) { // :3606

    if (era.get(`cflag:${target}:334`) == 0) { // :3608

      if (era.get(`talent:${target}:76`) == 1) { // :3610
        await era.printAndWait(`「啊~…嗯呜~…${sc()}什么时候都准备好来着的~…也不插进来…就这样做什么的…${heart(1)}」`); // :3611
        await era.printAndWait(`「啊~啊~啊啊~…啊啊~…在摩擦着呢~…${heart(1)}」`); // :3612

      } else if (era.get(`talent:${target}:85`) == 1) { // :3614
      ...
      era.set(`cflag:${target}:334`, 1); // :3622
      return 0; // :3623

    } else { // :3625

      if (era.get(`talent:${target}:76`) == 1 && era.get(`talent:${target}:0`) == 1 && (era.get(`cflag:${target}:334`) <= 5 || era.get('flag:7') == 2)) { // :3627
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:334`) <= 4 || era.get('flag:7') == 2)) { // :3634
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`talent:${target}:0`) == 1 && (era.get(`cflag:${target}:334`) <= 3 || era.get('flag:7') == 2)) { // :3640
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:334`) <= 2 || era.get('flag:7') == 2)) { // :3646
      ...
      } else if (era.get(`cflag:${target}:334`) <= 1 || era.get('flag:7') == 2) { // :3653
  ...
  if (era_flag.selectcom == 34) { // :3666

    if (era.get(`cflag:${target}:335`) == 0) { // :3668

      if (era.get(`talent:${target}:0`) == 1) { // :3670

        if (era.get(`talent:${target}:76`) == 1) { // :3672

          if (era.get(`talent:${target}:314`) == 7) { // :3674
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :3687
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :3705

          if (era.get(`talent:${target}:314`) == 1) { // :3707
            ...
            if (era.get(`talent:${target}:317`) == 4) { // :3718
          ...
          if (era.get(`talent:${target}:317`) == 4) { // :3735
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :3751
      ...
      era.set(`cflag:${target}:335`, 1); // :3759
      return 0; // :3760

    } else { // :3762

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:335`) <= 5 || era.get('flag:7') == 2)) { // :3764
        if (rand_n(4) == 0) { // :3765
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:335`) <= 4 || era.get('flag:7') == 2)) { // :3781
        if (rand_n(4) == 0) { // :3782
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:335`) <= 3 || era.get('flag:7') == 2)) { // :3799
        if (rand_n(3) == 0) { // :3800
          await era.printAndWait(`「嗯哈啊~${heart(1)} 进…进到了…深处了呀~${heart(1)}」`); // :3801
          await era.printAndWait(`「啊啊~…这么…下流的样子…明明…完全不想晃动起腰部来的~…♪」`); // :3802
        } else if (rand_n(2) == 0) { // :3803
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:335`) <= 2 || era.get('flag:7') == 2)) { // :3812
      ...
      } else if (era.get(`cflag:${target}:335`) <= 1 || era.get('flag:7') == 2) { // :3817
  ...
  if (era_flag.selectcom == 35) { // :3829

    if (era.get(`cflag:${target}:336`) == 0) { // :3831

      if (era.get(`abl:${target}:16`) >= 3) { // :3833
      ...
      era.set(`cflag:${target}:336`, 1); // :3841
      return 0; // :3842

    } else { // :3844

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:336`) <= 4 || era.get('flag:7') == 2)) { // :3846
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:336`) <= 3 || era.get('flag:7') == 2)) { // :3852
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:336`) <= 2 || era.get('flag:7') == 2)) { // :3857
      ...
      } else if (era.get(`cflag:${target}:336`) <= 1 || era.get('flag:7') == 2) { // :3862
  ...
  if (era_flag.selectcom == 36) { // :3874

    if (era.get(`cflag:${target}:337`) == 0) { // :3876

      if (era.get(`talent:${target}:76`) == 1) { // :3878
        await era.printAndWait(`「嗯哼哼~${heart(1)}…${target_name}会用肛穴来好好侍奉大人您的~${heart(1)}」`); // :3879
        await era.printAndWait(`「请尽情地变得舒服起来吧~${heart(3)}」`); // :3880

      } else if (era.get(`talent:${target}:85`) == 1) { // :3882
      ...
      era.set(`cflag:${target}:337`, 1); // :3889
      return 0; // :3890

    } else { // :3892

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:337`) <= 6 || era.get('flag:7') == 2)) { // :3894
        if (rand_n(2) == 0) { // :3895
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:337`) <= 5 || era.get('flag:7') == 2)) { // :3906
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:337`) <= 4 || era.get('flag:7') == 2)) { // :3911
        if (rand_n(2) == 0) { // :3912
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:337`) <= 2 || era.get('flag:7') == 2)) { // :3926
      ...
      } else if (era.get(`cflag:${target}:337`) <= 1 || era.get('flag:7') == 2) { // :3930
  ...
  if (era_flag.selectcom == 37) { // :3942

    if (era.get(`cflag:${target}:338`) == 0) { // :3944

      if (era.get(`abl:${target}:16`) >= 3) { // :3946
      ...
      era.set(`cflag:${target}:338`, 1); // :3953
      return 0; // :3954

    } else { // :3956

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:338`) <= 4 || era.get('flag:7') == 2)) { // :3958
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:338`) <= 3 || era.get('flag:7') == 2)) { // :3964
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:338`) <= 2 || era.get('flag:7') == 2)) { // :3969
      ...
      } else if (era.get(`cflag:${target}:338`) <= 1 || era.get('flag:7') == 2) { // :3974
  ...
  if (era_flag.selectcom == 38) { // :3986

    if (era.get(`cflag:${target}:339`) == 0) { // :3988
      await era.printAndWait(`「想要被踩吗~？……真是奇怪的兴趣来的呢~」`); // :3989
      // CFLAG:TARGET:339  = 1（变量语义：CFLAG 族，TARGET:339） // :3990
      era.set(`cflag:${target}:339`, 1); // :3990
      return 0; // :3991

    } else { // :3993

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:20`) >= 3 && (era.get(`cflag:${target}:339`) <= 4 || era.get('flag:7') == 2)) { // :3995
        if (rand_n(2) == 0) { // :3996
        ...
        era.set(`cflag:${target}:339`, 5); // :4011

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:20`) >= 3 && (era.get(`cflag:${target}:339`) <= 3 || era.get('flag:7') == 2)) { // :4013

        if (era_flag.assi > 0 && era_flag.assiplay) { // :4015
        ...
        era.set(`cflag:${target}:339`, 4); // :4022
        return 0; // :4023

      } else if (era.get(`abl:${target}:20`) >= 1 && (era.get(`cflag:${target}:339`) <= 2 || era.get('flag:7') == 2)) { // :4025
        if (rand_n(2) == 0) { // :4026
        ...
        era.set(`cflag:${target}:339`, 3); // :4038
        return 0; // :4039

      } else if (era.get(`cflag:${target}:339`) <= 1 || era.get('flag:7') == 2) { // :4041
        if (rand_n(2) == 0) { // :4042
        ...
        era.set(`cflag:${target}:339`, 2); // :4052
      } // :4053
      return 0; // :4054
    } // :4055
  } // :4056
  ...
  if (era_flag.selectcom == 40) { // :4062

    if (era.get(`cflag:${target}:341`) == 0) { // :4064
      await era.printAndWait(`「不要啊！？ 请、不要打${target_name}！好疼啊！」`); // :4065
      // CFLAG:TARGET:341  = 1（变量语义：CFLAG 族，TARGET:341） // :4066
      era.set(`cflag:${target}:341`, 1); // :4066
      return 0; // :4067

    } else { // :4069

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:341`) <= 4 || era.get('flag:7') == 2)) { // :4071
        ...
        era.set(`cflag:${target}:341`, 5); // :4075

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:341`) <= 3 || era.get('flag:7') == 2)) { // :4077
        ...
        era.set(`cflag:${target}:341`, 4); // :4081
        return 0; // :4082

      } else if (era.get(`mark:${target}:0`) == 3 && era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:341`) <= 2 || era.get('flag:7') == 2)) { // :4084
        ...
        era.set(`cflag:${target}:341`, 3); // :4087
        return 0; // :4088

      } else if (era.get(`cflag:${target}:341`) <= 1 || era.get('flag:7') == 2) { // :4090
        ...
        era.set(`cflag:${target}:341`, 2); // :4093
      } // :4094
      return 0; // :4095
    } // :4096
  } // :4097
  ...
  if (era_flag.selectcom == 41) { // :4103

    if (era.get(`cflag:${target}:342`) == 0) { // :4105

      if (era.get(`talent:${target}:76`) == 1) { // :4107
        await era.printAndWait(`「啊嗯~…啊~啊啊~…请处罚${target_name}吧~…${heart(1)}」`); // :4108

      } else if (era.get(`talent:${target}:85`) == 1) { // :4110
      ...
      era.set(`cflag:${target}:342`, 1); // :4117
      return 0; // :4118

    } else { // :4120

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:342`) <= 8 || era.get('flag:7') == 2)) { // :4122
        ...
        era.set(`cflag:${target}:342`, 9); // :4126

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:342`) <= 7 || era.get('flag:7') == 2)) { // :4128
        ...
        era.set(`cflag:${target}:342`, 8); // :4132

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:342`) <= 6 || era.get('flag:7') == 2)) { // :4134
        ...
        era.set(`cflag:${target}:342`, 7); // :4137

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:342`) <= 5 || era.get('flag:7') == 2)) { // :4139
        ...
        era.set(`cflag:${target}:342`, 6); // :4142

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:342`) <= 4 || era.get('flag:7') == 2)) { // :4144
        ...
        era.set(`cflag:${target}:342`, 5); // :4147

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:342`) <= 3 || era.get('flag:7') == 2)) { // :4149
        ...
        era.set(`cflag:${target}:342`, 4); // :4152

      } else if (era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:342`) <= 2 || era.get('flag:7') == 2)) { // :4154
        ...
        era.set(`cflag:${target}:342`, 3); // :4157

      } else if (era.get(`cflag:${target}:335`) <= 1 || era.get('flag:7') == 2) { // :4159
        await era.printAndWait(`「不、不要啊…已经…被打的不要啊…不要啊………」`); // :4160
        // CFLAG:TARGET:342  = 2（变量语义：CFLAG 族，TARGET:342） // :4161
        era.set(`cflag:${target}:342`, 2); // :4161
      } // :4162
      return 0; // :4163
    } // :4164
  } // :4165
  ...
  if (era_flag.selectcom == 42) { // :4171

    if (era.get(`cflag:${target}:343`) == 0) { // :4173

      if (era.get(`talent:${target}:76`) == 1) { // :4175
        await era.printAndWait(`「哈呜…不，不行的啊…请、请原谅…请原谅${sc()}吧！！！」`); // :4176

      } else if (era.get(`talent:${target}:85`) == 1) { // :4178
      ...
      era.set(`cflag:${target}:343`, 1); // :4184
      return 0; // :4185

    } else { // :4187

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:343`) <= 8 || era.get('flag:7') == 2)) { // :4189
        ...
        era.set(`cflag:${target}:343`, 9); // :4192

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:343`) <= 7 || era.get('flag:7') == 2)) { // :4194
        ...
        era.set(`cflag:${target}:343`, 8); // :4197

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:343`) <= 6 || era.get('flag:7') == 2)) { // :4199
        ...
        era.set(`cflag:${target}:343`, 7); // :4202

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:343`) <= 5 || era.get('flag:7') == 2)) { // :4204
        ...
        era.set(`cflag:${target}:343`, 6); // :4207

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:343`) <= 4 || era.get('flag:7') == 2)) { // :4209
        ...
        era.set(`cflag:${target}:343`, 5); // :4212

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:343`) <= 3 || era.get('flag:7') == 2)) { // :4214
        ...
        era.set(`cflag:${target}:343`, 4); // :4217

      } else if (era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:343`) <= 2 || era.get('flag:7') == 2)) { // :4219
        ...
        era.set(`cflag:${target}:343`, 3); // :4222

      } else if (era.get(`cflag:${target}:343`) <= 1 || era.get('flag:7') == 2) { // :4224
        await era.printAndWait(`「嗯呜！…不要不要不要啊啊啊啊啊！」`); // :4225
        // CFLAG:TARGET:343  = 2（变量语义：CFLAG 族，TARGET:343） // :4226
        era.set(`cflag:${target}:343`, 2); // :4226
      } // :4227
      return 0; // :4228
    } // :4229
  } // :4230
  ...
  if (era_flag.selectcom == 43 && era.get(`tequip:${target}:43`)) { // :4236

    if (era.get(`cflag:${target}:344`) == 0) { // :4238

      if (era.get(`talent:${target}:76`) == 1) { // :4240
        await era.printAndWait(''); // :4241

      } else if (era.get(`talent:${target}:85`) == 1) { // :4243
      ...
      era.set(`cflag:${target}:344`, 1); // :4249
      return 0; // :4250

    } else { // :4252

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:344`) <= 8 || era.get('flag:7') == 2)) { // :4254
        await era.printAndWait(''); // :4255
        // CFLAG:TARGET:344  = 9（变量语义：CFLAG 族，TARGET:344） // :4256
        era.set(`cflag:${target}:344`, 9); // :4256

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:344`) <= 7 || era.get('flag:7') == 2)) { // :4258
        await era.printAndWait(''); // :4259
        // CFLAG:TARGET:344  = 8（变量语义：CFLAG 族，TARGET:344） // :4260
        era.set(`cflag:${target}:344`, 8); // :4260

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:344`) <= 6 || era.get('flag:7') == 2)) { // :4262
        await era.printAndWait(''); // :4263
        // CFLAG:TARGET:344  = 7（变量语义：CFLAG 族，TARGET:344） // :4264
        era.set(`cflag:${target}:344`, 7); // :4264

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:344`) <= 5 || era.get('flag:7') == 2)) { // :4266
        await era.printAndWait(''); // :4267
        // CFLAG:TARGET:344  = 6（变量语义：CFLAG 族，TARGET:344） // :4268
        era.set(`cflag:${target}:344`, 6); // :4268

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:344`) <= 4 || era.get('flag:7') == 2)) { // :4270
        await era.printAndWait(''); // :4271
        // CFLAG:TARGET:344  = 5（变量语义：CFLAG 族，TARGET:344） // :4272
        era.set(`cflag:${target}:344`, 5); // :4272

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:344`) <= 3 || era.get('flag:7') == 2)) { // :4274
        await era.printAndWait(''); // :4275
        // CFLAG:TARGET:344  = 4（变量语义：CFLAG 族，TARGET:344） // :4276
        era.set(`cflag:${target}:344`, 4); // :4276

      } else if (era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:344`) <= 2 || era.get('flag:7') == 2)) { // :4278
        await era.printAndWait(''); // :4279
        // CFLAG:TARGET:344  = 3（变量语义：CFLAG 族，TARGET:344） // :4280
        era.set(`cflag:${target}:344`, 3); // :4280

      } else if (era.get(`cflag:${target}:344`) <= 1 || era.get('flag:7') == 2) { // :4282
        await era.printAndWait(''); // :4283
        // CFLAG:TARGET:344  = 2（变量语义：CFLAG 族，TARGET:344） // :4284
        era.set(`cflag:${target}:344`, 2); // :4284
      } // :4285
      return 0; // :4286
    } // :4287

  } else if (era_flag.selectcom == 43 && era.get(`tequip:${target}:43`) == 0) { // :4289

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:380`) < 3 || era.get('flag:7') == 2)) { // :4291
      await era.printAndWait(''); // :4292
      // CFLAG:380  = 3（变量语义：CFLAG 族，380） // :4293
      era.set(`cflag:${target}:380`, 3); // :4293

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:380`) < 2 || era.get('flag:7') == 2)) { // :4295
      await era.printAndWait(''); // :4296
      // CFLAG:380  = 2（变量语义：CFLAG 族，380） // :4297
      era.set(`cflag:${target}:380`, 2); // :4297

    } else if (era.get(`cflag:${target}:380`) < 1 || era.get('flag:7') == 2) { // :4299
  ...
  if (era_flag.selectcom == 44 && era.get(`tequip:${target}:44`)) { // :4311

    if (era.get(`cflag:${target}:345`) == 0) { // :4313

      if (era.get(`talent:${target}:76`) == 1) { // :4315
        await era.printAndWait(`「啊啊恩~…请更加用力地将${sc()}绑住吧~${heart(1)}」`); // :4316

      } else if (era.get(`talent:${target}:85`) == 1) { // :4318
      ...
      era.set(`cflag:${target}:345`, 1); // :4324
      return 0; // :4325

    } else { // :4327

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:345`) <= 8 || era.get('flag:7') == 2)) { // :4329
        ...
        era.set(`cflag:${target}:345`, 9); // :4333

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:345`) <= 7 || era.get('flag:7') == 2)) { // :4335
        ...
        era.set(`cflag:${target}:345`, 8); // :4339

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:345`) <= 6 || era.get('flag:7') == 2)) { // :4341
        ...
        era.set(`cflag:${target}:345`, 7); // :4344

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:345`) <= 5 || era.get('flag:7') == 2)) { // :4346
        ...
        era.set(`cflag:${target}:345`, 6); // :4350

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:345`) <= 4 || era.get('flag:7') == 2)) { // :4352
        ...
        era.set(`cflag:${target}:345`, 5); // :4356

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:345`) <= 3 || era.get('flag:7') == 2)) { // :4358
        ...
        era.set(`cflag:${target}:345`, 4); // :4361

      } else if (era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:345`) <= 2 || era.get('flag:7') == 2)) { // :4363
        ...
        era.set(`cflag:${target}:345`, 3); // :4366

      } else if (era.get(`cflag:${target}:345`) <= 1 || era.get('flag:7') == 2) { // :4368
        await era.printAndWait(`「哈啊~…哈啊~…请原谅…绳子好紧啊……请将绳子给解开吧~~~………」`); // :4369
        // CFLAG:TARGET:345  = 2（变量语义：CFLAG 族，TARGET:345） // :4370
        era.set(`cflag:${target}:345`, 2); // :4370
      } // :4371
      return 0; // :4372
    } // :4373

  } else if (era_flag.selectcom == 44 && era.get(`tequip:${target}:44`) == 0) { // :4375

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:385`) < 2 || era.get('flag:7') == 2)) { // :4377
      await era.printAndWait(`「哈啊…哈啊…啊啊…绳子装明明不错来的…${heart(1)}」`); // :4378
      // CFLAG:385  = 2（变量语义：CFLAG 族，385） // :4379
      era.set(`cflag:${target}:385`, 2); // :4379

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:385`) < 2 || era.get('flag:7') == 2)) { // :4381
    ...
    } else if (era.get(`cflag:${target}:385`) < 1 || era.get('flag:7') == 2) { // :4385
  ...
  if (era_flag.selectcom == 45 && era.get(`tequip:${target}:45`)) { // :4397

    if (era.get(`cflag:${target}:346`) == 0) { // :4399

      if (era.get(`talent:${target}:76`) == 1) { // :4401
        await era.printAndWait(`「嗯~…嗯呃~…嗯呼嗯~…嗯嗯~${heart(1)}」`); // :4402

      } else if (era.get(`talent:${target}:85`) == 1) { // :4404
      ...
      era.set(`cflag:${target}:346`, 1); // :4410
      return 0; // :4411

    } else { // :4413

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:346`) <= 8 || era.get('flag:7') == 2)) { // :4415
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4416
        // CFLAG:TARGET:346  = 9（变量语义：CFLAG 族，TARGET:346） // :4417
        era.set(`cflag:${target}:346`, 9); // :4417

      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:346`) <= 7 || era.get('flag:7') == 2)) { // :4419
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4420
        // CFLAG:TARGET:346  = 8（变量语义：CFLAG 族，TARGET:346） // :4421
        era.set(`cflag:${target}:346`, 8); // :4421

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:346`) <= 6 || era.get('flag:7') == 2)) { // :4423
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4424
        // CFLAG:TARGET:346  = 7（变量语义：CFLAG 族，TARGET:346） // :4425
        era.set(`cflag:${target}:346`, 7); // :4425

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 5 && (era.get(`cflag:${target}:346`) <= 5 || era.get('flag:7') == 2)) { // :4427
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4428
        // CFLAG:TARGET:346  = 6（变量语义：CFLAG 族，TARGET:346） // :4429
        era.set(`cflag:${target}:346`, 6); // :4429

      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:346`) <= 4 || era.get('flag:7') == 2)) { // :4431
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4432
        // CFLAG:TARGET:346  = 5（变量语义：CFLAG 族，TARGET:346） // :4433
        era.set(`cflag:${target}:346`, 5); // :4433

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:346`) <= 3 || era.get('flag:7') == 2)) { // :4435
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~${heart(1)}」`); // :4436
        // CFLAG:TARGET:346  = 4（变量语义：CFLAG 族，TARGET:346） // :4437
        era.set(`cflag:${target}:346`, 4); // :4437

      } else if (era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:346`) <= 2 || era.get('flag:7') == 2)) { // :4439
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~」`); // :4440
        // CFLAG:TARGET:346  = 3（变量语义：CFLAG 族，TARGET:346） // :4441
        era.set(`cflag:${target}:346`, 3); // :4441

      } else if (era.get(`cflag:${target}:346`) <= 1 || era.get('flag:7') == 2) { // :4443
        await era.printAndWait(`「嗯~…嗯呜~…嗯呼~…嗯嗯~」`); // :4444
        // CFLAG:TARGET:346  = 2（变量语义：CFLAG 族，TARGET:346） // :4445
        era.set(`cflag:${target}:346`, 2); // :4445
      } // :4446
      return 0; // :4447
    } // :4448

  } else if (era_flag.selectcom == 45 && era.get(`tequip:${target}:45`) == 0) { // :4450

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:386`) < 3 || era.get('flag:7') == 2)) { // :4452
      await era.printAndWait(`「嗯哈啊…哈啊…哈啊…哈啊…主人…${heart(1)}」`); // :4453
      // CFLAG:386  = 3（变量语义：CFLAG 族，386） // :4454
      era.set(`cflag:${target}:386`, 3); // :4454

    } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:386`) < 2 || era.get('flag:7') == 2)) { // :4456
      await era.printAndWait(`「嗯哈啊…哈啊…哈啊…哈啊…好难受来的啊…${heart(1)}」`); // :4457
      // CFLAG:386  = 2（变量语义：CFLAG 族，386） // :4458
      era.set(`cflag:${target}:386`, 2); // :4458

    } else if (era.get(`cflag:${target}:386`) < 1 || era.get('flag:7') == 2) { // :4460
  ...
  if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`)) { // :4472

    if (era.get(`cflag:${target}:347`) == 0) { // :4474

      if (era.get(`talent:${target}:76`) == 1) { // :4476
        await era.printAndWait(`「啊啊~…进来了呀~~~${heart(1)}…啊啊~${heart(1)}浣肠液${heart(1)}好热~~好舒服~~${heart(1)}」`); // :4477

      } else if (era.get(`talent:${target}:85`) == 1) { // :4479
      ...
      era.set(`cflag:${target}:347`, 1); // :4485
      return 0; // :4486

    } else { // :4488

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:347`) <= 6 || era.get('flag:7') == 2)) { // :4490
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:347`) <= 5 || era.get('flag:7') == 2)) { // :4496
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:347`) <= 4 || era.get('flag:7') == 2)) { // :4501
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:347`) <= 3 || era.get('flag:7') == 2)) { // :4507
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:347`) <= 2 || era.get('flag:7') == 2)) { // :4512
      ...
      } else if (era.get(`cflag:${target}:347`) <= 1 || era.get('flag:7') == 2) { // :4516
        if (era.get(`tequip:${target}:54`) == 1 && era_flag.prevcom == 46) { // :4517
          await era.printAndWait(`「真、真的不要了啊，赤裸着，在人前，排泄什呃，肚子，肚子好疼啊啊啊！」`); // :4518
        } else if (era_flag.prevcom == 46) { // :4519
  ...
  } else if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`) == 0) { // :4529

    if (era.get(`cflag:${target}:387`) == 0) { // :4531

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3) { // :4533

        if (era.get(`tequip:${target}:54`) == 1 && era.get(`tequip:${target}:53`) == 1) { // :4535
          if (era.get(`tequip:${target}:44`) == 0) { // :4537
        ...
        } else if (era.get(`tequip:${target}:54`) == 1) { // :4543
        ...
        } else if (era.get(`tequip:${target}:53`) == 1) { // :4548
      ...
      } else if (era.get(`talent:${target}:76`) == 1) { // :4559
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :4563
        await era.printAndWait(`「请、请不要看啊……唯独不想让主人大人看到的啊……嗯、嗯咕呜呜呜！　不要看啊啊啊啊！！」`); // :4564

      } else if (era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3) { // :4566
        if (era.get(`talent:${target}:成为勇者前的生活`) == 5 || era.get(`talent:${target}:成为勇者前的生活`) == 7 || era.get(`talent:${target}:成为勇者前的生活`) == 9 || era.get(`talent:${target}:成为勇者前的生活`) == 20) { // :4567
          if (era.get(`talent:${target}:成为勇者前的生活`) == 5) { // :4568
            await era.print(`「从娼妇`); // :4569
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 7) { // :4570
            await era.print(`「从乞丐`); // :4571
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 9) { // :4572
            await era.print(`「从贫民`); // :4573
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 20) { // :4574
            await era.print(`「从奴隶`); // :4575
          } // :4576
          await era.printAndWait(`成为了勇者，就能摆脱以前的生活…才对的啊…」`); // :4577
          await era.printAndWait(`「${scf()}、${sc()}，怎么就落到这个地步…呢…」`); // :4578
          if (era.get(`tequip:${target}:53`) == 1) { // :4580
        ...
        if (era.get(`talent:${target}:成为勇者前的生活`) == 5 || era.get(`talent:${target}:成为勇者前的生活`) == 7 || era.get(`talent:${target}:成为勇者前的生活`) == 9 || era.get(`talent:${target}:成为勇者前的生活`) == 20) { // :4588
          await era.print(`「不、不要啊！　这这这、这样子的、比`); // :4589
          if (era.get(`talent:${target}:成为勇者前的生活`) == 5) { // :4590
            await era.print(`娼妇`); // :4591
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 7) { // :4592
            await era.print(`乞丐`); // :4593
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 9) { // :4594
            await era.print(`贫民`); // :4595
          } else if (era.get(`talent:${target}:成为勇者前的生活`) == 20) { // :4596
            await era.print(`奴隶`); // :4597
          } // :4598
          await era.printAndWait(`还不如的待遇！！」`); // :4599
          await era.printAndWait(`「${scf()}、${sc()}っ，都成为勇者…成为勇者摆脱这些了啊…呀、呀啊啊啊！？」`); // :4600
          if (era.get(`tequip:${target}:53`) == 1) { // :4602
            await era.printAndWait(`「…啊、不要拍啊…唔、${sc()}的这幅模样…请不要记录下来啊啊…！」`); // :4602
          } // :4602
          await era.printAndWait(`「啊啊啊啊…！　停、停下啊…已经、出不来了、出、啊啊啊啊啊啊、啊嗷嗷嗷嗷…不要啊……」`); // :4603

        } else if (era.get(`tequip:${target}:54`) == 1 && era.get(`tequip:${target}:53`) == 1) { // :4605
      ...
      era.set(`cflag:${target}:387`, 1); // :4625
      return 0; // :4626

    } else { // :4628

      if (era.get(`talent:${target}:76`) == 1 && era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:387`) <= 6 || era.get('flag:7') == 2)) { // :4630

        if (era.get(`tequip:${target}:54`) == 1) { // :4632
          ...
          if (era.get(`cflag:${count}:1`) == 2 && era.get(`cflag:${count}:501`) == 9 && era.get(`abl:${target}:17`) >= 5) { // :4651
            if (rand_n(3) == 0) { // :4652
              await era.print(`「…哈、啊哈%UNICODE(0x2764) *1%　一想到${sc()}拉出来的东西、要是让探索中的勇者`); // :4653
              if (rand_n(3) == 0) { // :4654
                await era.print(`找到`); // :4655
              } else if (rand_n(2) == 0) { // :4656
          ...
          if (era.get(`tequip:${target}:53`) == 1) { // :4675
            if (rand_n(3) == 0) { // :4676
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:387`) <= 5 || era.get('flag:7') == 2)) { // :4703

        if (era.get(`tequip:${target}:54`) == 1) { // :4705
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:387`) <= 3 || era.get('flag:7') == 2)) { // :4737
      ...
      } else if (era.get(`abl:${target}:3`) >= 3 && era.get(`abl:${target}:21`) >= 3 && (era.get(`cflag:${target}:387`) <= 2 || era.get('flag:7') == 2)) { // :4741

        // RAW: REPEAT CHARANUM // :4743
        if (era.get(`tequip:${target}:54`) == 1 && era.get(`cflag:${count}:1`) == 2 && era.get(`cflag:${count}:501`) == 9 && era.get(`abl:${target}:17`) >= 5) { // :4744
          if (rand_n(3) == 0) { // :4745
            await era.printAndWait(`「啊啊啊啊啊啊啊…！　好舒服啊啊…！　怪物也好其他的勇者也行啊…！」`); // :4746
            await era.printAndWait(`「光着身子、在地下城、${sc()}排便的样子…好、好想被看到啊♪」`); // :4747
          } else if (rand_n(2) == 0) { // :4748
          ...
          return 0; // :4756
        } else if (era.get(`tequip:${target}:54`) == 1 && era.get(`cflag:${count}:1`) == 2 && era.get(`cflag:${count}:501`) == 9) { // :4757
        ...
        if (era.get(`tequip:${target}:54`) == 1) { // :4765
          if (rand_n(3) == 0) { // :4766
            await era.printAndWait(`「在外面…在地下城里…光着身子的这幅丑态、${scf()}、${sc()}……竟然」`); // :4767
          } else if (rand_n(2) == 0) { // :4768
      ...
      } else if (era.get(`cflag:${target}:387`) <= 1 || era.get('flag:7') == 2) { // :4786

        if (era.get(`mark:${target}:2`) == 3) { // :4788

          // RAW: REPEAT CHARANUM // :4790
          if (era.get(`tequip:${target}:54`) == 1 && era.get(`cflag:${count}:1`) == 2 && era.get(`cflag:${count}:501`) == 9) { // :4791
          ...
          if (era.get(`tequip:${target}:54`) == 1 && era.get(`cflag:${count}:1`) == 2 && era.get(`cflag:${count}:501`) == 9) { // :4823
          ...
          if (era.get(`tequip:${target}:54`) == 1 && era.get(`tequip:${target}:53`) == 1) { // :4831
            await era.printAndWait(`「快、快停下啊！　这…这样的姿态被拍下来什么的…啊啊啊啊！？」`); // :4832

          } else if (era.get(`tequip:${target}:54`) == 1) { // :4834
            await era.printAndWait(`「不、不要哇…在地下城里、连衣服都没穿、啊啊啊…停不下来、停下来……啊」`); // :4835

          } else if (era.get(`tequip:${target}:53`) == 1) { // :4837
  ...
  if (era_flag.selectcom == 55) { // :4852

    if (era.get(`cflag:${target}:356`) == 0) { // :4854

      if (era_flag.assi > 0 && era_flag.assiplay) { // :4856
        await era.printAndWait(`${target_name}一脸若无其事地看着这边………`); // :4857

      } else if (era.get(`talent:${target}:85`) == 1) { // :4859
        await era.printAndWait(`「哈啊哈啊…要…休息了吗...？」`); // :4860
        await era.printAndWait(`${target_name}不满地微眯着眼，看着${player_name}………`); // :4861

      } else if (era.get(`talent:${target}:76`) == 1) { // :4863
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && era.get(`palam:${target}:5`) >= era.get('palamlv:3') && (era.get(`cflag:${target}:356`) <= 5 || era.get('flag:7') == 2)) { // :4917
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:356`) <= 4 || era.get('flag:7') == 2)) { // :4922
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`palam:${target}:5`) >= era.get('palamlv:3') && (era.get(`cflag:${target}:356`) <= 3 || era.get('flag:7') == 2)) { // :4927
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:356`) <= 2 || era.get('flag:7') == 2)) { // :4932
      ...
      } else if (era.get(`cflag:${target}:356`) <= 1 || era.get('flag:7') == 2) { // :4937
  ...
  if (era_flag.selectcom == 56) { // :4988

    if (era.get(`cflag:${target}:357`) == 0) { // :4990

      if (era.get(`tequip:${target}:53`) == 1) { // :4992
        await era.print(`${master_name}催促着${target_name}开始自我介绍。`); // :4993
        if (rand_n(3) == 0 && (era.get(`talent:${target}:89`) || era.get(`abl:${target}:17`) >= 5)) { // :4994
          await era.print(`${target_name}将自己的本名、接下来要进行的性体验`); // :4995
          if (era.get(`abl:${target}:31`) >= 3) { // :4997
        ...
        } else if (era.get(`talent:${target}:76`) == 1) { // :5001
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :5008
        ...
        } else if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:76`) || era.get(`abl:${target}:11`) >= 5)) { // :5016
          await era.print(`${target_name}对着水晶球说起了淫猥的话语`); // :5017
          // TFLAG:32 | = 2（变量语义：TFLAG 族，32 |） // :5018
          era.set('tflag:32 |', 2); // :5018
        } else if (era.get(`abl:${target}:10`) >= 3 || era.get(`abl:${target}:11`) >= 4 || era.get(`abl:${target}:17`) >= 2) { // :5019
        ...
        if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:85`) || era.get(`abl:${target}:10`) >= 5) && era.get('tflag:60')) { // :5027
          await era.print(`向其搭话后，${target_name}摇晃着腰说起了恋慕的话语`); // :5028
        } else if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:76`) || era.get(`abl:${target}:11`) >= 5) && era.get('tflag:60')) { // :5029
          await era.print(`向其搭话后，${target_name}摇晃着腰说起了淫猥的话语`); // :5030
        } else if ((era.get(`palam:${target}:4`) >= era.get('palamlv:4') || era.get(`abl:${target}:10`) >= 5 || era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) && era.get(`palam:${target}:5`) >= era.get('palamlv:4')) { // :5031
          await era.print(`向其搭话后，${target_name}发出了`); // :5032
          if (era.get(`tequip:${target}:11`) || era.get(`tequip:${target}:13`) || era.get(`tequip:${target}:14`) || era.get(`tequip:${target}:15`) || era.get(`tequip:${target}:16`) || era.get(`tequip:${target}:17`)) { // :5033
            await era.print(`欢喜的`); // :5034
          } else if (era.get(`tequip:${target}:44`) || era.get(`tequip:${target}:49`)) { // :5035
            await era.print(`苦痛的`); // :5036
          } // :5037
          await era.print(`叫声，拼命地向你回话了。`); // :5038

        } else if (era.get(`talent:${target}:76`) == 1) { // :5040
          await era.print(`向其搭话后，${target_name}有点害羞地向你撒娇地一样靠近过来了。`); // :5041
          await era.printAndWait(`「主人…请随意地对${sc()}任何事情吧………${heart(1)}」`); // :5042
        } else if (era.get(`palam:${target}:4`) >= era.get('palamlv:4') || era.get(`talent:${target}:85`) || era.get(`abl:${target}:10`) >= 5) { // :5043
          await era.print(`向其搭话后，${target_name}融洽地向你回话了。`); // :5044
          await era.printAndWait(`「请对${sc()}下任何的命令吧~………${heart(1)}」`); // :5045
        } else if (era.get(`palam:${target}:4`) >= era.get('palamlv:2') ||  era.get(`abl:${target}:10`) >= 3) { // :5046
      ...
      if (era.get(`tequip:${target}:53`) == 1) { // :5058
        await era.print(`${master_name}催促着${target_name}快点开始介绍。`); // :5059
        if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:85`) || era.get(`abl:${target}:10`) >= 5) && era.get('tflag:60')) { // :5060
          await era.print(`${target_name}晃动着腰部开始说起了恋慕的话语。`); // :5061
          // TFLAG:32 | = 2（变量语义：TFLAG 族，32 |） // :5062
          era.set('tflag:32 |', 2); // :5062
        } else if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:76`) || era.get(`abl:${target}:11`) >= 5) && era.get('tflag:60')) { // :5063
          await era.print(`${target_name}晃动着腰部说起了淫猥的话语。`); // :5064
          // TFLAG:32 | = 2（变量语义：TFLAG 族，32 |） // :5065
          era.set('tflag:32 |', 2); // :5065
        } else if (rand_n(3) == 0 && (era.get(`talent:${target}:89`) || era.get(`abl:${target}:17`) >= 5)) { // :5066
          await era.print(`${target_name}将自己的本名、接下来要进行的性体验`); // :5067
          if (era.get(`abl:${target}:31`) >= 3) { // :5069
        ...
        } else if (era.get(`talent:${target}:76`) == 1) { // :5073
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :5080
        ...
        } else if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:76`) || era.get(`abl:${target}:11`) >= 5)) { // :5088
          await era.print(`${target_name}对着水晶球说起了淫猥的话语`); // :5089
          // TFLAG:32 | = 2（变量语义：TFLAG 族，32 |） // :5090
          era.set('tflag:32 |', 2); // :5090
        } else if (era.get(`abl:${target}:10`) >= 3 || era.get(`abl:${target}:11`) >= 4 || era.get(`abl:${target}:17`) >= 2) { // :5091
        ...
        if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:85`) || era.get(`abl:${target}:10`) >= 5) && era.get('tflag:60')) { // :5099
          await era.print(`向其搭话后，${target_name}摇晃着腰说起了恋慕的话语`); // :5100
        } else if (era.get(`palam:${target}:5`) >= era.get('palamlv:4') && (era.get(`talent:${target}:76`) || era.get(`abl:${target}:11`) >= 5) && era.get('tflag:60')) { // :5101
          await era.print(`向其搭话后，${target_name}摇晃着腰说起了淫猥的话语`); // :5102
        } else if ((era.get(`palam:${target}:4`) >= era.get('palamlv:4') || era.get(`abl:${target}:10`) >= 5 || era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) && era.get(`palam:${target}:5`) >= era.get('palamlv:4')) { // :5103
          await era.print(`向其搭话后，${target_name}发出了`); // :5104
          if (era.get(`tequip:${target}:11`) || era.get(`tequip:${target}:13`) || era.get(`tequip:${target}:14`) || era.get(`tequip:${target}:15`) || era.get(`tequip:${target}:16`) || era.get(`tequip:${target}:17`)) { // :5105
            await era.print(`欢喜的`); // :5106
          } else if (era.get(`tequip:${target}:44`) || era.get(`tequip:${target}:49`)) { // :5107
            await era.print(`苦痛的`); // :5108
          } // :5109
          await era.print(`叫声，拼命地向你回话了。`); // :5110

        } else if (era.get(`talent:${target}:76`) == 1) { // :5112
          await era.print(`向其搭话后，${target_name}有点害羞地向你撒娇地一样靠近过来了。`); // :5113
          await era.printAndWait(`「主人…请随意地对${sc()}任何事情吧………${heart(1)}」`); // :5114
        } else if (era.get(`palam:${target}:4`) >= era.get('palamlv:4') || era.get(`talent:${target}:85`) || era.get(`abl:${target}:10`) >= 5) { // :5115
          await era.print(`向其搭话后，${target_name}融洽地向你回话了。`); // :5116
          await era.printAndWait(`「请对${sc()}下任何的命令吧~………${heart(1)}」`); // :5117
        } else if (era.get(`palam:${target}:4`) >= era.get('palamlv:2') ||  era.get(`abl:${target}:10`) >= 3) { // :5118
  ...
  if (era_flag.selectcom == 123) { // :5132

    if (era.get(`cflag:${target}:360`) == 0) { // :5134

      if (era.get(`talent:${target}:76`) == 1) { // :5136
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5140
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5144
      ...
      era.set(`cflag:${target}:360`, 1); // :5152
      return 0; // :5153

    } else { // :5155

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:360`) <= 4 || era.get('flag:7') == 2)) { // :5157
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:360`) <= 3 || era.get('flag:7') == 2)) { // :5162
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:360`) <= 2 || era.get('flag:7') == 2)) { // :5167
        if (rand_n(2) == 0) { // :5168
      ...
      } else if (era.get(`cflag:${target}:360`) <= 1 || era.get('flag:7') == 2) { // :5180
  ...
  if (era_flag.selectcom == 125) { // :5191

    if (era.get(`cflag:${target}:361`) == 0) { // :5193

      if (era.get(`talent:${target}:76`) == 1) { // :5195
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5203
      ...
      era.set(`cflag:${target}:361`, 1); // :5211
      return 0; // :5212

    } else { // :5214

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:361`) <= 4 || era.get('flag:7') == 2)) { // :5216
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:361`) <= 3 || era.get('flag:7') == 2)) { // :5222
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:361`) <= 2 || era.get('flag:7') == 2)) { // :5228
      ...
      } else if (era.get(`cflag:${target}:361`) <= 1 || era.get('flag:7') == 2) { // :5233
  ...
  if (era_flag.selectcom == 126) { // :5245

    if (era.get(`cflag:${target}:362`) == 0) { // :5247

      if (era.get(`talent:${target}:76`) == 1) { // :5249
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5253
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5257
      ...
      era.set(`cflag:${target}:362`, 1); // :5264
      return 0; // :5265

    } else { // :5267

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:362`) <= 4 || era.get('flag:7') == 2)) { // :5269
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:362`) <= 3 || era.get('flag:7') == 2)) { // :5275
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:362`) <= 2 || era.get('flag:7') == 2)) { // :5281
      ...
      } else if (era.get(`cflag:${target}:362`) <= 1 || era.get('flag:7') == 2) { // :5286
  ...
  if (era_flag.selectcom == 127) { // :5299

    if (era.get(`cflag:${target}:363`) == 0) { // :5301

      if (era.get(`talent:${target}:76`) == 1) { // :5303
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5307
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5311
      ...
      era.set(`cflag:${target}:363`, 1); // :5319
      return 0; // :5320

    } else { // :5322

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:363`) <= 4 || era.get('flag:7') == 2)) { // :5324
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:363`) <= 3 || era.get('flag:7') == 2)) { // :5330
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:363`) <= 2 || era.get('flag:7') == 2)) { // :5336
      ...
      } else if (era.get(`cflag:${target}:363`) <= 1 || era.get('flag:7') == 2) { // :5342
  ...
  if (era_flag.selectcom == 69) { // :5354

    if (era.get(`cflag:${target}:364`) == 0) { // :5356

      if (era.get(`talent:${target}:76`) == 1) { // :5358
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5362
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5366
      ...
      era.set(`cflag:${target}:364`, 1); // :5374
      return 0; // :5375

    } else { // :5377

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:364`) <= 4 || era.get('flag:7') == 2)) { // :5379
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:364`) <= 3 || era.get('flag:7') == 2)) { // :5385
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:364`) <= 2 || era.get('flag:7') == 2)) { // :5391
      ...
      } else if (era.get(`cflag:${target}:364`) <= 1 || era.get('flag:7') == 2) { // :5396
  ...
  if (era_flag.selectcom == 124) { // :5408

    if (era.get(`cflag:${target}:365`) == 0) { // :5410

      if (era.get(`talent:${target}:76`) == 1) { // :5412
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5416
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5420
      ...
      era.set(`cflag:${target}:365`, 1); // :5428
      return 0; // :5429

    } else { // :5431

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:363`) <= 4 || era.get('flag:7') == 2)) { // :5433
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:363`) <= 3 || era.get('flag:7') == 2)) { // :5439
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:363`) <= 2 || era.get('flag:7') == 2)) { // :5445
      ...
      } else if (era.get(`cflag:${target}:363`) <= 1 || era.get('flag:7') == 2) { // :5451
  ...
  if (era_flag.selectcom == 80) { // :5464

    if (era.get(`cflag:${target}:381`) == 0) { // :5466

      if (era.get(`talent:${target}:76`) == 1) { // :5468
      ...
      } else if (era.get(`abl:${target}:16`) >= 3) { // :5472
      ...
      era.set(`cflag:${target}:381`, 1); // :5480
      return 0; // :5481

    } else { // :5483

      if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:381`) <= 4 || era.get('flag:7') == 2)) { // :5485
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:381`) <= 3 || era.get('flag:7') == 2)) { // :5491
      ...
      } else if (era.get(`abl:${target}:16`) >= 3 && (era.get(`cflag:${target}:381`) <= 2 || era.get('flag:7') == 2)) { // :5497
      ...
      } else if (era.get(`cflag:${target}:381`) <= 1 || era.get('flag:7') == 2) { // :5503
  ...
  if (era_flag.selectcom == 87) { // :5517


    if (era.get(`cflag:${target}:348`) == 0) { // :5520

      if (era_flag.assi > 0 && era_flag.assiplay) { // :5522
        await era.print(''); // :5523

      } else if (era.get(`talent:${target}:76`) == 1) { // :5525

        if (era.get(`cflag:${target}:7`) & P) { // :5527
          ...
          if (P == 1) { // :5530
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5543
      ...
      } else if (era.get(`talent:${target}:85`) == 1) { // :5568

        if (era.get(`cflag:${target}:7`) & P) { // :5570
          ...
          if (P == 1) { // :5573
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5586
        ...
        if (era.get(`cflag:${target}:7`) & P) { // :5613
          ...
          if (P == 1) { // :5616
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5629
      ...
      era.set(`cflag:${target}:348`, 1); // :5654
      return 0; // :5655

    } else { // :5657

      if (era_flag.assi > 0 && era_flag.assiplay) { // :5659
        await era.print(''); // :5660

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:348`) <= 3 || era.get('flag:7') == 2)) { // :5662

        if (era.get(`cflag:${target}:7`) & P) { // :5664
          ...
          if (P == 1) { // :5666
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5679
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:348`) <= 2 || era.get('flag:7') == 2)) { // :5705

        if (era.get(`cflag:${target}:7`) & P) { // :5707
          ...
          if (P == 1) { // :5709
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5722
      ...
      } else if (era.get(`cflag:${target}:348`) <= 1 || era.get('flag:7') == 2) { // :5748

        if (era.get(`cflag:${target}:7`) & P) { // :5750
          ...
          if (P == 1) { // :5752
            ...
            if (era.get(`talent:${target}:121`) || era.get(`talent:${target}:122`)) { // :5765
...
// @DOG_KOJO_3 // :5800
async function DOG_KOJO_3() {




  if (era_flag.selectcom == 0) { // :5805

    if (era.get(`cflag:${target}:301`) == 0) { // :5807

      if (era.get(`talent:${target}:136`) == 1) { // :5809
        await era.printAndWait(`「欢迎~~……嗯~、没、没错……嗯嗯~……！」`); // :5810

      } else if (era.get(`talent:${target}:76`) == 1) { // :5812
        await era.printAndWait(`「啊啊…魔王大人想要试试，${sc()}能被野狗弄成怎样淫乱下流的样子对吧、……啊嗯！」`); // :5813

      } else if (era.get(`mark:${target}:2`) == 3) { // :5815
        await era.printAndWait(`「这，这样的……被狗什么的…再怎么说也……呜啊啊啊~……！」`); // :5816

      } else if (era.get(`mark:${target}:2`) >= 2) { // :5818
      ...
      if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900 && (era.get(`cflag:${target}:301`) <= 7 || era.get('flag:7') == 2)) { // :5829
        await era.printAndWait(`「啊哈啊…${heart(1)} 来吧、老公大人啊…啊、啊啊啊~…」`); // :5830
        // CFLAG:301  = 8（变量语义：CFLAG 族，301） // :5831
        era.set(`cflag:${target}:301`, 8); // :5831

      } else if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:301`) <= 6 || era.get('flag:7') == 2)) { // :5833
  ...
  if (era_flag.selectcom == 1) { // :5864

    if (era.get(`cflag:${target}:302`) == 0) { // :5866

      if (era.get(`talent:${target}:136`) == 1) { // :5868
        await era.printAndWait(`「是这里哦、明白了吧？…啊嗯~、没、没错……嗯哈嗯~……！」`); // :5869

      } else if (era.get(`talent:${target}:76`) == 1) { // :5871
        await era.printAndWait(`「啊哈…这么地闻着那儿的味道……呜嗯~♪嗯~、没、没错……就是，这样舔……」`); // :5872

      } else if (era.get(`talent:${target}:0`) == 1) { // :5874
      ...
      if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900 && (era.get(`cflag:${target}:302`) <= 6 || era.get('flag:7') == 2)) { // :5885
      ...
      } else if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:302`) <= 5 || era.get('flag:7') == 2)) { // :5889
        await era.printAndWait(`「有着母狗的味道对吧~？　哼哼~…没错、那里……啊呜嗯~！啊、啊啊~♪」`); // :5890
        // CFLAG:302  = 6（变量语义：CFLAG 族，302） // :5891
        era.set(`cflag:${target}:302`, 6); // :5891

      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:302`) <= 4 || era.get('flag:7') == 2)) { // :5893
        await era.printAndWait(`「哼啊~……不只是小豆豆而已、整个小穴都……啊哈嗯~……♪」`); // :5894
        // CFLAG:302  = 5（变量语义：CFLAG 族，302） // :5895
        era.set(`cflag:${target}:302`, 5); // :5895

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:302`) <= 3 || era.get('flag:7') == 2)) { // :5897
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:302`) <= 2 || era.get('flag:7') == 2)) { // :5901
        await era.printAndWait(`「哈呜！呜…呜…！」`); // :5902
        // CFLAG:302  = 3（变量语义：CFLAG 族，302） // :5903
        era.set(`cflag:${target}:302`, 3); // :5903

      } else if (era.get(`cflag:${target}:302`) <= 1 || era.get('flag:7') == 2) { // :5905
  ...
  if (era_flag.selectcom == 5) { // :5917

    if (era.get(`cflag:${target}:306`) == 0) { // :5919

      if (era.get(`talent:${target}:130`) == 1) { // :5921

        if (era.get(`talent:${target}:136`) == 1) { // :5923
          await era.printAndWait(`「啊啊~…对狗狗的味道、对狗狗的舌头有反应了……${sc()}的乳房…母狗的奶要渗出来了啊${heart(1)}」`); // :5924

        } else if (era.get(`talent:${target}:76`) == 1) { // :5926
      ...
      } else if (era.get(`talent:${target}:136`) == 1) { // :5933
        await era.printAndWait(`「同样都是狗狗来的嘛…哼哼哼~${heart(1)} 可以的哦、请舔吧~……」`); // :5934

      } else if (era.get(`talent:${target}:76`) == 1) { // :5936
      ...
      era.set(`cflag:${target}:306`, 1); // :5942
      return 0; // :5943

    } else { // :5945

      if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900 && era.get(`talent:${target}:130`) == 1 && (era.get(`cflag:${target}:306`) <= 7 || era.get('flag:7') == 2)) { // :5947
      ...
      } else if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900 && (era.get(`cflag:${target}:306`) <= 6 || era.get('flag:7') == 2)) { // :5951
      ...
      } else if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:306`) <= 5 || era.get('flag:7') == 2)) { // :5955
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:306`) <= 4 || era.get('flag:7') == 2)) { // :5959
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:306`) <= 3 || era.get('flag:7') == 2)) { // :5963
        await era.printAndWait(`「嗯~、总觉得……有点舒服、又有点难受的…嗯~！」`); // :5964
        // CFLAG:306  = 4（变量语义：CFLAG 族，306） // :5965
        era.set(`cflag:${target}:306`, 4); // :5965

      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:306`) <= 2 || era.get('flag:7') == 2)) { // :5967
        await era.printAndWait(`「呜~！嗯…嗯呜~…！」`); // :5968
        // CFLAG:306  = 3（变量语义：CFLAG 族，306） // :5969
        era.set(`cflag:${target}:306`, 3); // :5969

      } else if (era.get(`cflag:${target}:306`) <= 1 || era.get('flag:7') == 2) { // :5971
  ...
  if (era_flag.selectcom == 6) { // :5983

    if (era.get(`cflag:${target}:307`) == 0 && era.get('tflag:13')) { // :5985

      if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900) { // :5987
      ...
      } else if (era.get(`talent:${target}:136`) == 1) { // :5992
        await era.printAndWait(`「第一次的kiss、对象居然是野狗…啊啊~、不管是身体还是心理都完全是母狗来的了…♪${heart(1)}」`); // :5993

      } else if (era.get(`talent:${target}:76`) == 1) { // :5995
    ...
    } else if (era.get(`cflag:${target}:307`) == 0) { // :6004

      if (era.get(`talent:${target}:136`) == 1) { // :6006

        await era.printAndWait(`「和野狗亲吻什么的、心脏还会小鹿乱撞什么的……唔哼哼~、${target_name}身心都变成雌犬了呢~${heart(1)}」`); // :6008

      } else if (era.get(`talent:${target}:76`) == 1) { // :6010
      ...
      if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:307`) <= 5 || era.get('flag:7') == 2)) { // :6023
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:307`) <= 4 || era.get('flag:7') == 2)) { // :6040

        await era.printAndWait(`「是魔王大人的命令的话…会欢喜地顺从的~」`); // :6042
        // CFLAG:307  = 5（变量语义：CFLAG 族，307） // :6043
        era.set(`cflag:${target}:307`, 5); // :6043

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:307`) <= 3 || era.get('flag:7') == 2)) { // :6045
      ...
      } else if (era.get(`abl:${target}:10`) >=2 && (era.get(`cflag:${target}:307`) <= 2 || era.get('flag:7') == 2)) { // :6054
      ...
      } else if (era.get(`cflag:${target}:307`) <= 1 || era.get('flag:7') == 2) { // :6063
  ...
  if (era_flag.selectcom == 9) { // :6076

    if (era.get(`cflag:${target}:310`) == 0) { // :6078

      if (era.get(`talent:${target}:136`) == 1) { // :6080

        await era.printAndWait(`「啊啊…屁股、更多更加尽情地、呸咯呸咯地舔吧~${heart(1)}」`); // :6082

      } else if (era.get(`talent:${target}:76`) == 1) { // :6084

        await era.printAndWait(`「哈呜~…那、那里是~啊嗯~${heart(1)}」`); // :6086

      } else if (era.get(`talent:${target}:85`) == 1) { // :6088
      ...
      era.set(`cflag:${target}:310`, 1); // :6096
      return 0; // :6097

    } else { // :6099

      if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:310`) <= 5 || era.get('flag:7') == 2)) { // :6101
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:310`) <= 4 || era.get('flag:7') == 2)) { // :6108

        await era.printAndWait(`「真是奇怪的感觉呢~……」`); // :6110
        // CFLAG:310  = 5（变量语义：CFLAG 族，310） // :6111
        era.set(`cflag:${target}:310`, 5); // :6111

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:310`) <= 3 || era.get('flag:7') == 2)) { // :6113
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:310`) <= 2 || era.get('flag:7') == 2)) { // :6118

        await era.printAndWait(`「如果是魔王大人的命令来的话……那就没有办法了呢……」`); // :6120
        // CFLAG:310  = 3（变量语义：CFLAG 族，310） // :6121
        era.set(`cflag:${target}:310`, 3); // :6121

      } else if (era.get(`cflag:${target}:310`) <= 1 || era.get('flag:7') == 2) { // :6123
  ...
  if (era_flag.selectcom == 21) { // :6135

    if (era.get(`cflag:${target}:322`) == 0) { // :6137

      if (era.get(`talent:${target}:0`) == 1) { // :6139

        if (era.get(`talent:${target}:136`) == 1) { // :6141
        ...
        if (era.get(`talent:${target}:136`) == 1) { // :6163



          await era.print(`「是的…${sc()}的小穴是狗大人专用的 以后每天都会交尾的${heart(1)}」`); // :6167

        } else if (era.get(`talent:${target}:76`) == 1) { // :6169

          await era.printAndWait(`「和狗做吗？ 呵呵…很期待呢${heart(1)}」`); // :6171

        } else if (era.get(`talent:${target}:85`) == 1) { // :6173
      ...
      if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:322`) <= 6 || era.get('flag:7') == 2)) { // :6187
        if (era.get(`tequip:${target}:53`)) { // :6188
      ...
      } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:322`) <= 5 || era.get('flag:7') == 2)) { // :6207

        await era.printAndWait(`「相比魔王大人派过来的魔物们来说…狗什么的真的不算什么呢」`); // :6209
        // CFLAG:322  = 6（变量语义：CFLAG 族，322） // :6210
        era.set(`cflag:${target}:322`, 6); // :6210

      } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:322`) <= 4 || era.get('flag:7') == 2)) { // :6212
      ...
      } else if (era.get(`mark:${target}:2`) == 3 && era.get(`abl:${target}:2`) >= 3 && (era.get(`cflag:${target}:322`) <= 3 || era.get('flag:7') == 2)) { // :6221

        await era.printAndWait(`「哈啊~…~……才，才没有对狗的鸡巴有感觉了呢……」`); // :6223
        // CFLAG:322  = 4（变量语义：CFLAG 族，322） // :6224
        era.set(`cflag:${target}:322`, 4); // :6224

      } else if (era.get(`mark:${target}:2`) == 3 && (era.get(`cflag:${target}:322`) <= 2 || era.get('flag:7') == 2)) { // :6226

        await era.printAndWait(`「这不是开玩笑来的对吧……」`); // :6228
        // CFLAG:322  = 3（变量语义：CFLAG 族，322） // :6229
        era.set(`cflag:${target}:322`, 3); // :6229

      } else if (era.get(`cflag:${target}:322`) <= 1 || era.get('flag:7') == 2) { // :6231
  ...
  if (era_flag.selectcom == 27) { // :6243

    if (era.get(`cflag:${target}:328`) == 0) { // :6245

      if (era.get(`talent:${target}:136`) == 1) { // :6247
        await era.print(`${target_name}晃动着屁股引诱着野狗`); // :6248

        await era.printAndWait(`「${sc()}的不净之穴在这边${heart(1)}」`); // :6250

      } else if (era.get(`talent:${target}:76`) == 1) { // :6252
      ...
      era.set(`cflag:${target}:328`, 1); // :6264
      return 0; // :6265

    } else { // :6267

      if (era.get(`talent:${target}:136`) == 1 && era.get(`abl:${target}:3`) >= 3 && (era.get(`cflag:${target}:328`) <= 6 || era.get('flag:7') == 2)) { // :6269
        if (era.get(`tequip:${target}:53`)) { // :6270
  ...
  if (era_flag.selectcom == 56) { // :6666

    if (era.get(`cflag:${target}:357`) == 0) { // :6668
      if (era.get(`tequip:${target}:53`)) { // :6669
        ...
        if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900) { // :6696
          ...
          if (local_9 > 0) { // :6716
            ...
            if (local_5 && local_6 && local_7 && local_8) { // :6718
              await era.print(`姐姐，哥哥，弟弟，妹妹`); // :6719
            } else if (local_5 && local_6 && local_7) { // :6720
              await era.print(`姐姐，哥哥，妹妹`); // :6721
            } else if (local_5 && local_6 && local_8) { // :6722
              await era.print(`姐姐，哥哥，弟弟`); // :6723
            } else if (local_5 && local_7 && local_8) { // :6724
              await era.print(`姐姐，弟弟，妹妹`); // :6725
            } else if (local_6 && local_7 && local_8) { // :6726
              await era.print(`哥哥，弟弟，妹妹`); // :6727
            } else if (local_5 && local_6) { // :6728
              await era.print(`姐姐和哥哥`); // :6729
            } else if (local_5 && local_8) { // :6730
              await era.print(`姐姐和弟弟`); // :6731
            } else if (local_5 && local_7) { // :6732
              await era.print(`姐姐和妹妹`); // :6733
            } else if (local_6 && local_8) { // :6734
              await era.print(`哥哥和弟弟`); // :6735
            } else if (local_6 && local_7) { // :6736
              await era.print(`哥哥和妹妹`); // :6737
            } else if (local_7 && local_8) { // :6738
              await era.print(`弟弟和妹妹`); // :6739
            } else if (local_5) { // :6740
              await era.print(`姐姐`); // :6741
            } else if (local_6) { // :6742
              await era.print(`哥哥`); // :6743
            } else if (local_7) { // :6744
              await era.print(`妹妹`); // :6745
            } else if (local_8) { // :6746
        ...
        } else if (era.get(`talent:${target}:136`) == 1) { // :6777
          ...
          if (local_9 > 0) { // :6795
            ...
            if (local_5 && local_6 && local_7 && local_8) { // :6797
              await era.print(`姐姐，哥哥，弟弟，妹妹`); // :6798
            } else if (local_5 && local_6 && local_7) { // :6799
              await era.print(`姐姐，哥哥，妹妹`); // :6800
            } else if (local_5 && local_6 && local_8) { // :6801
              await era.print(`姐姐，哥哥，弟弟`); // :6802
            } else if (local_5 && local_7 && local_8) { // :6803
              await era.print(`姐姐，弟弟，妹妹`); // :6804
            } else if (local_6 && local_7 && local_8) { // :6805
              await era.print(`哥哥，弟弟，妹妹`); // :6806
            } else if (local_5 && local_6) { // :6807
              await era.print(`姐姐和哥哥`); // :6808
            } else if (local_5 && local_8) { // :6809
              await era.print(`姐姐和弟弟`); // :6810
            } else if (local_5 && local_7) { // :6811
              await era.print(`姐姐和妹妹`); // :6812
            } else if (local_6 && local_8) { // :6813
              await era.print(`哥哥和弟弟`); // :6814
            } else if (local_6 && local_7) { // :6815
              await era.print(`哥哥和妹妹`); // :6816
            } else if (local_7 && local_8) { // :6817
              await era.print(`弟弟和妹妹`); // :6818
            } else if (local_5) { // :6819
              await era.print(`姐姐`); // :6820
            } else if (local_6) { // :6821
              await era.print(`哥哥`); // :6822
            } else if (local_7) { // :6823
              await era.print(`妹妹`); // :6824
            } else if (local_8) { // :6825
        ...
        } else if (era.get(`talent:${target}:76`) == 1) { // :6856
        ...
        } else if (era.get(`talent:${target}:85`) == 1) { // :6861
      ...
      if (era.get(`tequip:${target}:53`)) { // :6876


        if (era.get(`talent:${target}:136`) == 1 && era.get(`cflag:${target}:601`) == 900 && (era.get(`cflag:${target}:306`) <= 5 || era.get('flag:7') == 2)) { // :6879
          await era.printAndWait(`「观赏这个的大家、初次见面。${sc()}是${target_name}」`); // :6880
          await era.printAndWait(`「今天${sc()}和丈夫大人的……关系和睦的、交尾，请您欣赏」`); // :6881
          if (era.get(`talent:${target}:人妻`)) { // :6883
          ...
          if (local_9 > 0) { // :6899
            ...
            if (local_5 && local_6 && local_7 && local_8) { // :6901
              await era.print(`姐姐，哥哥，弟弟，妹妹`); // :6902
            } else if (local_5 && local_6 && local_7) { // :6903
              await era.print(`姐姐，哥哥，妹妹`); // :6904
            } else if (local_5 && local_6 && local_8) { // :6905
              await era.print(`姐姐，哥哥，弟弟`); // :6906
            } else if (local_5 && local_7 && local_8) { // :6907
              await era.print(`姐姐，弟弟，妹妹`); // :6908
            } else if (local_6 && local_7 && local_8) { // :6909
              await era.print(`哥哥，弟弟，妹妹`); // :6910
            } else if (local_5 && local_6) { // :6911
              await era.print(`姐姐和哥哥`); // :6912
            } else if (local_5 && local_8) { // :6913
              await era.print(`姐姐和弟弟`); // :6914
            } else if (local_5 && local_7) { // :6915
              await era.print(`姐姐和妹妹`); // :6916
            } else if (local_6 && local_8) { // :6917
              await era.print(`哥哥和弟弟`); // :6918
            } else if (local_6 && local_7) { // :6919
              await era.print(`哥哥和妹妹`); // :6920
            } else if (local_7 && local_8) { // :6921
              await era.print(`弟弟和妹妹`); // :6922
            } else if (local_5) { // :6923
              await era.print(`姐姐`); // :6924
            } else if (local_6) { // :6925
              await era.print(`哥哥`); // :6926
            } else if (local_7) { // :6927
              await era.print(`妹妹`); // :6928
            } else if (local_8) { // :6929
        ...
        } else if (era.get(`talent:${target}:136`) == 1 && (era.get(`cflag:${target}:357`) <= 4 || era.get('flag:7') == 2)) { // :6962
          ...
          if (local_9 > 0) { // :6981
            ...
            if (local_5 && local_6 && local_7 && local_8) { // :6983
              await era.print(`姐姐，哥哥，弟弟，妹妹`); // :6984
            } else if (local_5 && local_6 && local_7) { // :6985
              await era.print(`姐姐，哥哥，妹妹`); // :6986
            } else if (local_5 && local_6 && local_8) { // :6987
              await era.print(`姐姐，哥哥，弟弟`); // :6988
            } else if (local_5 && local_7 && local_8) { // :6989
              await era.print(`姐姐，弟弟，妹妹`); // :6990
            } else if (local_6 && local_7 && local_8) { // :6991
              await era.print(`哥哥，弟弟，妹妹`); // :6992
            } else if (local_5 && local_6) { // :6993
              await era.print(`姐姐和哥哥`); // :6994
            } else if (local_5 && local_8) { // :6995
              await era.print(`姐姐和弟弟`); // :6996
            } else if (local_5 && local_7) { // :6997
              await era.print(`姐姐和妹妹`); // :6998
            } else if (local_6 && local_8) { // :6999
              await era.print(`哥哥和弟弟`); // :7000
            } else if (local_6 && local_7) { // :7001
              await era.print(`哥哥和妹妹`); // :7002
            } else if (local_7 && local_8) { // :7003
              await era.print(`弟弟和妹妹`); // :7004
            } else if (local_5) { // :7005
              await era.print(`姐姐`); // :7006
            } else if (local_6) { // :7007
              await era.print(`哥哥`); // :7008
            } else if (local_7) { // :7009
              await era.print(`妹妹`); // :7010
            } else if (local_8) { // :7011
        ...
        } else if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:357`) <= 3 || era.get('flag:7') == 2)) { // :7044
        ...
        } else if (era.get(`talent:${target}:85`) == 1 && (era.get(`cflag:${target}:357`) <= 2 || era.get('flag:7') == 2)) { // :7050
        ...
        } else if (era.get(`cflag:${target}:357`) <= 1 || era.get('flag:7') == 2) { // :7056
...
async function KOJO_MESSAGE_PALAMCNG_3() {

  if (era_flag.assi > 0 && era_flag.assiplay) { // :7078
    return 0; // :7078
  } // :7078

  if (era.get(`tequip:${target}:45`)) { // :7081
    return 0; // :7081
  } // :7081

  if (era.get('tflag:899')) { // :7084
    return 0; // :7084
  } // :7084

  if (era.get(`talent:${target}:9`) == 1) { // :7087
    return 0; // :7087
  } // :7087

  if (era.get(`tequip:${target}:89`)) { // :7090
    return 0; // :7090
  } // :7090

  if (era.get(`tequip:${target}:90`)) { // :7093
    return 0; // :7093
  } // :7093

  if (era.get(`tequip:${target}:55`)) { // :7096
    return 0; // :7096
  } // :7096
  ...
  if (P > era.get('palamlv:2') && era.get(`cflag:${target}:221`) == 0) { // :7105

    if (era.get(`talent:${target}:85`) == 1) { // :7107

      if (era_flag.selectcom == 50) { // :7109
    ...
    era.set(`cflag:${target}:221`, 1); // :7129
  } // :7130
  ...
  if (P > era.get('palamlv:2') && era.get(`cflag:${target}:222`) == 0) { // :7136

    if (era.get(`talent:${target}:85`) == 1) { // :7138

      if (era_flag.selectcom == 51) { // :7140
  ...
  if (P > era.get('palamlv:2') && era.get(`cflag:${target}:223`) == 0) { // :7167

    if (era.get(`talent:${target}:85`) == 1) { // :7169
  ...
  if (P > era.get('palamlv:2') && era.get(`cflag:${target}:224`) == 0) { // :7184

    if (era.get(`talent:${target}:85`) == 1) { // :7186
  ...
  if (era.get('nowex:0') > 0 && era.get(`cflag:${target}:225`) == 0) { // :7200

    if (era.get(`talent:${target}:85`) == 1) { // :7202
  ...
  if (era.get('nowex:1') > 0 && era.get(`cflag:${target}:226`) == 0) { // :7216

    if (era.get(`talent:${target}:76`) == 1) { // :7218
    ...
    } else if (era.get(`talent:${target}:85`) == 1) { // :7224
    ...
    era.set(`cflag:${target}:226`, 1); // :7235
  } // :7236




  if (era.get('nowex:2') > 0 && era.get(`cflag:${target}:227`) == 0) { // :7241

    if (era.get(`talent:${target}:76`) == 1) { // :7243

      if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`) == 0 && era.get(`abl:${target}:3`) == 0) { // :7245
    ...
    } else if (era.get(`talent:${target}:85`) == 1) { // :7258
      ...
      if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`) && era.get(`abl:${target}:3`) == 0) { // :7266
      ...
      } else if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`) == 0 && era.get(`abl:${target}:3`) == 0) { // :7286
      ...
      } else if (era_flag.selectcom == 46 && era.get(`tequip:${target}:46`) == 0) { // :7293
  ...
  if (era.get('nowex:3') > 0 && era.get(`cflag:${target}:228`) == 0) { // :7309

    if (era.get(`talent:${target}:85`) == 1) { // :7311
    ...
    era.set(`cflag:${target}:228`, 1); // :7319
  } // :7320
  ...
  if (era.get('tflag:3') == 1 && era.get(`cflag:${target}:229`) == 0) { // :7327

    if (era.get('tflag:20') == 1) { // :7329

      if (era.get(`talent:${target}:76`) == 1 && (A < 500 || era.get('tflag:150') == 1)) { // :7331
      ...
      } else if (era.get(`talent:${target}:85`) == 1 && (A < 500 || era.get('tflag:150') == 1)) { // :7336
    ...
    era.set(`cflag:${target}:229`, 1); // :7361
  } // :7362




  if (((era.get('nowex:0') && era.get(`cflag:${target}:225`) == 1) || (era.get('nowex:1') && era.get(`cflag:${target}:226`) == 1) || (era.get('nowex:2') && era.get(`cflag:${target}:227`) == 1) || (era.get('nowex:3') && era.get(`cflag:${target}:228`) == 1)) && (era.get(`talent:${target}:190`) == 1 || era.get(`talent:${target}:191`) == 1)) { // :7367
    if (era.get(`cflag:${target}:230`) >= 100) { // :7368
      if (rand_n(3) == 0) { // :7369
        await era.print(`「啊啊~${heart(1)} 要、要生出来了呀~${heart(3)}」`); // :7370
        await era.printAndWait(`「……请不要、看着……${target_name}的这种样子~……」`); // :7371
      } else if (rand_n(2) == 0) { // :7372
        await era.print(`「不、不行……要生出来了啊啊啊~${heart(1)}」`); // :7373
      } else { // :7374
        await era.printAndWait(`「……撒、现在就将${target_name}可爱的孩子们生出来了~${heart(3)}」`); // :7375
      } // :7376
    } else if (era.get(`cflag:${target}:230`) == 75) { // :7377
      await era.print(`「……我的身体、总觉得有点奇怪啊……」`); // :7378
      await era.printAndWait(`「不管怎样生…怎样生都好、都满足不了啊~……想要生更多…更多的蛋出来了啊~……」`); // :7379
    } else { // :7380

      if (era.get(`talent:${target}:190`) == 1 && era.get(`talent:${target}:191`) == 1) { // :7382
      ...
      } else if (era.get(`talent:${target}:190`) == 1) { // :7391
        if (rand_n(1) == 0) { // :7392
    ...
    era.set(`cflag:${target}:230 +`, 1); // :7406
  } // :7407
...
async function KOJO_MESSAGE_MARKCNG_3() {

  if (era_flag.assi > 0 && era_flag.assiplay) { // :7417
    return 0; // :7417
  } // :7417

  if (era.get(`tequip:${target}:45`)) { // :7420
    return 0; // :7420
  } // :7420

  if (era.get('tflag:899')) { // :7423
    return 0; // :7423
  } // :7423

  if (era.get(`tequip:${target}:89`)) { // :7426
    return 0; // :7426
  } // :7426

  if (era.get(`tequip:${target}:90`)) { // :7429
    return 0; // :7429
  } // :7429

  if (era.get(`talent:${target}:9`) == 1) { // :7432
    return 0; // :7432
  } // :7432

  if (era.get(`tequip:${target}:55`)) { // :7435
    return 0; // :7435
  } // :7435



  if (era.get('tflag:22') == 3 && era.get(`cflag:${target}:297`) == 0) { // :7439

    if (era.get(`talent:${target}:85`) == 1) { // :7441
  ...
  if (era.get('tflag:23') == 3 && era.get(`cflag:${target}:298`) == 0) { // :7452

    if (era.get(`talent:${target}:85`) == 1) { // :7454
  ...
  if (era.get('tflag:24') == 3 && era.get(`cflag:${target}:299`) == 0) { // :7465

    if (era.get(`talent:${target}:85`) == 1) { // :7467
  ...
  if (era.get('tflag:21') == 3 && era.get(`cflag:${target}:300`) == 0) { // :7478

    if (era.get(`talent:${target}:85`) == 1) { // :7480
...
// @SELF_KOJO_K3 // :7492
async function SELF_KOJO_K3() {



  if (era.get('tflag:13') == 1) { // :7496
    ...
    if (Q == 1) { // :7498
      ...
      if (era.get(`talent:${target}:76`) && (era.get(`cflag:${target}:261`) < 4 || era.get('flag:7') == 2)) { // :7508
      ...
      } else if (era.get(`talent:${target}:85`) && (era.get(`cflag:${target}:261`) < 3 || era.get('flag:7') == 2)) { // :7513
      ...
      } else if (era.get(`abl:${target}:31`) >= 3 && (era.get(`cflag:${target}:261`) < 2 || era.get('flag:7') == 2)) { // :7518
      ...
      } else if (era.get(`cflag:${target}:261`) < 1 || era.get('flag:7') == 2) { // :7522
  ...
  if (era.get('tflag:13') == 2) { // :7531

    if (era.get(`talent:${target}:76`) && (era.get(`cflag:${target}:262`) < 5 || era.get('flag:7') == 2)) { // :7533
    ...
    } else if (era.get(`talent:${target}:85`) && (era.get(`cflag:${target}:262`) < 4 || era.get('flag:7') == 2)) { // :7538
    ...
    } else if (era.get(`abl:${target}:33`) >= 3 && (era.get(`cflag:${target}:262`) < 3 || era.get('flag:7') == 2)) { // :7543
    ...
    } else if (era.get(`abl:${target}:22`) >= 3 && (era.get(`cflag:${target}:262`) < 2 || era.get('flag:7') == 2)) { // :7547
      await era.printAndWait(`「哼啊啊~…和女孩子做…居然会那么舒服什么的…${heart(1)}」`); // :7548
      // CFLAG:262  = 2（变量语义：CFLAG 族，262） // :7549
      era.set(`cflag:${target}:262`, 2); // :7549

    } else if (era.get(`cflag:${target}:262`) < 1 || era.get('flag:7') == 2) { // :7551
  ...
  if (era.get('tflag:13') == 3) { // :7560

    if (era.get(`talent:${target}:76`) == 1 && (era.get(`cflag:${target}:263`) < 4 || era.get('flag:7') == 2)) { // :7562
    ...
    } else if (era.get(`talent:${target}:85`) && (era.get(`cflag:${target}:263`) < 3 || era.get('flag:7') == 2)) { // :7569
    ...
    } else if (era.get(`abl:${target}:16`) >= 5 && (era.get(`cflag:${target}:263`) < 2 || era.get('flag:7') == 2)) { // :7576
    ...
    } else if (era.get(`cflag:${target}:263`) < 1 || era.get('flag:7') == 2) { // :7581
  ...
  if (era.get('tflag:13') == 4) { // :7590

    if (era.get(`abl:${target}:2`) >= 4 && (era.get(`cflag:${target}:264`) < 2 || era.get('flag:7') == 2)) { // :7592
    ...
    } else if (era.get(`cflag:${target}:264`) < 1 || era.get('flag:7') == 2) { // :7597
  ...
  if (era.get('tflag:13') == 5) { // :7607
    if (era.get(`cflag:${target}:265`) < 1 || era.get('flag:7') == 2) { // :7608
  ...
  if (era.get('tflag:13') == 6) { // :7619

    if (era.get(`talent:${target}:136`)) { // :7621
    ...
    } else if (era.get(`talent:${target}:85`) && era.get(`mark:${target}:3`) < 3) { // :7626

      if (era.get(`talent:${target}:314`) == 1) { // :7628
      ...
      } else if (era.get(`talent:${target}:210`) || era.get(`talent:${target}:211`)) { // :7637
    ...
    } else if (era.get(`mark:${target}:3`) == 3) { // :7650
      await era.printAndWait(`「给我记住…给我记住啊！…哪怕死了也…混蛋…！！」`); // :7651

    } else if (era.get(`talent:${target}:76`)) { // :7653

      if (era.get(`talent:${target}:314`) == 7) { // :7655
    ...
    if (era.get(`talent:${target}:122`) != 1) { // :7672
  ...
  if (era.get('tflag:13') == 11) { // :7679
    if (era.get(`cflag:${target}:271`) == 0) { // :7680
      ...
      } else if (era.get(`cflag:${target}:102`) == 3) { // :7695
      ...
      } else if (era.get(`cflag:${target}:102`) == 5) { // :7700
        if (era.get(`talent:${target}:136`) == 1) { // :7701
          await era.printAndWait(`「居然怀上了可爱的狗宝宝种子真是幸福呢~♪」`); // :7702
        } else { // :7703
          await era.printAndWait(`「怎么会…${sc()}居然怀上了那个野狗的孩子…骗、骗人的………」`); // :7704
        } // :7705

      } else if (era.get(`cflag:${target}:102`) == 7) { // :7707
      ...
      } else if (era.get(`cflag:${target}:102`) == 3) { // :7731
      ...
      } else if (era.get(`cflag:${target}:102`) == 5) { // :7736
        if (era.get(`talent:${target}:136`) == 1) { // :7737
          await era.printAndWait(`「居然怀上了可爱的狗宝宝种子真是幸福呢~♪」`); // :7738
        } else { // :7739
          await era.printAndWait(`「怎么会…${sc()}居然怀上了那个野狗的孩子…骗、骗人的………」`); // :7740
        } // :7741

      } else if (era.get(`cflag:${target}:102`) == 7) { // :7743
  ...
  if (era.get('tflag:13') == 12) { // :7759
    if (era.get(`cflag:${target}:272`) == 0) { // :7760

      if (era.get(`talent:${target}:9`) == 1) { // :7762
        await era.printAndWait(`「嗯哈啊啊嗯…有什么要出来了…要出来了…啊哈~啊哈~啊哈哈哈哈哈哈哈！」`); // :7763

      } else if (era.get(`talent:${target}:85`) && era.get(`cflag:${target}:102`) == 1) { // :7765
        await era.printAndWait(`「哈啊…哈啊…啊啊…果然…跟${sc()}想象一样的小宝宝…跟大人你一摸一样呢${heart(1)}」`); // :7766

      } else if (era.get(`cflag:${target}:102`) == 2) { // :7768
        await era.printAndWait(`「呜…呜呜~…${sc()}的小宝宝要………」`); // :7769

      } else if (era.get(`cflag:${target}:102`) == 3) { // :7771
        await era.printAndWait(`「呜…呜呜~…${sc()}的小宝宝要………」`); // :7772

      } else if (era.get(`cflag:${target}:102`) == 5) { // :7774
        if (era.get(`talent:${target}:136`) == 1) { // :7775
          await era.printAndWait(`「要、要生出来了、可爱的狗宝宝~♪」`); // :7776
        } else { // :7777
          await era.printAndWait(`「呜…呜呜~…${sc()}的小宝宝要………」`); // :7778
        } // :7779

      } else if (era.get(`cflag:${target}:102`) == 7) { // :7781
  ...
  if (era.get('tflag:13') == 13) { // :7823

    if (era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) { // :7825

      if (era.get(`talent:${target}:153`)) { // :7827
        await era.printAndWait(`「还有一会就要生出来了、敬请期待吧~♪」`); // :7828
        await era.printAndWait(`${target_name}摸着迎接临盆的而变大的肚子………`); // :7829

      } else if (era.get(`talent:${target}:154`)) { // :7831
  ...
  if (era.get('tflag:13') == 14) { // :7842

    if (era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) { // :7844
  ...
  if (era.get('tflag:13') == 999) { // :7854

    if (era.get(`talent:${target}:85`)) { // :7856
  ...
  if (era.get('tflag:13') == 998) { // :7867

    if (era.get(`talent:${target}:85`)) { // :7869
...
async function DUNGEON_RYOUZYOKU_K3() {




  if (era.get(`talent:${target}:0`) == 1) { // :7913

    await era.printAndWait(`「${sc()}的第一次…骗人…骗人的…」`); // :7915

    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :7917


      await era.printAndWait(`「全部…都结束了啊…」`); // :7920

      return 0; // :7922
    } else if (era.get(`talent:${target}:17`) ==1 || era.get(`talent:${target}:31`) == 1 || era.get(`talent:${target}:36`) == 1) { // :7923


      await era.printAndWait(`「不管用${sc()}的哪个地方都没关系…只要留下小命的话......！」`); // :7926


      if (era.get(`talent:${target}:106`) == 1 || era.get(`exp:${target}:1`) > 0) { // :7930
        await era.printAndWait(`「哈啊…比起前面来说屁股会更加舒服的、就这样好吧！」`); // :7930
      } // :7930


      if (era.get(`exp:${target}:22`) > 0) { // :7934
        await era.printAndWait(`「会用嘴巴来做的…请饶过…${sc()}的小命......！」`); // :7934
      } // :7934

    } else if (era.get(`talent:${target}:11`) == 1 || era.get(`talent:${target}:12`) == 1 || era.get(`talent:${target}:15`) == 1 || era.get(`talent:${target}:30`) == 1 || era.get(`talent:${target}:34`) == 1) { // :7936



      await era.printAndWait(`「…嘛、只是一张膜女人的价值才不会改变呢！」`); // :7940

    } else if (era.get(`talent:${target}:10`) == 1 || era.get(`talent:${target}:26`) == 1) { // :7942
    ...
    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :7957


      await era.printAndWait(`「这是一场梦来的…」`); // :7960

      return 0; // :7962
    } else if (era.get(`talent:${target}:17`) ==1 || era.get(`talent:${target}:31`) == 1 || era.get(`talent:${target}:36`) == 1) { // :7963


      await era.printAndWait(`「只要是${sc()}的身体不管怎样都没关系…只要留下小命的话......！」`); // :7966


      if (era.get(`talent:${target}:106`) == 1 || era.get(`exp:${target}:1`) > 0) { // :7970
        await era.printAndWait(`「${sc()}…屁股的那边也可以的噢、会满足你们的…」`); // :7970
      } // :7970


      if (era.get(`exp:${target}:22`) > 0) { // :7974
        await era.printAndWait(`「用嘴巴的多少都会做的！　请饶过…${sc()}的小命！」`); // :7974
      } // :7974

    } else if (era.get(`talent:${target}:11`) == 1 || era.get(`talent:${target}:12`) == 1 || era.get(`talent:${target}:15`) == 1 || era.get(`talent:${target}:30`) == 1 || era.get(`talent:${target}:34`) == 1) { // :7976



      await era.printAndWait(`「真是不巧呢、处女什么的早就丢掉了、真、真是残念呢！」`); // :7980

    } else if (era.get(`talent:${target}:10`) == 1 || era.get(`talent:${target}:26`) == 1) { // :7982
...
async function DUNGEON_RYOUZYOKU_AFTER_K3() {




  if (era.get(`talent:${target}:0`) == 1) { // :8003

    await era.printAndWait(`「太好了…还是…没问题的…」`); // :8005

    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :8007
    ...
    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :8032
...
async function BENKI_KOUJO_K3() {
  ...
  if (era.get('flag:62') == 0) { // :8081


    if (era.get('flag:63') == 1) { // :8084
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8089
      await era.printAndWait(''); // :8090

    } else if (era.get(`talent:${a}:85`)) { // :8092
      await era.printAndWait(''); // :8093

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8095
      await era.printAndWait(''); // :8096

    } else { // :8098
      await era.printAndWait(''); // :8099
    } // :8100
  } else if (era.get('flag:62') == 1) { // :8101


    if (era.get('flag:63') == 1) { // :8104
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8109
      await era.printAndWait(''); // :8110

    } else if (era.get(`talent:${a}:85`)) { // :8112
      await era.printAndWait(''); // :8113

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8115
      await era.printAndWait(''); // :8116

    } else { // :8118
      await era.printAndWait(''); // :8119
    } // :8120
  } else if (era.get('flag:62') == 2) { // :8121


    if (era.get('flag:63') == 1) { // :8124
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8129
      await era.printAndWait(''); // :8130

    } else if (era.get(`talent:${a}:85`)) { // :8132
      await era.printAndWait(''); // :8133

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8135
      await era.printAndWait(''); // :8136

    } else { // :8138
      await era.printAndWait(''); // :8139
    } // :8140
  } else if (era.get('flag:62') == 3) { // :8141


    if (era.get('flag:63') == 1) { // :8144
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8149
      await era.printAndWait(''); // :8150

    } else if (era.get(`talent:${a}:85`)) { // :8152
      await era.printAndWait(''); // :8153

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8155
      await era.printAndWait(''); // :8156

    } else { // :8158
      await era.printAndWait(''); // :8159
    } // :8160
  } else if (era.get('flag:62') == 4) { // :8161


    if (era.get('flag:63') == 1) { // :8164
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8169
      await era.printAndWait(''); // :8170

    } else if (era.get(`talent:${a}:85`)) { // :8172
      await era.printAndWait(''); // :8173

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8175
      await era.printAndWait(''); // :8176

    } else { // :8178
      await era.printAndWait(''); // :8179
    } // :8180
  } else if (era.get('flag:62') == 5) { // :8181


    if (era.get('flag:63') == 1) { // :8184
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8189
      await era.printAndWait(''); // :8190

    } else if (era.get(`talent:${a}:85`)) { // :8192
      await era.printAndWait(''); // :8193

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8195
      await era.printAndWait(''); // :8196

    } else { // :8198
      await era.printAndWait(''); // :8199
    } // :8200
  } else if (era.get('flag:62') == 6) { // :8201


    if (era.get('flag:63') == 1) { // :8204
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8211
      await era.printAndWait(''); // :8212

    } else if (era.get(`talent:${a}:85`)) { // :8214
      await era.printAndWait(''); // :8215

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8217
      await era.printAndWait(''); // :8218

    } else { // :8220
      await era.printAndWait(''); // :8221
    } // :8222
  } else if (era.get('flag:62') == 7) { // :8223


    if (era.get('flag:63') == 1) { // :8226
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8232
      await era.printAndWait(''); // :8233

    } else if (era.get(`talent:${a}:85`)) { // :8235
      await era.printAndWait(''); // :8236

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8238
      await era.printAndWait(''); // :8239

    } else { // :8241
      await era.printAndWait(''); // :8242
    } // :8243
  } else if (era.get('flag:62') == 9) { // :8244


    if (era.get('flag:63') == 1) { // :8247
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8253
      await era.printAndWait(''); // :8254

    } else if (era.get(`talent:${a}:85`)) { // :8256
      await era.printAndWait(''); // :8257

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8259
      await era.printAndWait(''); // :8260

    } else { // :8262
      await era.printAndWait(''); // :8263
    } // :8264
  } else if (era.get('flag:62') == 12) { // :8265


    if (era.get('flag:63') == 1) { // :8268
    ...
    } else if (era.get(`talent:${a}:76`) == 1) { // :8274
      await era.printAndWait(''); // :8275

    } else if (era.get(`talent:${a}:85`)) { // :8277
      await era.printAndWait(''); // :8278

    } else if (era.get(`abl:${a}:16`) >= 5) { // :8280
...
async function DUNGEON_VICTORY_K3() {
  ...
  if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :8298


    await era.printAndWait(`「……」`); // :8301

    return 0; // :8303
  } else if (era.get(`talent:${target}:11`) == 1 || era.get(`talent:${target}:12`) == 1 || era.get(`talent:${target}:15`) == 1 || era.get(`talent:${target}:30`) == 1 || era.get(`talent:${target}:34`) == 1) { // :8304


    if (rand_n(3) == 0) { // :8307
      await era.printAndWait(`「真是对不起了~♪」`); // :8308
    } else if (rand_n(2) == 0) { // :8309
      await era.printAndWait(`「真是不像样……」`); // :8310
    } else { // :8311
      await era.printAndWait(`「完全没有可能会输嘛！」`); // :8312
    } // :8313

  } else if (era.get(`talent:${target}:10`) == 1 || era.get(`talent:${target}:26`) == 1) { // :8315
  ...
  if ((era.get(`base:${a}:0`) * 100 / era.get(`maxbase:${a}:0`) < 50) || (era.get(`base:${a}:1`) * 100 / era.get(`maxbase:${a}:1`) < 50)) { // :8334
...
async function DUNGEON_ATTACK_K3() {




  if (era.get(`cflag:${target}:1`) == 2) { // :8350

    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :8352


      await era.printAndWait(`「……」`); // :8355

      return 0; // :8357
    } else if (era.get(`talent:${target}:11`) == 1 || era.get(`talent:${target}:12`) == 1 || era.get(`talent:${target}:15`) == 1 || era.get(`talent:${target}:30`) == 1 || era.get(`talent:${target}:34`) == 1) { // :8358


      if (era.get(`talent:${target}:278`)) { // :8361

        await era.printAndWait(`「就让${sc()}的光来抹杀你吧！」`); // :8363
      } else if (rand_n(3) == 0) { // :8364
        await era.printAndWait(`「才不会输的!！」`); // :8365
      } else if (rand_n(2) == 0) { // :8366
        await era.printAndWait(`「区区你这样的家伙！」`); // :8367
      } else { // :8368
        await era.printAndWait(`「${sc()}的力量……好好地见识一下吧！」`); // :8369
      } // :8370

    } else if (era.get(`talent:${target}:10`) == 1 || era.get(`talent:${target}:26`) == 1) { // :8372


      if (era.get(`talent:${target}:256`)) { // :8375
      ...
      if (era.get(`talent:${target}:258`)) { // :8386

        await era.printAndWait(`「跟得上${sc()}的速度吗？」`); // :8388
      } else if (rand_n(3) == 0) { // :8389
        await era.printAndWait(`「会加油的！」`); // :8390
      } else if (rand_n(2) == 0) { // :8391
    ...
    if (era.get(`talent:${target}:21`) == 1 || era.get(`talent:${target}:22`) == 1) { // :8400


      await era.printAndWait(`「……」`); // :8403

      return 0; // :8405
    } else if (era.get(`talent:${target}:11`) == 1 || era.get(`talent:${target}:12`) == 1 || era.get(`talent:${target}:15`) == 1 || era.get(`talent:${target}:30`) == 1 || era.get(`talent:${target}:34`) == 1) { // :8406


      if (rand_n(3) == 0) { // :8409
        await era.printAndWait(`「向魔王大人屈服吧！」`); // :8410
      } else if (rand_n(2) == 0) { // :8411
        await era.printAndWait(`「不要再做无用的抵抗了！」`); // :8412
      } else { // :8413
        await era.printAndWait(`「${sc()}新的力量……好好地见识一下吧！」`); // :8414
      } // :8415

    } else if (era.get(`talent:${target}:10`) == 1 || era.get(`talent:${target}:26`) == 1) { // :8417
...
async function COLOSSEUM_KOJO_3() {



  if (era_flag.selectcom == 55) { // :8449

    if (era.get(`base:${target}:1`) <= 0) { // :8451
  ...
  if (era_flag.selectcom == 56) { // :8461

    if (era.get(`base:${target}:1`) <= 0) { // :8463

      if (era_flag.assi > 0 && era_flag.assiplay) { // :8465
      ...
      if (era_flag.assi > 0 && era_flag.assiplay) { // :8474
  ...
  if (era_flag.selectcom == 31) { // :8488

    if (era_flag.assi > 0 && era_flag.assiplay) { // :8490
      await era.printAndWait(`「啊哼嗯…嗯呜…再、再这样做的话…呜噗嗯！？嗯噗嗯嗯噗嗯……！」`); // :8491
      await era.print(`${assi_name}用`); // :8492
      if (era.get(`talent:${assi}:121`) == 1 || era.get(`talent:${assi}:122`) == 1) { // :8494
        await era.print(`大鸡巴`); // :8494
      } // :8494
      if (era.get(`talent:${assi}:121`) != 1 && era.get(`talent:${assi}:122`) != 1 && era.get('item:4') == 1) { // :8496
  ...
  if (era_flag.selectcom == 5) { // :8507

    if (era_flag.assi > 0 && era_flag.assiplay) { // :8509
  ...
  if (era_flag.selectcom == 21) { // :8521

    if (era_flag.assi > 0 && era_flag.assiplay) { // :8523
      await era.printAndWait(`「啊啊~！不，不行的啊…这样…强行做这样的…啊啊啊啊！」`); // :8524
      await era.print(`${assi_name}一边听着悲鸣一边用`); // :8525
      if (era.get(`talent:${assi}:121`) == 1 || era.get(`talent:${assi}:122`) == 1) { // :8527
        await era.print(`大鸡巴`); // :8527
      } // :8527
      if (era.get(`talent:${assi}:121`) != 1 && era.get(`talent:${assi}:122`) != 1 && era.get('item:4') == 1) { // :8529
        await era.print(`假阳具`); // :8529
      } // :8529
      await era.printAndWait(`将${target_name}的小穴毫不留情地侵犯着……`); // :8530

    } else if (era.get('tflag:400') == 206) { // :8532
  ...
  if (era_flag.selectcom == 27) { // :8545

    if (era_flag.assi > 0 && era_flag.assiplay) { // :8547
      await era.printAndWait(`「啊啊~！啊~啊啊~！屁股…要坏掉了啊~…~！」`); // :8548
      await era.print(`${assi_name}一边听着悲鸣一边用`); // :8549
      if (era.get(`talent:${assi}:121`) == 1 || era.get(`talent:${assi}:122`) == 1) { // :8551
        await era.print(`大鸡巴`); // :8551
      } // :8551
      if (era.get(`talent:${assi}:121`) != 1 && era.get(`talent:${assi}:122`) != 1 && era.get('item:4') == 1) { // :8553
        await era.print(`假阳具`); // :8553
      } // :8553
      await era.printAndWait(`将${target_name}的肛穴毫不留情地侵犯着……`); // :8554

    } else if (era.get('tflag:400') == 206) { // :8556
...
// @NTR_KOUJO_K3 // :8579
async function NTR_KOUJO_K3() {


  if (era.get(`cflag:${target}:650`) == 0) { // :8583
  ...
  if (P == 1) { // :8586
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8588
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8597
    ...
    if (era.get(`talent:${target}:136`)) { // :8605
      await era.printAndWait(`「啊啊~~♪…请继续看着被狗侵犯还会有感觉的${sc()}吧~~${heart(1)}」`); // :8606
    } else if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8607
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8615
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8623
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8631
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8639
    ...
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) { // :8649
      if (era.get(`cflag:${target}:102`) == 1) { // :8650
...
async function EXUCUTION_KOUJO_K3() {


  if (era.get('tflag:16') == 4) { // :8665
    await era.printAndWait(`「哈啊！${sc()}居然成为了怪物的慰安妇什么的…啊…不要…不要啊啊~！」`); // :8666

  } else if (era.get('tflag:16') == 5) { // :8668
    await era.printAndWait(`「${sc()}在…${sc()}在消失着………」`); // :8669

  } else if (era.get('tflag:16') == 6) { // :8671
    await era.printAndWait(`「只要能忍受地了真的就能解放${sc()}了对吧？」`); // :8672

  } else if (era.get('tflag:16') == 7) { // :8674
...
async function MUSEUM_KOUJO_K3() {


  if (era.get('tflag:500') == 0) { // :8682
    await era.printAndWait(`「把${sc()}变成石头当装饰什么的…真是…十分地恶趣味啊………」`); // :8683

  } else if (era.get('tflag:500') == 1) { // :8685
    await era.printAndWait(`「到这种地方来才不是为了被剥制的啊！」`); // :8686

  } else if (era.get('tflag:500') == 2) { // :8688
    await era.printAndWait(''); // :8689

  } else if (era.get('tflag:500') == 3) { // :8691
    await era.printAndWait(`「很、很让人害羞的啊…快点结束本小姐这种耻辱的…」`); // :8692

  } else if (era.get('tflag:500') == 4) { // :8694
    await era.printAndWait(`「让尊贵的${sc()}、变成人偶…哪、哪里…搞、错……了……吧…啊…」`); // :8695

  } else if (era.get('tflag:500') == 5) { // :8697
    await era.printAndWait(''); // :8698

  } else if (era.get('tflag:500') == 6) { // :8700
    await era.printAndWait(''); // :8701

  } else if (era.get('tflag:500') == 7) { // :8703
    await era.printAndWait(''); // :8704

  } else if (era.get('tflag:500') == 8) { // :8706
    await era.printAndWait(''); // :8707

  } else if (era.get('tflag:500') == 9) { // :8709
...
async function BANISHMENT_KOUJO_K3() {



  if (era.get('tflag:510') == 0) { // :8718
    await era.printAndWait(`${sc()}的…${sc()}的力量…完全…没有了啊………」`); // :8719

  } else if (era.get('tflag:510') == 1) { // :8721
    await era.printAndWait(''); // :8722

  } else if (era.get('tflag:510') == 2) { // :8724
    await era.printAndWait(''); // :8725

  } else if (era.get('tflag:510') == 3) { // :8727
    await era.printAndWait(''); // :8728

  } else if (era.get('tflag:510') == 4) { // :8730
...
async function PUBLIC_EXUCUTION_KOUJO_K3() {



  if (era.get('tflag:520') == 0) { // :8739
    await era.printAndWait(`「已经…什么都…感觉不到了…啊…啊啊啊啊…${sc()}的…噶………咳咳」`); // :8740

  } else if (era.get('tflag:520') == 1) { // :8742
    await era.printAndWait(`「这样终于能轻松了呢………」`); // :8743

  } else if (era.get('tflag:520') == 2) { // :8745
...
async function GROTESQUE_KOUJO_K3() {



  if (era.get('tflag:530') == 0) { // :8754
    await era.printAndWait(''); // :8755

  } else if (era.get('tflag:530') == 1) { // :8757
    await era.printAndWait(''); // :8758

  } else if (era.get('tflag:530') == 2) { // :8760
    await era.printAndWait(''); // :8761

  } else if (era.get('tflag:530') == 3) { // :8763
    await era.printAndWait(''); // :8764

  } else if (era.get('tflag:530') == 4) { // :8766
    await era.printAndWait(''); // :8767

  } else if (era.get('tflag:530') == 5) { // :8769
    await era.printAndWait(''); // :8770

  } else if (era.get('tflag:530') == 6) { // :8772
...
async function ENTERENEMY_KOUJO_K3() {


  if (era.get(`talent:${a}:21`) == 1 || era.get(`talent:${a}:22`) == 1) { // :8780

    await era.printAndWait(`「………%SELF_CALL(A)%会打倒魔王的」`); // :8782
  } else if (era.get(`talent:${a}:11`) == 1 || era.get(`talent:${a}:12`) == 1 || era.get(`talent:${a}:15`) == 1 || era.get(`talent:${a}:30`) == 1 || era.get(`talent:${a}:34`) == 1) { // :8783

    await era.printAndWait(`「噢吼～吼吼吼！魔王什么的%SELF_CALL(A)%用一根手指头就能打败给你看~！」`); // :8785
  } else if (era.get(`talent:${a}:10`) == 1 || era.get(`talent:${a}:26`) == 1) { // :8786
...
async function GOHOUBI_AFTER_KOUJO_K3() {





  if (era.get('tflag:18') == 0) { // :8839
    await era.printAndWait(`「难得%SELF_CALL(A)%…什，什么都没有啦」`); // :8840

  } else if (era.get('tflag:18') == 1) { // :8842
    await era.printAndWait(`「哼哼哼~、要得到多少个勋章才能给%SELF_CALL(A)%奖赏呢~？」`); // :8843
  } else if (era.get('tflag:18') == 2) { // :8844

    if (era.get(`cflag:${a}:504`) == 0) { // :8846
      await era.printAndWait(`「非常地感谢。那个…这个钱%SELF_CALL(A)%想要送回老家可以吗………」`); // :8847

    } else if (era.get(`cflag:${a}:504`) == 1) { // :8849

      if (era.get(`talent:${a}:0`) == 1) { // :8851
    ...
    } else if (era.get(`cflag:${a}:504`) == 2) { // :8857

      if (era.get(`talent:${a}:0`) == 1) { // :8859
    ...
    } else if (era.get(`cflag:${a}:504`) == 3) { // :8865

      if (era.get(`talent:${a}:0`) == 1) { // :8867
    ...
    } else if (era.get(`cflag:${a}:504`) == 4) { // :8873
      await era.printAndWait(`，今天的KISS十分地甜蜜呢`); // :8874

    } else if (era.get(`cflag:${a}:504`) == 5) { // :8876

      if (era.get(`abl:${a}:2`) > era.get(`abl:${a}:3`)) { // :8878
...
async function OSIOKI_KOUJO_K3() {





  if (era.get('tflag:18') == 0) { // :8917
    await era.printAndWait(`「得、得救了呀………」`); // :8918

  } else if (era.get('tflag:18') == 1) { // :8920

    if (era.get(`abl:${a}:21`) >= 3) { // :8922
      await era.printAndWait(`「哔哩哔哩地！啊~~哈啊~~~！哔哩~${heart(1)}」`); // :8923
    } else { // :8924
      await era.printAndWait(`「不，不要啊~~~！电什么的不要啊！啊哇哇哇哇哇」`); // :8925
    } // :8926

  } else if (era.get('tflag:18') == 2) { // :8928

    if (era.get(`abl:${a}:17`) >= 4) { // :8930
...
async function GOBI_KOUJO_K3() {


  if (arg_0 == 1) { // :8977

    await era.print(`的噢~♪`); // :8979
  } else if (arg_0 == 2) { // :8980

    await era.print(`的啊！`); // :8982
  } else if (arg_0 == 3) { // :8983

    await era.print(`来着……。`); // :8985
  } else if (arg_0 == 4) { // :8986

    await era.print(`来的……呢~。`); // :8988
  } else if (arg_0 == 5) { // :8989
