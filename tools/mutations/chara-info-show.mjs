...
export const COUNT = 75; // #593 +2（M11983/M11984：同屏固定编号核对——条件键基数进预设段、名单轮插 [7] 探针）；#586 +9（M11900-M11902：献祭名单轮的返回编号——撞号复现、打印与判定各自的错位；M11903-M11906、M11907-M11908：十个探针暴露的覆盖缺口——条件键两端、编号基数、勇者档、自身排除、RESTART）；#565 返工 +1（M11633：TARGET 换手删除——语尾回退按调用方取）；#390 建表 60 条；#546 +3（M11544-M11546：SHOW_BLOCK 的 [8] 一人称重设真按钮——快捷键、正文前缀、一人称行补宽）
