...
export default [
  ...
  {
    desc: 'M244 版本轴退回 0.0.0（【版本】改 0 而【版本代号】仍是当前串——编码一致性用例红，#138 抬版本的机器可查子集；find 随 #188 抬 0.0.2、#215 抬 0.0.3、#217 抬 0.0.4、#349 抬 0.0.5、#545 抬 0.0.6、#547 抬 0.0.7 同步）',
  ...
  {
    desc: 'M246 版本退回 0（loadData 的 truthy 短路把所有存档拒掉——版本下限与闸门用例双红，#138 追加；find 随 #188 抬 0.0.2、#215 抬 0.0.3、#217 抬 0.0.4、#349 抬 0.0.5、#545 抬 0.0.6、#547 抬 0.0.7 同步）',
    file: 'yml/GameBase.yml',
    find: `"版本": 7`,
    replace: `"版本": 0`,
    tests: ['extalent-table'],
