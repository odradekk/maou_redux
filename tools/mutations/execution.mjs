...
export const COUNT = 168; // #597 起 +3（M12121：处刑对象列表表头之后的 :22 PRINTL 不是空行；
// M12124/M12125：公开处刑的勋章空行只属于 :56/:76 两支——第三支补回与第一支删除都算错）；#572 起 +10（M11990-M11999：流放/公开处刑/处置菜单/设施四菜单按钮化）；#593 起 +1（M11985：批量处刑的 [121] 退回预设 ID 段——同屏核对）；#549 起 +2（M11641/M11642：自動處刑1 漏播报、流放漏勋章——自动处刑 e2e 唯一守卫）；#561 起 +12（M11782-M11793：归档槽位/NO 寻址与等待次数）
