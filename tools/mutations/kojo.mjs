...
export default [
  ...
  {
    desc: 'M2000 K0 GOHOUBI_AFTER choice==0 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
    find: '  if (choice === 0) {\n    // :8167',
  ...
  {
    desc: 'M2001 K0 GOHOUBI_AFTER 买药分支删松（CFLAG:504==0 改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
    find: '    if ((era.get(`cflag:${target}:504`) || 0) === 0) {\n      // :8174',
  ...
  {
    desc: 'M2002 K0 OSIOKI choice==1 快感分支删松（ABL:21 改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
  ...
  {
    desc: 'M2008 K0 NTR P==1 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
    find: '  if (p === 1) {\n    // :7873',
  ...
  {
    desc: 'M2009 K0 EXUCUTION 事件类型 4 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
  ...
  {
    desc: 'M2010 K0 MUSEUM 事件类型 3 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
  ...
  {
    desc: 'M2011 K0 BANISHMENT 事件类型 0 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
  ...
  {
    desc: 'M2012 K0 PUBLIC_EXUCUTION 事件类型 0 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
    find: '  if (event_type === 0) {\n    // :8023',
    replace: '  if (false) { // 变异：事件类型 0 删松',
    tests: ['kojo-k0-tender'],
  ...
  {
    desc: 'M2013 K0 COLOSSEUM selectcom 55 分支删松（改恒 false）（#231）',
    file: 'ere/kojo/kojo-k0-tender.js',
