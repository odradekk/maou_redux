...
// @EXP_GOT_CHECK`,
  ...
  // —— #572：满月确认的按钮化 ——
  {
    desc: 'M12036 满月确认的两项退回纯文本行（引擎里点不动）',
    file: 'ere/system/train/com-toy.js',
    find: "  era.printButton('好的', 0);\n  era.printButton('算了', 1);",
    replace: "  era.print('[0] 好的 [1] 算了'); // 变异",
    tests: ['com-toy'],
  ...
  {
    desc: 'M12321 奉仕分派：様子拆回独立一行（:922-941 的 PRINTFORML 收尾 :892-920 的穴句行）',
    file: 'ere/system/train/benki.js',
  ...
  {
    desc: 'M12323 通常分派：様子拆回独立一行（:1236-1260 的 PRINTFORML 收尾 :1224-1232 的名字句）',
    file: 'ere/system/train/benki.js',
