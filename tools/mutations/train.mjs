...
// @EXP_GOT_CHECK`,
  ...
  },
  {
    ...
    file: 'ere/system/train/benki.js',
    find: "    s = ''; // :892-941 的穴句行（角色名已在上一行）",
    replace: '    s = `${name_of(arg)}`; // 变异：角色名挪回穴句行',
    tests: ['benki'],
