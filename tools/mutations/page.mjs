...
export default [
  ...
  {
    desc: 'M12070 能力值提升页每条按钮之后补回空行（:81-83 的 PRINTL 只收行，golden 里四行按钮逐行相邻）',
    file: 'ere/page/page-ablup.js',
