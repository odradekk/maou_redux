...
export const COUNT = 181; // #396 起 +12（M8104-M8115 段，page-shop-trap.js 与 page-shop.js 接线）；
...
export default [
  ...
  {
    desc: 'M8403 ABILITY_UP 奴隶一览每页行数（23 → 24）',
    file: 'ere/page/page-ability-up.js',
    find: 'const SLAVE_NUM_PAGE = 23;',
    replace: 'const SLAVE_NUM_PAGE = 24;',
    tests: ['page-ability-up'],
  ...
  {
    desc: 'M8416 INTERCEPT 出击写入的侵攻度（90 → 91）',
    file: 'ere/page/page-intercept.js',
    find: 'const DISPATCH_DURATION = 90;',
    replace: 'const DISPATCH_DURATION = 91;',
    tests: ['page-intercept'],
    must_mention: '出击决定写入状态与扣款',
  },
  {
  ...
  {
    desc: 'M8420 INTERCEPT 设施编号基数（349 → 350）',
    file: 'ere/page/page-intercept.js',
    find: 'const ROOM_ID_BASE = 349;',
    replace: 'const ROOM_ID_BASE = 350;',
    tests: ['page-intercept'],
    must_mention: '行动设定选扩张设施',
  },
  {
    desc: 'M8421 INTERCEPT 设施扩张上限（3 → 4）',
    file: 'ere/page/page-intercept.js',
    find: 'const ROOM_LEVEL_MAX = 3;',
    replace: 'const ROOM_LEVEL_MAX = 4;',
    tests: ['page-intercept'],
    must_mention: '已到上限',
  },
  {
  ...
  {
    desc: 'M8426 PAGE-TAILOR 普通装备价格（1000 → 1001）',
    file: 'ere/page/page-tailor.js',
    find: 'const NORMAL_PRICE = 1000;',
    replace: 'const NORMAL_PRICE = 1001;',
    tests: ['page-tailor'],
    must_mention: '42 件整表驱动',
  },
  {
  ...
  {
    desc: 'M8429 PAGE-TAILOR 尿布价格（50 → 51）',
    file: 'ere/page/page-tailor.js',
    find: 'const DIAPER_PRICE = 50;',
    replace: 'const DIAPER_PRICE = 51;',
    tests: ['page-tailor'],
    must_mention: '主菜单选项与条件门',
  },
  {
  ...
  {
    desc: 'M8431 PAGE-TAILOR 强化上限（10 → 11）',
    file: 'ere/page/page-tailor.js',
    find: 'const ENHANCE_MAX = 10;',
    replace: 'const ENHANCE_MAX = 11;',
    tests: ['page-tailor'],
    must_mention: '超限回退',
  },
  {
  ...
  {
    desc: 'M8435 PAGE-TAILOR 装备品页数（4 → 5）',
    file: 'ere/page/page-tailor.js',
    find: 'const ACCESSORY_PAGE_MAX = 4;',
    replace: 'const ACCESSORY_PAGE_MAX = 5;',
    tests: ['page-tailor'],
    must_mention: '43 件整表驱动',
  },
  {
    desc: 'M8436 PAGE-TAILOR 旧内衣变卖基数（50 → 51）',
    file: 'ere/page/page-tailor.js',
    find: '      let price = 50 * cflag(cid, 48); // :181',
    replace: '      let price = 51 * cflag(cid, 48); // 变异：变卖基数',
    tests: ['page-tailor'],
    must_mention: '内衣的旧内衣变卖',
  },
];
