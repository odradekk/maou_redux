...
export default [
  ...
  {
    desc: 'M12252 横幅第一行的首段 "-"*16 与尾随空格删掉（:63/65 的拼接）',
    file: 'ere/page/page-chara-info-show.js',
    find: '      `${dashes()} 魔王之影 『 ${chara_callname(shadow)} 』 ${dashes()}  `,',
    replace:
      '      `魔王之影 『 ${chara_callname(shadow)} 』`, // 变异：首段短横线与尾随空格都没了',
    tests: ['chara-info-show'],
    must_mention: '横幅第一行',
  },
  {
