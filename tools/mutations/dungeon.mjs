...
export const COUNT = 283; // #548 起 +3（M11485-M11487：BEDROOM_BATTLE_MALE 真身——
// 男人位判据、欲望门槛、睡着分支文案）；#461 +1（SOURCE_CHECK_AUTO 接线 M9882，号段见 #461 完成报告——原
...
export default [
  ...
  {
    desc: 'M11487 BEDROOM_BATTLE_MALE 睡着分支文案错（MODE 0 也打「察觉到了气息」）',
    file: 'ere/dungeon/dungeon.js',
    find: '    era.print(`${name_of(0)}从睡梦中醒了过来。`); // :1056',
    replace:
      '    era.print(`${name_of(0)}察觉到了${name_of(cid)}的气息。`); // 变异：MODE 0 文案错',
    tests: ['dungeon-bedroom'],
    must_mention: 'MODE 0',
  },
];
