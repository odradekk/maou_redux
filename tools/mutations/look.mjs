...
export const COUNT = 87; // #570 起 +3（M11766-M11768，语尾行内拼接）；+3（M11774 调用点丢返回值、M11775 换行多空行、M11776 收尾另起一行）；+30（M11910-M11939，20 个语尾调用点的情绪档与其分支，含两处条件对调）；+3（M11960-M11962，显示面的上界/门槛/心形上限三个字面量——票里点名的 29/31 实测是等价变异，见条目头注）；+3（M12180-M12182，经验補正七组各自的档位，#601）
...
export default [
  ...
  make(
    12180,
    '肛门快乐经验的档位整组抄回其余六组的 100/30',
    '[E_肛门快乐经验, LOVE.A性感, 200, 80],',
    '[E_肛门快乐经验, LOVE.A性感, 100, 30],',
    'EXP:32 = 200 → LOVE:12（档位 200/80）',
  ),
  make(
    12181,
    '肛门快乐经验的下档 80 改成 30（上档 200 不动）',
    '[E_肛门快乐经验, LOVE.A性感, 200, 80],',
    '[E_肛门快乐经验, LOVE.A性感, 200, 30],',
    'EXP:32 = 80 → LOVE:12（档位 200/80）',
  ),
  make(
    12182,
    '精饮绝顶经验误抄成肛门组的 200/80',
    '[E_精饮绝顶经验, LOVE.精液, 100, 30],',
    '[E_精饮绝顶经验, LOVE.精液, 200, 80],',
    'EXP:8 = 101 → LOVE:31（档位 100/30）',
  ),
];
