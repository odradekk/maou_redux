// 源: target/ERB/口上/EVENT_K904_菲娅.ERB  @全部内联引用
// issue #250；#298 锚鉴别力锁。
//
...
const SRC = 'target/ERB/口上/EVENT_K904_菲娅.ERB';

export const FILES = [
  {
    js: 'ere/kojo/kojo-k904-fia.js',
    refs: [
      {
        src: SRC,
        ref: '1-6724',
      ...
      },
      {
        src: SRC,
        ref: '291',
        any: [/^(?:\uFEFF)?[ \t]*CALL[ \t]+K904_KOJO2[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '292',
        any: [/^(?:\uFEFF)?[ \t]*CALL[ \t]+K904_FUKU[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '351-352',
      ...
      },
      {
        src: SRC,
        ref: '4858',
        any: [/^(?:\uFEFF)?[ \t]*@KOJO_MESSAGE_PALAMCNG_904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '4861-4862',
      ...
      },
      {
        src: SRC,
        ref: '5197',
        any: [/^(?:\uFEFF)?[ \t]*@KOJO_MESSAGE_MARKCNG_904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '5200-5201',
      ...
      },
      {
        src: SRC,
        ref: '5850',
        any: [/^(?:\uFEFF)?[ \t]*@DUNGEON_RYOUZYOKU_AFTER_K904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '5855',
      ...
      },
      {
        src: SRC,
        ref: '6455',
        any: [/^(?:\uFEFF)?[ \t]*@PUBLIC_EXUCUTION_KOUJO_K904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '6459',
      ...
      },
      {
        src: SRC,
        ref: '6517',
        any: [/^(?:\uFEFF)?[ \t]*@GOHOUBI_REQUEST_KOUJO_K904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '6520',
      ...
      },
      {
        src: SRC,
        ref: '6555',
        any: [/^(?:\uFEFF)?[ \t]*@GOHOUBI_AFTER_KOUJO_K904[ \t]*$/m],
      },
      {
        src: SRC,
        ref: '6561',
