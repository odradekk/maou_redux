 ...
 *
 * 固定编号的字面量上限是 4001（名册表头 1200-1500、一并积极性 [1600]、换号
 * [1700] 与其内的 [1999]-[2003]/[3000]-[3002]/[4000]-[4001]、批量处刑
 * [1999]-[2001]、com-register [998]-[1000]、目标选择 [1000]-[1002]…），
 * 另有「常量 + 角色 ID」型的家族行按钮（15_000 + 角色 ID）；两者之间留出
 * 余量后起点取 100000。test/child-id-collision.test.js 的静态检查守这条
 * 不变量，改小即红。撞号清单与选点依据见 #560。
 */
