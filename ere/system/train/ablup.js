 ...
 *     在自己文件内没有任何调用点，是 @AUTO_ABLUP 专用的另一条独立通路；
 *     AUTO_ABLUP 仍是 juel-check.js 的 STUBBED_CALLS 存根，不在本票范围，
 *     故不移植（#464/#465/#466 的 0～17、20～23、30～33 各 CORE 同理；原作
 *     全库唯一一处 CORE 调用是 ABL.ERB:211 的 `CALL CORE_ABLUP99`，而那则
 *     尚未移植）。
 *
