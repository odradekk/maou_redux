 ...
 *
 * 源: target/ERB/口上/EVENT_K10_クラブ.ERB  @EVENTTRAIN #PRI（:62-67，存在
 *     标志 FLAG:110）@EVENTEND #LATER（:68-75，清标志）@K10_KOJO2（:603-815，
 *     二回目以降调教开始）@KOJO_MESSAGE_COM_10（:900-4849，指令口上状态机，
 *     CFLAG:301-400 使用同 K3 惯例）@DOG_KOJO_10（:4850-5653，本地函数，非
 *     family 分发）@KOJO_MESSAGE_PALAMCNG_10（:5654-5948）
 *     @KOJO_MESSAGE_MARKCNG_10（:5949-6030）@SELF_KOJO_K10（:6031-6478）
 *     @DUNGEON_RYOUZYOKU_K10 起余下战斗/迷宫/死斗场/NTR/处刑/奖惩口上
 *     （:6479-7303）。
 *
...
on(
  'EVENTTRAIN',
  () => {
    game.kojo.口上存在_10 = 1; // :64 FLAG:110 = 1（K10 口上存在标志）
    if (game.kojo.口上开关 === 0) {
      game.kojo.口上开关 = 2; // :66
    }
  },
...
on('EVENTTRAIN', async () => {
  ...
  if (chara(target).kojo.初调教 == 0) {
    ...
    if (era.get(`talent:${target}:314`) == 9) {
      ...
      for (;;) {
        ...
        if (result0 < 0 || result0 > 1) {
          continue; // :107-108 GOTO INPUT_LOOP
        }
        break;
      }
      if (result0 == 0) {
      ...
      for (;;) {
        ...
        if (result1 < 0 || result1 > 1) {
          continue; // :134-135 GOTO INPUT_LOOP1
        }
        break;
      }
      if (result1 == 0) {
    ...
    if (era.get(`talent:${target}:85`) || era.get(`talent:${target}:76`)) {
      ...
      chara(target).kojo.NTR再捕获 = 0; // :166
    } else {
      // :167-168
      era.drawLine(); // :168
      await era.printAndWait(
      ...
      chara(target).kojo.NTR再捕获 = 0; // :174
    } // :174-176
    return 1; // :175-177
  } else if (
    ...
    chara(target).kojo.初调教 = 9; // :344
    return 1; // :345-346
  } else if (era.get(`talent:${target}:9`) == 1) {
    // :347
    await k10_kojo2(); // :348 崩坏した場合は二回目以降へ
  } else if (era_flag.assi < 0) {
    // :351
    await k10_kojo2(); // :352 助手なしは二回目以降へ
  } else if (era.get(`talent:${master}:122`) == 0) {
    // :361
    await k10_kojo2(); // :362 你が男じゃなかったら二回目以降へ
  } else if (assi == 20) {
    // :364
    era.drawLine(); // :365
    ...
    if (chara(target).kojo.简易助手_0 == 0) {
      ...
      if (
        ...
        chara(target).kojo.简易助手_0 = 2; // :375
      } else if (
        era.get(`talent:${target}:76`) == 1 &&
        chara(target).kojo.初调教 >= 5
      ) {
        ...
        chara(target).kojo.简易助手_0 = 2; // :383
      } else {
        // :385-386
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_0 = 1; // :392
      } // :392-394
      return 1; // :392-396
    } else if (
      ...
      if (era.get(`talent:${target}:85`) == 1) {
        ...
        chara(target).kojo.简易助手_0 = 2; // :406
        ...
        chara(target).kojo.简易助手_0 = 2; // :415
      } // :415-417
      return 1; // :416-419
    ...
    if (chara(target).kojo.简易助手_1 == 0) {
      ...
      if (
        ...
        chara(target).kojo.简易助手_1 = 2; // :451
      } else if (
        era.get(`talent:${target}:76`) == 1 &&
        chara(target).kojo.初调教 >= 5
      ) {
        ...
        await era.printAndWait(`『正是、魔王大人命令仆今天来当你的对手』`); // :456
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_1 = 2; // :461
      } else {
        // :463-464
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_1 = 1; // :470
      } // :470-472
      return 1; // :470-474
    } else if (
      ...
      if (era.get(`talent:${target}:85`) == 1) {
        ...
        await era.printAndWait(`『哈啊、呀累呀累、仆的竞争对手又增加了嘛………』`); // :479
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_1 = 2; // :485
      } else if (era.get(`talent:${target}:76`) == 1) {
        // :487
        ...
        chara(target).kojo.简易助手_1 = 2; // :494
      } // :494-496
      return 1; // :495-498
      ...
      if (era.get(`talent:${target}:85`) == 1) {
        ...
        await era.printAndWait(`『这、这样发情反而怪仆咯？ 你这家伙真是………』`); // :507
        await era.printAndWait(
      ...
      await era.printAndWait(`『赞同、仆正想这么做！』`); // :515
      return 1; // :515-517
    } // :517-518
  } else if (assi == 22) {
    // :519
    ...
    if (chara(target).kojo.简易助手_2 == 0) {
      ...
      if (
        ...
        chara(target).kojo.简易助手_2 = 2; // :531
      } else if (
        era.get(`talent:${target}:76`) == 1 &&
        chara(target).kojo.初调教 >= 5
      ) {
        ...
        chara(target).kojo.简易助手_2 = 2; // :539
      } else {
        // :541-542
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_2 = 1; // :547
      } // :547-549
      return 1; // :547-551
    } else if (
      ...
      if (era.get(`talent:${target}:85`) == 1) {
        ...
        chara(target).kojo.简易助手_2 = 2; // :560
      } else if (era.get(`talent:${target}:76`) == 1) {
        // :562
        await era.printAndWait(
        ...
        chara(target).kojo.简易助手_2 = 2; // :570
      } // :570-572
      return 1; // :571-574
...
async function k10_kojo2(rand) {
  ...
  if (era.get(`talent:${target}:9`) == 1 && game.kojo.口上开关 == 2) {
    ...
    if (era.get(`mark:${target}:3`) == 3 && game.kojo.口上开关 == 2) {
      ...
      await era.printAndWait(`${target_name}揉着眼角${glasses_word}。`); // :646
      await era.printAndWait(
  ...
  if (era_flag.selectcom == 56) {
    ...
    if (kojo.交谈 == 0) {
      ...
      if (era.get(`tequip:${target}:53`) == 1) {
        ...
        await era.print(`${master_name}催促${target_name}进行自我介绍。`); // :4199
        if (
          era.get(`palam:${target}:5`) >= PALAMLV[4] &&
          (era.get(`talent:${target}:85`) ||
            era.get(`abl:${target}:10`) >= 5) &&
        ...
        // :4222-4223
        await era.print(`在和${master_name}`); // :4223
        if (
          era.get(`palam:${target}:5`) >= PALAMLV[4] &&
          (era.get(`talent:${target}:85`) ||
            era.get(`abl:${target}:10`) >= 5) &&
...
async function dog_kojo_10(rand) {
  ...
  if (era_flag.selectcom == 27) {
    ...
    if (chara(target).kojo.背后位肛交 == 0) {
      ...
      chara(target).kojo.背后位肛交 = 1; // :5204
      return 0; // :5203-5208
    } else {
      // :5207-5208
      ...
      if (
        ...
        chara(target).kojo.背后位肛交 = 7; // :5215
      } else if (
        era.get(`talent:${target}:76`) == 1 &&
        era.get(`abl:${target}:3`) >= 3 &&
        ...
        chara(target).kojo.背后位肛交 = 6; // :5223
      } else if (
        era.get(`talent:${target}:85`) == 1 &&
        era.get(`abl:${target}:3`) >= 3 &&
        ...
        chara(target).kojo.背后位肛交 = 5; // :5231
      } else if (
        era.get(`talent:${target}:85`) == 1 &&
        ...
        chara(target).kojo.背后位肛交 = 4; // :5235
      } else if (
        era.get(`abl:${target}:3`) >= 3 &&
        ...
        chara(target).kojo.背后位肛交 = 3; // :5239
      } else if (
        ...
        chara(target).kojo.背后位肛交 = 2; // :5243
      } // :5242-5246
      return 0; // :5242-5248
    } // :5243-5250
  } // :5245-5250
...
async function kojo_message_palamcng_10(rand) {
  ...
  const P1 =
    (era.get(`palam:${target}:3`) || 0) + (era.get(`delta:${target}:3`) || 0); // :5682
  ...
  const P2 =
    (era.get(`palam:${target}:5`) || 0) + (era.get(`delta:${target}:5`) || 0); // :5713
  if (P2 > PALAMLV[2] && chara(target).kojo.首次欲情Lv2 == 0) {
    ...
    chara(target).kojo.首次欲情Lv2 = 1; // :5740
  } // :5740-5742

  const P3 =
    (era.get(`palam:${target}:8`) || 0) + (era.get(`delta:${target}:8`) || 0); // :5746
  if (P3 > PALAMLV[2] && chara(target).kojo.首次耻情Lv2 == 0) {
    ...
    chara(target).kojo.首次耻情Lv2 = 1; // :5757
  } // :5757-5759

  const P4 =
    (era.get(`palam:${target}:10`) || 0) + (era.get(`delta:${target}:10`) || 0); // :5763
  if (P4 > PALAMLV[2] && chara(target).kojo.首次恐怖Lv2 == 0) {
    ...
    chara(target).kojo.首次恐怖Lv2 = 1; // :5774
  } // :5774-5776
  ...
  if (era.get(`nowex:${target}:0`) > 0 && chara(target).kojo.首次C绝顶 == 0) {
    ...
    chara(target).kojo.首次C绝顶 = 1; // :5792
  } // :5792-5794
  ...
  if (era.get(`nowex:${target}:1`) > 0 && chara(target).kojo.首次V绝顶 == 0) {
    ...
    chara(target).kojo.首次V绝顶 = 1; // :5816
  } else if (
  ...
  if (era.get(`nowex:${target}:2`) > 0 && chara(target).kojo.首次A绝顶 == 0) {
    ...
    chara(target).kojo.首次A绝顶 = 1; // :5861
  } else if (
  ...
  if (era.get(`nowex:${target}:3`) > 0 && chara(target).kojo.首次B绝顶 == 0) {
    ...
    chara(target).kojo.首次B绝顶 = 1; // :5897
  } // :5897-5899
...
async function kojo_message_markcng_10(rand) {
  ...
  if (game.system.快乐刻印变动 == 3 && chara(target).kojo.快乐刻印Lv3 == 0) {
    ...
    chara(target).kojo.快乐刻印Lv3 = 1; // :5998
  } // :5998-6000
  ...
  if (game.system.屈服刻印变动 == 3 && chara(target).kojo.屈服刻印Lv3 == 0) {
    ...
    chara(target).kojo.屈服刻印Lv3 = 1; // :6007
  } // :6007-6009
  ...
  if (game.system.反抗刻印变动 == 3 && chara(target).kojo.反抗刻印Lv3 == 0) {
    ...
    chara(target).kojo.反抗刻印Lv3 = 1; // :6024
  } // :6024-6026
}
...
async function self_kojo_k10(rand, q) {
  ...
  if (game.train.初吻与自我口上 == 1) {
    ...
    if (era.get(`talent:${target}:9`) == 1) {
      ...
      // CFLAG:657 -= 1（NTR 调教后自慰计数递减） // :6043
      chara(target).kojo.NTR_657 = (chara(target).kojo.NTR_657 || 0) - 1; // :6043

      // Q = 3（跳过 AFTERTRAIN_MASTURBATION_CHECK 后续 Q==1/Q==2 分支） // :6045
      Q = 3;
      ...
      if (
        ...
        chara(target).kojo.调教后自慰 = 7; // :6101
      } else if (
        era.get(`talent:${target}:85`) &&
        era.get(`talent:${target}:74`) == 1 &&
        ...
        chara(target).kojo.调教后自慰 = 6; // :6109
      } else if (
        era.get(`talent:${target}:76`) &&
        ...
        chara(target).kojo.调教后自慰 = 5; // :6116
      } else if (
        era.get(`talent:${target}:85`) &&
        ...
        chara(target).kojo.调教后自慰 = 4; // :6123
      } else if (
        era.get(`talent:${target}:74`) == 1 &&
        (chara(target).kojo.调教后自慰 < 3 || game.kojo.口上开关 == 2)
      ) {
        ...
        chara(target).kojo.调教后自慰 = 3; // :6130
      } else if (
        era.get(`abl:${target}:31`) >= 3 &&
        ...
        chara(target).kojo.调教后自慰 = 2; // :6136
        ...
        chara(target).kojo.调教后自慰 = 1; // :6141
      } // :6141-6143
    } // :6141-6145
  } // :6142-6147
  ...
  if (game.train.初吻与自我口上 == 2) {
    ...
    if (era.get(`talent:${target}:9`) == 1) {
      ...
      chara(target).kojo.百合PLAY = 5; // :6161
    } else if (
      era.get(`talent:${target}:85`) &&
      ...
      chara(target).kojo.百合PLAY = 4; // :6168
    } else if (
      ...
      chara(target).kojo.百合PLAY = 3; // :6174
    } else if (
      ...
      chara(target).kojo.百合PLAY = 2; // :6179
      ...
      chara(target).kojo.百合PLAY = 1; // :6184
    } // :6184-6186
  } // :6184-6188
  ...
  if (game.train.初吻与自我口上 == 4) {
    ...
    if (
      ...
      chara(target).kojo.调教后性交 = 2; // :6240
      ...
      chara(target).kojo.调教后性交 = 1; // :6248
    } // :6248-6250
  } // :6248-6252
  ...
  if (game.train.初吻与自我口上 == 11) {
    ...
    if (chara(target).kojo.妊娠发觉 == 0) {
      ...
      if (era.get(`talent:${target}:9`) == 1) {
        ...
        await era.printAndWait(`${target_name}向${master_name}报告妊娠情况………`); // :6315
      } else if (chara(target).event.妊娠相手 == 3) {
        // :6317
        await era.printAndWait(
          `「虽然不用向你报告…好像有了${cstr2}的孩子………唔、总觉得知道父亲是谁………」`,
        ); // :6318
        await era.printAndWait(`${target_name}向${master_name}报告妊娠情况………`); // :6319
      } else if (
      ...
      if (era.get(`talent:${target}:9`) == 1) {
        ...
        await era.printAndWait(`${target_name}向${master_name}报告妊娠情况………`); // :6346
      } else if (chara(target).event.妊娠相手 == 3) {
        // :6348
        await era.printAndWait(
          `「虽然不用向你报告…好像有了${cstr2}的孩子………唔、总觉得知道父亲是谁………」`,
        ); // :6349
        await era.printAndWait(`${target_name}向${master_name}报告妊娠情况………`); // :6350
      } else if (
        chara(target).event.妊娠相手 == 5 &&
        era.get(`talent:${target}:136`) &&
        chara(target).invasion.状态 != 9
...
async function ntr_koujo_k10(rand, P) {
  ...
  if (chara(target).kojo.NTR再捕获 == 0) {
    ...
    chara(target).kojo.NTR_657 = rand_n(3) + 1; // :6859
  } // :6859-6861
  ...
  if (P == 1) {
    ...
    chara(target).kojo.NTR_652 = 1; // :6885

    // CFLAG:657 + = 1（变量语义：CFLAG 族，657 +） // :6887
    chara(target).kojo.NTR_657 += 1; // :6887
  } else if (P == 3) {
    // :6889
    ...
    chara(target).kojo.NTR_653 = 1; // :6898
  } else if (P == 4) {
    // :6900
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) {
      // :6901
    ...
    chara(target).kojo.NTR_654 = 1; // :6907

    // CFLAG:657 + = 1（变量语义：CFLAG 族，657 +） // :6909
    chara(target).kojo.NTR_657 += 1; // :6909
  } else if (P == 5) {
    // :6911
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) {
      // :6912
    ...
    chara(target).kojo.NTR_655 = 1; // :6917
  } else if (P == 6) {
    // :6919
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) {
      // :6920
    ...
    chara(target).kojo.NTR_656 = 1; // :6928
  } else if (P == 7) {
    // :6930
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) {
      // :6931
    ...
    chara(target).kojo.NTR_657 += 1; // :6940
  } else if (P == 20) {
    // :6942
    if (era.get(`talent:${target}:76`) || era.get(`talent:${target}:85`)) {
      // :6943
...
async function gohoubi_request_koujo_k10(rand) {
  ...
  if (chara(a).stronghold.要求奖赏 == 0) {
    ...
    await era.printAndWait(`${chara_callname(a)}提出了想要关爱动物的奖励。`); // :7110
    ...
    await era.printAndWait(`${chara_callname(a)}提出了想要啪啪啪的奖励。`); // :7118
  } else if (chara(a).stronghold.要求奖赏 == 6) {
    // :7119

    await era.printAndWait(`「人家、想要独占你的精液一天呢」`); // :7121
    await era.printAndWait(`${chara_callname(a)}提出了想要魔王汁一杯的奖励。`); // :7122
    ...
    await era.printAndWait(`${chara_callname(a)}提出了想要海天盛筵的奖励。`); // :7126
  } else if (chara(a).stronghold.要求奖赏 == 8) {
    // :7127

    await era.printAndWait(`「人家想喝魔王大人的小便呢」`); // :7129
    await era.printAndWait(`${chara_callname(a)}提出了饮用圣水的奖励。`); // :7130
  } else if (chara(a).stronghold.要求奖赏 == 9) {
    // :7131

    await era.printAndWait(`「那么..可以赏给人家几个童贞的孩子嘛？」`); // :7133
    await era.printAndWait(`${chara_callname(a)}提出了童贞狩猎的奖励。`); // :7134
  } // :7134-7136
}
