 ...
 *      普查（繁 492 / 日 76，收录方法见各常量头注释），机械映射必须覆盖
...
const MEASURED_TRAD =
  '這個變別現發聲話於請喲還調讓體陰寶對點滿長態壞雙難張連與顫負裝續宮搖樂當視復淚說嬌腸誰恥細惡膚該計東兩諒厲應實悅潤關卻臨擺員謝騙絕聽餘夾稱陽並濃鮮離壺靜隨軍奮電試親睜憤纏韻脹撥嘗獎記貞達盡論幾瘋護遠選擇聖確問勝揚禮乾賜濕幫辦習慣設剛領斷衛養場備殺轉針類熾脫製產掙館況吶閉錯擁棄敗戰題準換勞顯貼係費誠黃擴飛罰藥聞擊喪團執喚華樹聯畫寬侶師斬歸標潔競療綳趕劃渾彎務戲擠憂幹癮兒摳齡條鬆顏懲滯濺獻戀飼擔屬學礦賣艱鬥憶漢臥濁聳瀕虜衆書園訓銀曬運講攝擡貫懇飯爭顛倫誘義跡飄膩狽緒軀嘆貧較擰圓駡銷尋徹嚕雜顆綺贊囂濘竊諂嚨鬱繞戶藝財闆評價輩輪嚇車擾險礙醜曠佈燙腦憫遺剝鳥絞獵勵監鎖數縛飾淨陸噴賤項紮營糞蹟鷄豬婦揮據嚥糾檢縮隻獸適專觸騰環綫噥奪舊皺違飢牽構絲圖塗鑽壓鬧腫寵攪農慘側緣撐捨嘔錢質塊優責識歡處興鳴攣痙將氣紅夠雖嗎強帶熱蕩無溫給莖頂傳隊馬覺結時們異種為驗傢夥隸討厭憐買躪靈狀葉邁術畢鏈瑪臉艷蟲報見許總資姦淩妳樣從間懷緊機認殘賞癱輕慾亂議響傷須偉貪奧則級敵納繼圍獲陣貴導約純詛謎慄簡濫摀嚐勳墮訴憊練髮頻盤順範煩駕決勢襲極終丟穢虛髒褲紋麗慮語維諸際願啟麽墻著後裏裡爲來開邊會過頭經門沒愛進動嗚撫衹僕劇掃堝贖';
const MEASURED_JP =
  '変挿実満覚経説戦脳両壊専昇圧値増廃陥抜豊渇悪帰拡縄汎処浄斉営掲団舎雑軽応姉栄緑毎晩歳様砕乗闘幇郷撃獣呑顔験絶証寛険汚呪効黒巣楽搾対帯亜揺録収発鈍壷囲産亀';
...
const MEASURED_WORDS = {
  ...
  ハウンド: 3,
  'っ，': 1,
  ﾌﾞﾂﾌﾞﾂﾌﾞﾂ: 1, // EVENT_K9_ダイヤ.ERB:434，#240
  ああっ啊啊啊: 1, // EVENT_K13_庇護者.ERB:1692，#244
  'あなたの目の前でうっとりとした表情で跪く女性が、少し前まであなたに刃を向けようとしていた男勇者とは誰も思わないだろう。': 1, // EVENT_K14_貴公子.ERB:319，整句日文残留，#245
  '「魔の力、これほどとは……」': 1, // EVENT_K14_貴公子.ERB:5300，整句日文残留，#245
};
