...
const MULTIPLIER_SPECS = [
  {
    ...
    talents: {
      ...
      30: { a: 1.1, b: 1.1 }, // 看重贞操 :239-247 的 IF 侧
      31: { a: 0.95, b: 0.95 }, // 看轻贞操 :243-247 的 ELSEIF 侧
      32: { a: 0.95, b: 0.95 }, // 压抑 :249-257 的 IF 侧
      33: { a: 0.9, b: 0.9 }, // 开放 :253-257 的 ELSEIF 侧
      79: { a: 0.95, b: 0.95 }, // 讨厌男人 or 男人婆 :259-263（OR 两侧各测一次）
      82: { a: 0.95, b: 0.95 },
      40: { a: 1.2, b: 1.2 }, // 害怕疼痛 :265-273 的 IF 侧
      41: { a: 0.9, b: 0.9 }, // 不惧疼痛 :269-273 的 ELSEIF 侧
