...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  const NON_KOJO_NAMED = [
    ...
    452, 453, 454, 455, 456, 457, 491, 493, 495, 496, 498, 499, 500, 501, 502,
    503, 504, 505, 506, 507, 508, 510, 511, 520, 521, 534, 550, 551, 552, 570,
    571, 580, 582, 601, 602, 606, 607, 608, 610, 666, 667, 700, 777, 820, 999,
  ];
