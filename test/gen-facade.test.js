...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  const NON_KOJO_NAMED = [
    1, 2, 4, 6, 9, 11, 12, 13, 14, 15, 16, 41, 42, 44, 45, 46, 50, 102, 109,
    120, 130, 131, 151, 451, 452, 500, 501, 502, 503, 506, 507, 508, 510, 511,
    521, 534, 550, 551, 552, 570, 580, 582, 601, 666,
  ];
