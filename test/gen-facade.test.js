...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  // #176（迷宫陷阱）补 1 个：582（patch 借款——诈骗陷阱的借条债，实测区段
  // patch 7 票对 dungeon 6 票，属主 patch）
  const NON_KOJO_NAMED = [
    1, 2, 4, 6, 11, 12, 13, 14, 15, 16, 41, 45, 46, 50, 109, 120, 151, 451, 452,
    501, 502, 503, 506, 507, 508, 521, 534, 550, 551, 552, 570, 580, 582, 601,
    666,
  ];
