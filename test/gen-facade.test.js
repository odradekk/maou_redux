...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  const NON_KOJO_NAMED = [
    ...
    110, 111, 112, 113, 120, 130, 131, 151, 451, 452, 491, 493, 495, 496, 498,
    499, 500, 501, 502, 503, 504, 506, 507, 508, 510, 511, 521, 534, 550, 551,
    552, 570, 580, 582, 601, 602, 606, 607, 608, 610, 666, 667,
  ];
