...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  // #176（迷宫陷阱）补 1 个：582（patch 借款——诈骗陷阱的借条债）
  // #182（迷宫凌辱）补 2 个：130/131（dungeon 凌辱畏怖记忆/计数）
  // #181（2D 地下城）补 2 个：510/511（event X/Y 坐标——UNIT_MOVE 的落笔）
  const NON_KOJO_NAMED = [
    1, 2, 4, 6, 11, 12, 13, 14, 15, 16, 41, 45, 46, 50, 109, 120, 130, 131, 151,
    451, 452, 501, 502, 503, 506, 507, 508, 510, 511, 521, 534, 550, 551, 552,
    570, 580, 582, 601, 666,
  ];
