...
test('口上域切片：cflag 属主 kojo 的下标恰好是命名表的 110 条', () => {
  ...
  const NON_KOJO_NAMED = [
    ...
    106, 107, 108, 109, 110, 111, 112, 113, 120, 130, 131, 151, 190, 420, 451,
    452, 454, 455, 491, 493, 495, 496, 498, 499, 500, 501, 502, 503, 504, 505,
    506, 507, 508, 510, 511, 520, 521, 534, 550, 551, 552, 570, 580, 582, 601,
    602, 606, 607, 608, 610, 666, 667, 700, 777, 820, 999,
  ];
...
test('尾部条目分区（named_tail，#170）：同表既有条目之后发射、两侧各自升序', () => {
  ...
  const expected_tails = {
    ...
    chara: [6, 42, 151, 420, 454, 455, 601, 602, 700, 820],
    dungeon: [
